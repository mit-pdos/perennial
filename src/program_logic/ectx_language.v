...
Section ectx_language_mixin.
  ...
  Record EctxLanguageMixin := {
    ...
    mixin_val_base_stuck e1 σ1 g1 κ e2 σ2 g2 efs :
    ...
    mixin_step_by_val K' K_redex e1' e1_redex σ1 g1 κ e2 σ2 g2 efs :
      ...
      to_val e1' = None →
      base_step e1_redex σ1 g1 κ e2 σ2 g2 efs →
    ...
    mixin_base_ctx_step_val K e σ1 g1 κ e2 σ2 g2 efs :
      base_step (fill K e) σ1 g1 κ e2 σ2 g2 efs → is_Some (to_val e) ∨ K = empty_ectx;
  }.
...
Section ectx_language.
  ...
  Lemma step_by_val K' K_redex e1' e1_redex σ1 g1 κ e2 σ2 g2 efs :
      ...
      ∃ K'', K_redex = comp_ectx K' K''.
  Proof. apply ectx_language_mixin. Qed.
  Lemma base_ctx_step_val K e σ1 g1 κ e2 σ2 g2 efs :
    base_step (fill K e) σ1 g1 κ e2 σ2 g2 efs → is_Some (to_val e) ∨ K = empty_ectx.
  Proof. apply ectx_language_mixin. Qed.

  Definition base_reducible (e : expr Λ) (σ : state Λ) (g : global_state Λ) :=
    ∃ κ e' σ' g' efs, base_step e σ g κ e' σ' g' efs.
  Definition base_reducible_no_obs (e : expr Λ) (σ : state Λ) (g : global_state Λ) :=
    ∃ e' σ' g' efs, base_step e σ g [] e' σ' g' efs.
  Definition base_irreducible (e : expr Λ) (σ : state Λ) (g : global_state Λ) :=
    ∀ κ e' σ' g' efs, ¬base_step e σ g κ e' σ' g' efs.
  Definition base_stuck (e : expr Λ) (σ : state Λ) (g : global_state Λ) :=
    to_val e = None ∧ base_irreducible e σ g.
  ...
  Lemma Ectx_step' K e1 σ1 g1 κ e2 σ2 g2 efs :
    base_step e1 σ1 g1 κ e2 σ2 g2 efs → prim_step (fill K e1) σ1 g1 κ (fill K e2) σ2 g2 efs.
  ...
  Lemma base_reducible_no_obs_reducible e σ g :
    base_reducible_no_obs e σ g → base_reducible e σ g.
  ...
  Proof.
    ...
    destruct (base_ctx_step_val _ _ _ _ _ _ _ _ _ Hred') as [[]%not_eq_None_Some|HK''].
    { by eapply val_base_stuck. }
    subst K''. rewrite fill_empty. done.
  Qed.

  Lemma base_prim_step e1 σ1 g1 κ e2 σ2 g2 efs :
    base_step e1 σ1 g1 κ e2 σ2 g2 efs → prim_step e1 σ1 g1 κ e2 σ2 g2 efs.
  Proof. apply Ectx_step with empty_ectx; by rewrite ?fill_empty. Qed.

  Lemma base_step_not_stuck e σ g κ e' σ' g' efs :
    base_step e σ g κ e' σ' g' efs → not_stuck e σ g.
  ...
  Proof.
    ...
    by apply fill_prim_step.
  Qed.
  Lemma base_prim_reducible e σ g : base_reducible e σ g → reducible e σ g.
  Proof. intros (κ&e'&σ'&g'&efs&?). eexists κ, e', σ', g', efs. by apply base_prim_step. Qed.
  Lemma base_prim_fill_reducible e K σ g :
    base_reducible e σ g → reducible (fill K e) σ g.
  Proof. intro. by apply fill_reducible, base_prim_reducible. Qed.
  Lemma base_prim_reducible_no_obs e σ g : base_reducible_no_obs e σ g → reducible_no_obs e σ g.
  Proof. intros (e'&σ'&g'&efs&?). eexists e', σ', g', efs. by apply base_prim_step. Qed.
  Lemma base_prim_irreducible e σ g : irreducible e σ g → base_irreducible e σ g.
  Proof.
    rewrite -not_reducible -not_base_reducible. eauto using base_prim_reducible.
  Qed.
  Lemma base_prim_fill_reducible_no_obs e K σ g :
    base_reducible_no_obs e σ g → reducible_no_obs (fill K e) σ g.
  ...
  Lemma base_stuck_stuck e σ g :
    base_stuck e σ g → sub_redexes_are_values e → stuck e σ g.
  Proof.
  ...
  Lemma base_reducible_prim_step_ctx K e1 σ1 g1 κ e2 σ2 g2 efs :
    base_reducible e1 σ1 g1 →
    prim_step (fill K e1) σ1 g1 κ e2 σ2 g2 efs →
    ∃ e2', e2 = fill K e2' ∧ base_step e1 σ1 g1 κ e2' σ2 g2 efs.
  Proof.
  ...
  Lemma base_reducible_prim_step e1 σ1 g1 κ e2 σ2 g2 efs :
    base_reducible e1 σ1 g1 →
  ...
  Record pure_base_step (e1 e2 : expr Λ) := {
    pure_base_step_safe σ1 g1 : base_reducible_no_obs e1 σ1 g1;
    pure_base_step_det σ1 g1 κ e2' σ2 g2 efs :
  ...
  Proof.
    ...
    - intros σ g. destruct (Hp1 σ g) as (e2' & σ2 & g2 & efs & ?).
      eexists e2', σ2, g2, efs. by apply base_prim_step.
    - intros σ1 g1 κ e2' σ2 g2 efs ?%base_reducible_prim_step; eauto using base_reducible_no_obs_reducible.
  Qed.
