...
Lemma wp_lift_head_step_fupd {s E Φ} e1 :
  to_val e1 = None →
  (∀ σ1 g1 ns κ κs nt, state_interp σ1 g1 ns (κ ++ κs) nt ={E,∅}=∗ ▷
  ...
  ⊢ WP e1 @ s; E {{ Φ }}.
Proof.
  iIntros (?) "H". iApply wp_lift_step_fupd=>//. iIntros (σ1 g1 ns κ κs nt) "Hσ".
...
Proof.
  ...
  iIntros (σ1 g1 ns κ κs nt) "Hσ1". iMod ("H" with "Hσ1") as "[% H]"; iModIntro.
...
Lemma wp_lift_atomic_head_step_no_fork {s E Φ} e1 :
  ...
  (∀ σ1 g1 ns κ κs nt, state_interp σ1 g1 ns (κ ++ κs) nt ={E}=∗
    ⌜head_reducible e1 σ1 g1⌝ ∗
    ▷ ∀ e2 σ2 g2 efs, ⌜head_step e1 σ1 g1 κ e2 σ2 g2 efs⌝ ={E}=∗
      ⌜efs = []⌝ ∗ state_interp σ2 g2 (S ns) κs nt ∗ from_option Φ False (to_val e2))
  ⊢ WP e1 @ s; E {{ Φ }}.
Proof.
  iIntros (?) "H". iApply wp_lift_atomic_head_step; eauto.
  iIntros (σ1 g1 ns κ κs nt) "Hσ1". iMod ("H" $! σ1 with "Hσ1") as "[$ H]"; iModIntro.
