...
Section proof.
  ...
  Definition is_twophase_started l γ dinit objs_dom j K ls e1 e2 : iProp Σ :=
    ∃ σj1 σj2 mt_changed,
  ...
  Theorem wp_TwoPhase__Begin' N prel ls γ γ' dinit objs_dom j K e1 :
    {{{
      ...
      Begin #prel
    {{{ tphl, RET #tphl;
        is_twophase_started tphl γ dinit objs_dom j K ls e1 e1 }}}.
  Proof.
    iIntros (Φ) "(?&Hatom) HΦ".
    iNamed.
    iNamed "Htwophase".
  ...
  Theorem wp_TwoPhase__CommitNoRelease' l γ dinit objs_dom j K ls e1 v :
    {{{ is_twophase_started l γ dinit objs_dom j K ls e1 (SOMEV v) }}}
  ...
  Theorem twophase_started_abort l γ dinit objs_dom j K ls e1 e2 :
    is_twophase_started l γ dinit objs_dom j K ls e1 e2 -∗
  ...
  Theorem wp_TwoPhase__ReadBuf' l γ dinit objs_dom j K0 K ls
          {Hctx: LanguageCtx'
            ...
            K} e1 a sz :
    {{{
      is_twophase_started l γ dinit objs_dom j K0 ls e1
  ...
  Theorem wp_TwoPhase__OverWrite' l γ dinit objs_dom j K0 K ls
          {Hctx: LanguageCtx'
            (ext := @spec_ext_op_field _)
            (ffi := (spec_ffi_model_field))
            (ffi_semantics := (spec_ext_semantics_field))
            K}  e1 a ov :
    {{{
      is_twophase_started l γ dinit objs_dom j K0 ls
        e1
        (K (ExternalOp (ext := @spec_ext_op_field jrnl_spec_ext)
  ...
  Lemma twophase_started_step_puredet l γ dinit objs_dom j K0 K ls
        `{Hctx: LanguageCtx'
          (ext := @spec_ext_op_field _)
          (ffi := (spec_ffi_model_field))
          (ffi_semantics := (spec_ext_semantics_field))
    ...
    is_twophase_started l γ dinit objs_dom j K0 ls e0 (K e1) -∗
    is_twophase_started l γ dinit objs_dom j K0 ls e0 (K e2).
  Proof. Admitted.

  Lemma twophase_started_ub_det l γ dinit objs_dom E j K0 K ls
        `{Hctx: LanguageCtx'
          (ext := @spec_ext_op_field _)
          (ffi := (spec_ffi_model_field))
          (ffi_semantics := (spec_ext_semantics_field))
    ...
    nclose sN ⊆ E →
    (∀ s, stuck' e s) →
    is_twophase_started l γ dinit objs_dom j K0 ls e0 (K e)
    -∗ |NC={E}=> False.
  Proof. Admitted.
