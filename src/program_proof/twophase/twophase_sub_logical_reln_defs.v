...
Proof.
  ...
  - subst. simpl.
    ...
    iDestruct (twophase_started_step_puredet _ _ _ _ _ _ (λ x : sexpr, K (ectx_language.fill [InjRCtx] x))
                 with "Hj") as "Hj".
    { intros ?.
      apply head_prim_step_trans'. repeat econstructor; eauto.
    }
  ...
  - subst. simpl.
    ...
    iDestruct (twophase_started_step_puredet _ _ _ _ _ _
  ...
  - subst. simpl.
    ...
    iPoseProof (wp_TwoPhase__ReadBuf' tph _ _ _ _ _ _ _ (a, o) x with "Hj") as "H".
    iApply "H".
  ...
  - subst. simpl.
    ...
    iPoseProof (wp_TwoPhase__OverWrite' tph _ _ _ _ _ _ _ (a, o) v with "Hj") as "H".
    iApply "H".
