...
Proof.
  ...
  iNamed.
  iMod (twophase_lift with "Htxncinv Hbuftxn Hcrash_invs Hlinv")
...
Proof.
  ...
  iMod (twophase_lift_if_needed with "Htxn_cinv Hbuftxn Hcrash_invs Hlinv")
    as (?) "(?&?&?)".
  iNamed.
  iModIntro.
...
Proof.
  ...
  wp_apply (wp_TwoPhase__Acquire_lift with "Htwophase"); first by assumption.
