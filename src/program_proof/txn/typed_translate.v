...
Export ffi.disk_ffi.typed_impl ffi.disk_ffi.typed_impl.disk.
...
Section translate.
  ...
  | cast_u64_op_transTy e1 e2 t :
      Γ @ tph ⊢ e1 -- e2 : t ->
      is_intTy t = true ->
      Γ @ tph ⊢ UnOp UToW64Op e1 -- UnOp UToW64Op e2 : uint64T
  | cast_s64_op_transTy e1 e2 t :
      Γ @ tph ⊢ e1 -- e2 : t ->
      is_intTy t = true ->
      Γ @ tph ⊢ UnOp SToW64Op e1 -- UnOp SToW64Op e2 : uint64T
  | cast_u32_op_transTy e1 e2 t :
      Γ @ tph ⊢ e1 -- e2 : t ->
      is_intTy t = true ->
      Γ @ tph ⊢ UnOp UToW32Op e1 -- UnOp UToW32Op e2 : uint32T
  | cast_s32_op_transTy e1 e2 t :
      Γ @ tph ⊢ e1 -- e2 : t ->
      is_intTy t = true ->
      Γ @ tph ⊢ UnOp SToW32Op e1 -- UnOp SToW32Op e2 : uint32T
  | cast_u8_op_transTy e1 e2 t :
      Γ @ tph ⊢ e1 -- e2 : t ->
      is_intTy t = true ->
      Γ @ tph ⊢ UnOp UToW8Op e1 -- UnOp UToW8Op e2 : byteT
  | cast_s8_op_transTy e1 e2 t :
      Γ @ tph ⊢ e1 -- e2 : t ->
      is_intTy t = true ->
      Γ @ tph ⊢ UnOp SToW8Op e1 -- UnOp SToW8Op e2 : byteT
