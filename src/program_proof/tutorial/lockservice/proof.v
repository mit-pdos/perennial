...
Definition is_lockserver_host host : iProp Σ :=
  ∃ γrpc,
  "#H1" ∷ is_urpc_spec_pred γrpc host (I64 0) getFreshNum_spec ∗
  "#H2" ∷ is_urpc_spec_pred γrpc host (I64 1) tryAcquire_spec ∗
  "#H3" ∷ is_urpc_spec_pred γrpc host (I64 2) release_spec ∗
