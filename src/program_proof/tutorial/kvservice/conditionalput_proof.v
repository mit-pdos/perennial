...
Definition own (args_ptr: loc) (args: C) (dq: dfrac) : iProp Σ :=
  "Hargs_opId" ∷ args_ptr ↦[conditionalput_gk.S :: "OpId"]{dq} #args.(opId) ∗
  "Hargs_key" ∷ args_ptr ↦[conditionalput_gk.S :: "Key"]{dq} #(str args.(key)) ∗
  "Hargs_expectedVal" ∷ args_ptr ↦[conditionalput_gk.S :: "ExpectedVal"]{dq} #(str args.(expectedVal)) ∗
  "Hargs_newVal" ∷ args_ptr ↦[conditionalput_gk.S :: "NewVal"]{dq} #(str args.(newVal)).
