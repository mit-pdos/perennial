...
Definition own (args_ptr:loc) (args:C) (q:dfrac) : iProp Σ :=
  "Hargs_writeId" ∷ args_ptr ↦[recordchunk_gk.S :: "WriteId"]{q} #args.(writeId) ∗
  "Hargs_server" ∷ args_ptr ↦[recordchunk_gk.S :: "Server"]{q} #args.(server) ∗
  "Hargs_contentHash" ∷ args_ptr ↦[recordchunk_gk.S :: "ContentHash"]{q} #(str args.(contentHash)) ∗
  "Hargs_index" ∷ args_ptr ↦[recordchunk_gk.S :: "Index"]{q} #args.(index).
