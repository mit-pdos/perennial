...
From Perennial Require Import replica.protocol replica.primary_protocol
     replica.definitions replica.makeclerk_proof.
...
Lemma wp_Server__BecomePrimary γ γsrv s args_ptr args σ backupγ Φ Ψ :
  ...
  WP Server__BecomePrimary #s #args_ptr {{ Φ }}
  .
Proof.
