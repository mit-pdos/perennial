...
Definition TryLock_Pre γ : RPCValsC -> iProp Σ := (λ args, lockservice_is_lock γ args.(I64_1))%I.
Definition TryLock_Post : RPCValsC -> u64 -> iProp Σ := λ args reply, (⌜reply = 0⌝ ∨ ⌜reply = 1⌝ ∗ (Ps args.(I64_1)))%I.

Definition Unlock_Pre γ : RPCValsC -> iProp Σ := (λ args, lockservice_is_lock γ args.(I64_1) ∗ (Ps args.(I64_1)))%I.
