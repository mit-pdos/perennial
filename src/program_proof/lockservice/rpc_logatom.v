...
Lemma pnfupd_elim γrpc cid P Q:
  <disc> (P -∗ |PN={γrpc,cid}=> Q) -∗ (|PN={γrpc,cid}=> P -∗ |PN={γrpc,cid}=> Q).
Proof.
  ...
  iDestruct "HmodQ" as (seq2) "[#Hlb2 HmodQ]".
  iDestruct (own_disc_fupd_elim with "HmodQ") as "HQ".
Admitted.
