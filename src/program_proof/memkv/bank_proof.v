...
From Perennial.program_proof.memkv Require Export common_proof erpc_lib memkv_clerk_proof lockservice_proof.
...
Section bank_proof.
Context `{!heapGS Σ (ext:=grove_op) (ffi:=grove_model), !erpcG Σ ShardReplyC, !urpcregG Σ, !kvMapG Σ, mapG Σ u64 u64}.
