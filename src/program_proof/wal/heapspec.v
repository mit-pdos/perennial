...
Proof.
  ...
  - simpl in H. exfalso. apply H. apply list_elem_of_here.
  - rewrite -> insert_insert_ne by eauto.
    rewrite IHbs; eauto.
    intro Hne. apply H. apply list_elem_of_further. eauto.
Qed.
...
Proof.
  ...
  - eauto.
  - iPureIntro. intros. eapply Hdisjoint. eapply list_elem_of_further. eauto.
...
Proof.
  ...
  iIntros (x Hx).
  eapply list_elem_of_lookup_1 in Hx.
  destruct Hx as [i Hx].
  rewrite /memappend_pre.
...
Proof using walheapG0.
  ...
  { simpl; eauto.
    ...
    move: Hbs_in_gh Hin.
    clear.
    rewrite list_elem_of_lookup elem_of_dom.
    naive_solver. }
  ...
  - eapply list_elem_of_fmap in e as ex.
    destruct ex as [y [-> ?]].
    apply list_elem_of_lookup in H0; destruct H0.
