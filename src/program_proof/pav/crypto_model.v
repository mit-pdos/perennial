...
Definition step (op : op_ty) (state : state_ty) : (ret_ty * state_ty) :=
  ...
  | key_gen =>
    ...
    match (state.(sk_to_pk) !! sk, state.(pk_to_sk) !! pk,
    ...
    | Some pk =>
      ...
      | Some true =>
        (ret_sign sig,
          ...
          state <| verify_memo ::= <[(pk,msg,sig):=true]> |>)
      | Some false =>
