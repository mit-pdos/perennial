...
Section goose_lang.
  ...
  Definition EncodeUInt32: val :=
    λ: "n" "p",
    "p" +ₗ #0 <-[u8T] to_u8 ("n" ≫ #(I32 $ 0*8));;
    "p" +ₗ #1 <-[u8T] to_u8 ("n" ≫ #(I32 $ 1*8));;
    "p" +ₗ #2 <-[u8T] to_u8 ("n" ≫ #(I32 $ 2*8));;
    "p" +ₗ #3 <-[u8T] to_u8 ("n" ≫ #(I32 $ 3*8)).
  ...
  Definition DecodeUInt32: val :=
    ...
    "v0" `or` ("v1" `or` ("v2" `or` "v3" ≪ #(I32 8)) ≪ #(I32 8)) ≪ #(I32 8).
  ...
  Definition DecodeUInt64: val :=
    ...
    "v0" `or` ("v1" `or` ("v2" `or` ("v3" `or` ("v4" `or` ("v5" `or` ("v6" `or` "v7"
      ≪ #(I64 8)) ≪ #(I64 8)) ≪ #(I64 8)) ≪ #(I64 8)) ≪ #(I64 8)) ≪ #(I64 8)) ≪ #(I64 8).
