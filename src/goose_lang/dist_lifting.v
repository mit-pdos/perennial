...
Definition wpd `{hG: !gooseGlobalGS Σ} (k: nat) (E: coPset) (ers: list node_init_cfg) :=
  ([∗ list] i↦σ ∈ ers, ∀ `(hG: !gooseLocalGS Σ),
    ...
    ∃ Φ Φrx Φinv, wpr NotStuck k E σ.(init_thread) σ.(init_restart) Φ Φinv Φrx)%I.

Lemma wpd_compose `{hG: !gooseGlobalGS Σ} k E ers1 ers2 :
  wpd k E ers1 -∗
  wpd k E ers2 -∗
  wpd k E (ers1 ++ ers2).
