...
From Perennial.goose_lang.automation Require proof_automation.
From Perennial.program_proof Require Import memkv_clerk_proof.

(* the issue is with a part of the memkv closed proof, when
shard_server_ghost_init is called *)
...
(* only the closed proof is incompatible *)
From Perennial.program_proof Require memkv.closed.
