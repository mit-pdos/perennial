...
Ltac reshape_expr e tac :=
  ...
  let rec go K vs e :=
    ...
    | BinOp ?op ?e (Val ?v)           => add_item (@BinOpLCtx _ op v) vs K e
    | BinOp ?op ?e1 ?e2               => add_item (@BinOpRCtx _ op e1) vs K e2
    ...
    | Primitive2 ?op ?e (Val ?v)              => add_item (@Primitive2LCtx _ _ _ op v) vs K e
    | Primitive2 ?op ?e1 ?e2                  => add_item (@Primitive2RCtx _ op e1) vs K e2
