...
this in GooseLang, so we just loop. *)
  ...
  Definition UInt64Put: val := λ: "p" "n", EncodeUInt64 "n" (slice.ptr "p").

  Definition UInt64Get: val := λ: "p", DecodeUInt64 (slice.ptr "p").

  Definition UInt32Put: val := λ: "p" "n", EncodeUInt32 "n" (slice.ptr "p").

  Definition UInt32Get: val := λ: "p", DecodeUInt32 (slice.ptr "p").
