...
Section instances.
Context `{ffi_syntax}.
Global Instance AppendOnlyFile_ty_wf : struct.Wf aof.AppendOnlyFile.
Proof. apply _. Qed.
...
Global Instance is_pkg_defined_pure_aof : IsPkgDefinedPure aof :=
  {|
...
Global Program Instance is_pkg_defined_aof : IsPkgDefined aof :=
  {|
