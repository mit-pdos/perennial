...
(* type channel.ReceiverState *)
Module ReceiverState.
Section def.
Context `{ffi_syntax}.
Definition t := w64.
End def.
...
Global Instance wp_func_call_TrySelectAt :
  WpFuncCall channel "TrySelectAt" _ (is_pkg_defined channel) :=
  ltac:(apply wp_func_call'; reflexivity).

Global Instance wp_func_call_TrySelectCase :
  WpFuncCall channel "TrySelectCase" _ (is_pkg_defined channel) :=
  ltac:(apply wp_func_call'; reflexivity).

Global Instance wp_func_call_TryCasesInOrder :
  WpFuncCall channel "TryCasesInOrder" _ (is_pkg_defined channel) :=
  ltac:(apply wp_func_call'; reflexivity).

Global Instance wp_func_call_multiSelect :
  WpFuncCall channel "multiSelect" _ (is_pkg_defined channel) :=
  ltac:(apply wp_func_call'; reflexivity).
...
Global Instance wp_method_call_Channel'ptr_ReceiverCompleteOrOffer :
  WpMethodCall channel "Channel'ptr" "ReceiverCompleteOrOffer" _ (is_pkg_defined channel) :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_Channel'ptr_ReceiverCompleteOrRescindOffer :
  WpMethodCall channel "Channel'ptr" "ReceiverCompleteOrRescindOffer" _ (is_pkg_defined channel) :=
  ltac:(apply wp_method_call'; reflexivity).
