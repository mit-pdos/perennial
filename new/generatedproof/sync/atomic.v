...
Global Instance is_pkg_defined_instance : IsPkgDefined atomic.pkg_name' :=
{|
  is_pkg_defined := is_global_definitions atomic.pkg_name' var_addrs;
|}.
...
Global Instance wp_func_call_CompareAndSwapUint64 :
  WpFuncCall atomic.pkg_name' "CompareAndSwapUint64" _ (is_pkg_defined atomic.pkg_name') :=
  ltac:(apply wp_func_call'; reflexivity).

Global Instance wp_func_call_AddUint64 :
  WpFuncCall atomic.pkg_name' "AddUint64" _ (is_pkg_defined atomic.pkg_name') :=
  ltac:(apply wp_func_call'; reflexivity).

Global Instance wp_func_call_LoadUint64 :
  WpFuncCall atomic.pkg_name' "LoadUint64" _ (is_pkg_defined atomic.pkg_name') :=
  ltac:(apply wp_func_call'; reflexivity).

Global Instance wp_func_call_StoreUint64 :
  WpFuncCall atomic.pkg_name' "StoreUint64" _ (is_pkg_defined atomic.pkg_name') :=
  ltac:(apply wp_func_call'; reflexivity).

Global Instance wp_method_call_Uint64'ptr_Add :
  WpMethodCall atomic.pkg_name' "Uint64'ptr" "Add" _ (is_pkg_defined atomic.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_Uint64'ptr_CompareAndSwap :
  WpMethodCall atomic.pkg_name' "Uint64'ptr" "CompareAndSwap" _ (is_pkg_defined atomic.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_Uint64'ptr_Load :
  WpMethodCall atomic.pkg_name' "Uint64'ptr" "Load" _ (is_pkg_defined atomic.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_Uint64'ptr_Store :
  WpMethodCall atomic.pkg_name' "Uint64'ptr" "Store" _ (is_pkg_defined atomic.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).
