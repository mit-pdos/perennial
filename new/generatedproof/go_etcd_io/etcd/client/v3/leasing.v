...
Global Instance wp_func_call_inRange :
  WpFuncCall leasing.pkg_name' "inRange" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_func_call'; reflexivity).

Global Instance wp_func_call_isBadOp :
  WpFuncCall leasing.pkg_name' "isBadOp" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_func_call'; reflexivity).

Global Instance wp_func_call_NewKV :
  WpFuncCall leasing.pkg_name' "NewKV" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_func_call'; reflexivity).

Global Instance wp_func_call_compareInt64 :
  WpFuncCall leasing.pkg_name' "compareInt64" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_func_call'; reflexivity).

Global Instance wp_func_call_evalCmp :
  WpFuncCall leasing.pkg_name' "evalCmp" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_func_call'; reflexivity).

Global Instance wp_func_call_gatherOps :
  WpFuncCall leasing.pkg_name' "gatherOps" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_func_call'; reflexivity).

Global Instance wp_func_call_gatherResponseOps :
  WpFuncCall leasing.pkg_name' "gatherResponseOps" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_func_call'; reflexivity).

Global Instance wp_func_call_copyHeader :
  WpFuncCall leasing.pkg_name' "copyHeader" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_func_call'; reflexivity).

Global Instance wp_func_call_closeAll :
  WpFuncCall leasing.pkg_name' "closeAll" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_func_call'; reflexivity).

Global Instance wp_method_call_leaseCache'ptr_Add :
  WpMethodCall leasing.pkg_name' "leaseCache'ptr" "Add" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leaseCache'ptr_Delete :
  WpMethodCall leasing.pkg_name' "leaseCache'ptr" "Delete" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leaseCache'ptr_Evict :
  WpMethodCall leasing.pkg_name' "leaseCache'ptr" "Evict" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leaseCache'ptr_EvictRange :
  WpMethodCall leasing.pkg_name' "leaseCache'ptr" "EvictRange" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leaseCache'ptr_Get :
  WpMethodCall leasing.pkg_name' "leaseCache'ptr" "Get" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leaseCache'ptr_Lock :
  WpMethodCall leasing.pkg_name' "leaseCache'ptr" "Lock" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leaseCache'ptr_LockRange :
  WpMethodCall leasing.pkg_name' "leaseCache'ptr" "LockRange" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leaseCache'ptr_LockWriteOps :
  WpMethodCall leasing.pkg_name' "leaseCache'ptr" "LockWriteOps" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leaseCache'ptr_MayAcquire :
  WpMethodCall leasing.pkg_name' "leaseCache'ptr" "MayAcquire" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leaseCache'ptr_NotifyOps :
  WpMethodCall leasing.pkg_name' "leaseCache'ptr" "NotifyOps" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leaseCache'ptr_Rev :
  WpMethodCall leasing.pkg_name' "leaseCache'ptr" "Rev" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leaseCache'ptr_Update :
  WpMethodCall leasing.pkg_name' "leaseCache'ptr" "Update" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leaseCache'ptr_clearOldRevokes :
  WpMethodCall leasing.pkg_name' "leaseCache'ptr" "clearOldRevokes" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).
...
Global Instance wp_method_call_leaseCache'ptr_evalCmp :
  WpMethodCall leasing.pkg_name' "leaseCache'ptr" "evalCmp" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leaseCache'ptr_evalOps :
  WpMethodCall leasing.pkg_name' "leaseCache'ptr" "evalOps" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leaseCache'ptr_notify :
  WpMethodCall leasing.pkg_name' "leaseCache'ptr" "notify" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leaseKey'ptr_get :
  WpMethodCall leasing.pkg_name' "leaseKey'ptr" "get" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_Close :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "Close" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_Compact :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "Compact" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_Delete :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "Delete" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_Do :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "Do" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_Get :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "Get" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_Put :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "Put" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_Txn :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "Txn" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_acquire :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "acquire" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).
...
Global Instance wp_method_call_leasingKV'ptr_deleteRange :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "deleteRange" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_deleteRangeRPC :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "deleteRangeRPC" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).
...
Global Instance wp_method_call_leasingKV'ptr_leaseID :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "leaseID" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_monitorLease :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "monitorLease" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_monitorSession :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "monitorSession" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).
...
Global Instance wp_method_call_leasingKV'ptr_readySession :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "readySession" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_rescind :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "rescind" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_revoke :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "revoke" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_revokeLeaseKvs :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "revokeLeaseKvs" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_revokeRange :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "revokeRange" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_tryModifyOp :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "tryModifyOp" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_waitRescind :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "waitRescind" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_leasingKV'ptr_waitSession :
  WpMethodCall leasing.pkg_name' "leasingKV'ptr" "waitSession" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_txnLeasing'ptr_Commit :
  WpMethodCall leasing.pkg_name' "txnLeasing'ptr" "Commit" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_txnLeasing'ptr_Else :
  WpMethodCall leasing.pkg_name' "txnLeasing'ptr" "Else" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_txnLeasing'ptr_If :
  WpMethodCall leasing.pkg_name' "txnLeasing'ptr" "If" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_txnLeasing'ptr_Then :
  WpMethodCall leasing.pkg_name' "txnLeasing'ptr" "Then" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_txnLeasing'ptr_commitToCache :
  WpMethodCall leasing.pkg_name' "txnLeasing'ptr" "commitToCache" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_txnLeasing'ptr_eval :
  WpMethodCall leasing.pkg_name' "txnLeasing'ptr" "eval" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_txnLeasing'ptr_fallback :
  WpMethodCall leasing.pkg_name' "txnLeasing'ptr" "fallback" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_txnLeasing'ptr_guard :
  WpMethodCall leasing.pkg_name' "txnLeasing'ptr" "guard" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_txnLeasing'ptr_guardKeys :
  WpMethodCall leasing.pkg_name' "txnLeasing'ptr" "guardKeys" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_txnLeasing'ptr_guardRanges :
  WpMethodCall leasing.pkg_name' "txnLeasing'ptr" "guardRanges" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_txnLeasing'ptr_revokeFallback :
  WpMethodCall leasing.pkg_name' "txnLeasing'ptr" "revokeFallback" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).

Global Instance wp_method_call_txnLeasing'ptr_serverTxn :
  WpMethodCall leasing.pkg_name' "txnLeasing'ptr" "serverTxn" _ (is_pkg_defined leasing.pkg_name') :=
  ltac:(apply wp_method_call'; reflexivity).
