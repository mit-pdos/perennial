...
Global Instance is_pkg_defined_pure_mvccpb : IsPkgDefinedPure mvccpb :=
  {|
    is_pkg_defined_pure_def go_ctx :=
      is_pkg_defined_pure_single mvccpb;
  |}.

#[local] Transparent is_pkg_defined_single is_pkg_defined_pure_single.
Global Program Instance is_pkg_defined_mvccpb : IsPkgDefined mvccpb :=
  {|
    is_pkg_defined_def go_ctx :=
      (is_pkg_defined_single mvccpb)%I
  |}.
