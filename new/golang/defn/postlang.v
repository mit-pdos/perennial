...
Class CoreComparisonSemantics {go_ctx : GoContext} :=
{
  ...
  equals_interface elems t v1 v2 :
    ...
    go_equals t v1 v2;
  (* Constraints about equality for structs are generated by goose.go *)
  equals_array n t V (a1 a2 : array.t t V n) `{!EqDecision V} `{!IntoVal V}
    (H : is_strictly_comparable_sem t V) :
    is_strictly_comparable_sem (go.ArrayType n t) (array.t t V n);
