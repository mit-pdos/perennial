Require Import New.code.github_com.mit_pdos.go_journal.addr.
Require Import New.generatedproof.github_com.mit_pdos.go_journal.addr.
...
Definition addr2val (a : addr) : addr.Addr.t :=
  addr.Addr.mk (fst a) (snd a).
...
Proof.
  ...
  simpl in *.
  intuition.
  replace w0 with w2 in * by word.
  replace w with w1 by word.
  done.
Qed.
...
Proof.
  ...
  iPureIntro.
  revert Hvalid.
  unfold valid_addr, addr2flat, addr2flat_z, block_bytes, addrBlock, addrOff.
  intros.
  word.
Qed.
