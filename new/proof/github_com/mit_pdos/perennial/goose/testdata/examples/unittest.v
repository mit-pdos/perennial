...
From New.generatedproof.github_com.mit_pdos.perennial.goose.testdata.examples Require Import unittest.
...
Proof.
  wp_start.
  wp_auto.
  wp_apply wp_slice_literal. iSplitR; first done. iIntros "% [Hz _]". wp_auto.
  iPersist "arg2".
  ...
  - wp_apply wp_slice_literal. iSplitR; first done. iIntros "% [Hsl2 _]". wp_auto.
