...
From New.code Require Import github_com.mit_pdos.gokv.fencing.ctr.getreply_gk.
From New.generatedproof Require Import github_com.mit_pdos.gokv.fencing.ctr.getreply_gk.
From New.proof.github_com.mit_pdos.gokv.fencing.ctr Require Import error_proof_gk.
From New.code Require Import github_com.mit_pdos.gokv.fencing.ctr.error_gk.
...
Definition own (args__v: getreply_gk.S.t) (args__c: C) (dq: dfrac) : iProp Σ :=
  ...
  "%Hown_val" ∷ ⌜ args__v.(getreply_gk.S.Val') = args__c.(val') ⌝.
