...
From New.generatedproof Require Import github_com.mit_pdos.gokv.vrsm.paxos.error_gk.
...
Definition name_map_def : gmap w32 go_string := list_to_map [
                                                ((W32 0), "ENone"%go);
                                                ((W32 1), "EEpochStale"%go);
                                                ((W32 2), "EOutOfOrder"%go);
                                                ((W32 3), "ETimeout"%go);
                                                ((W32 4), "ENotLeader"%go)
                                              ].
Definition value_map_def : gmap go_string w32 := list_to_map [
                                                 ("ENone"%go, (W32 0));
                                                 ("EEpochStale"%go, (W32 1));
                                                 ("EOutOfOrder"%go, (W32 2));
                                                 ("ETimeout"%go, (W32 3));
                                                 ("ENotLeader"%go, (W32 4))
                                               ].
