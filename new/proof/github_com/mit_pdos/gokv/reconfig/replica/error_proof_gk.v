...
From New.generatedproof Require Import github_com.mit_pdos.gokv.reconfig.replica.error_gk.
...
Definition name_map_def : gmap w32 go_string := list_to_map [
                                                ((W32 0), "ENone"%go);
                                                ((W32 1), "ENotPrimary"%go);
                                                ((W32 2), "EStale"%go);
                                                ((W32 3), "EAppendOutOfOrder"%go);
                                                ((W32 4), "ETruncated"%go);
                                                ((W32 5), "EIncompleteLog"%go)
                                              ].
Definition value_map_def : gmap go_string w32 := list_to_map [
                                                 ("ENone"%go, (W32 0));
                                                 ("ENotPrimary"%go, (W32 1));
                                                 ("EStale"%go, (W32 2));
                                                 ("EAppendOutOfOrder"%go, (W32 3));
                                                 ("ETruncated"%go, (W32 4));
                                                 ("EIncompleteLog"%go, (W32 5))
                                               ].
...
Definition to_tag i : w32 :=
  ...
  | ENotPrimary => W32 1
  | EStale => W32 2
  | EAppendOutOfOrder => W32 3
  | ETruncated => W32 4
  | EIncompleteLog => W32 5
  end.
