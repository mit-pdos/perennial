...
(* TODO(new): where should I put the trusted model? *)
From Perennial.goose_lang.trusted.github_com.mit_pdos.tulip Require trusted_proph.

(* TODO(new): probably should not import this, but not sure what to import in new. *)
From Perennial.goose_lang.lib.map Require map.
