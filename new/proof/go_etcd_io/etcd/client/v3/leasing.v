...
Proof.
  ...
  { (* not nil *)
    ...
    wp_apply wp_Session__Done as "* #HsessDone".
    { iFrame "#". }
    wp_auto. wp_apply "HDone".
    wp_auto.
  ...
  iCombine "sessionc_lock sessionc" gives %Heq. subst.
...
Abort.
(*   { *)
(*     wp_apply (chan.wp_select_nonblocking_alt [⌜ open = true ⌝]%I with "[Hsessionc] [-]"). *)
(*     2:{ iNamedAccu. } *)
