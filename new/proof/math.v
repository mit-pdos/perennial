...
Local Lemma wp_useFMA_init :
  {{{ True }}} math.useFMA'init #() {{{ RET #(); True }}}.
Proof. Admitted.
...
Proof.
  ...
  do 52 (wp_apply wp_GlobalAlloc as "?").
  wp_apply wp_useFMA_init.
  (* remaining: 51 array CompositeLiterals + stores *)
  all: admit.
Admitted.
