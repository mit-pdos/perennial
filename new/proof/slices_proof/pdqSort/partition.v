...
Lemma wp_partitionCmpFunc (data: slice.t) (a b pivot: w64) (cmp_code: func.t)
  ...
  {{{ is_pkg_init slices ∗
    ...
    @! slices.partitionCmpFunc #Et #data #a #b #pivot #cmp_code
...
Proof using StrictWeakOrder0 RelDecision0.
  ...
  wp_pure; first lia.
  wp_apply (wp_store_slice_elem with "[$Hxs]") as "Hxs"; eauto; first word.
  
  assert(Hlen1: length (<[sint.nat a:=xp]> xs) = length xs) by apply length_insert.
  wp_pure; first lia.
  wp_apply (wp_store_slice_elem with "[$Hxs]") as "Hxs"; eauto; try word.
  ...
  wp_if_destruct. {
    ...
    wp_pure; first lia.
    wp_apply (wp_store_slice_elem with "[$Hxs]") as "Hxs"; eauto.
...
Lemma wp_medianCmpFunc (data: slice.t) (a b c: w64) (swaps_l: loc) (cmp_code: func.t)
  ...
  {{{ is_pkg_init slices ∗
    ...
    @! slices.medianCmpFunc #Et #data #a #b #c #swaps_l #cmp_code
...
Lemma wp_medianAdjacentCmpFunc (data: slice.t) (a: w64) (swaps_l: loc) (cmp_code: func.t)
  ...
  {{{ is_pkg_init slices ∗
    ...
    @! slices.medianAdjacentCmpFunc #Et #data #a #swaps_l #cmp_code
  {{{ (r: w64) (swaps': w64), RET (#r);
      data ↦*{dq} xs ∗
...
Lemma wp_choosePivotCmpFunc (data: slice.t) (a b: w64) (cmp_code: func.t)
  ...
  {{{ is_pkg_init slices ∗
    ...
    @! slices.choosePivotCmpFunc #Et #data #a #b #cmp_code
...
Lemma wp_breakPatternsCmpFunc (data: slice.t) (a b: w64) (cmp_code: func.t)
  ...
  {{{ is_pkg_init slices ∗
    ...
    @! slices.breakPatternsCmpFunc #Et #data #a #b #cmp_code
  {{{ (xs': list E), RET #();
      data ↦* xs' ∗
      "%Hperm" ∷ ⌜ Permutation xs xs' ⌝ ∗
      "%Houtside" ∷ ⌜ outside_same xs xs' (sint.nat a) (sint.nat b) ⌝ 
...
Lemma wp_partitionEqualCmpFunc (data: slice.t) (a b pivot: w64) (cmp_code: func.t)
  ...
  {{{ is_pkg_init slices ∗
    ...
    @! slices.partitionEqualCmpFunc #Et #data #a #b #pivot #cmp_code
