...
#[global] Instance info' : PkgInfo auditor.auditor :=
  {|
    ...
    pkg_msets := msets';
    pkg_imported_pkgs := [sync.sync; std.std; advrpc.advrpc; cryptoffi.cryptoffi; hashchain.hashchain; ktcore.ktcore; merkle.merkle; server.server; safemarshal.safemarshal; marshal.marshal];
  |}.
