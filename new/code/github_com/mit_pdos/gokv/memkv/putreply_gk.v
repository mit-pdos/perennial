...
Definition S {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go.type := go.Named "github.com/mit-pdos/gokv/memkv/putreply_gk.S"%go [].

Definition Marshal {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/gokv/memkv/putreply_gk.Marshal"%go.

Definition Unmarshal {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/gokv/memkv/putreply_gk.Unmarshal"%go.
...
#[global] Instance info' : PkgInfo pkg_id.putreply_gk :=
{|
  pkg_imported_pkgs := [code.github_com.mit_pdos.gokv.memkv.error_gk.pkg_id.error_gk]
|}.

Definition initialize' {ext : ffi_syntax} {go_gctx : GoGlobalContext} : val :=
  λ: <>,
    package.init pkg_id.putreply_gk (λ: <>,
