(* autogenerated from github.com/mit-pdos/gokv/memkv/error_gk *)
Require Export New.code.github_com.tchajed.marshal.
From New.golang Require Import defn.
Module pkg_id.
Definition error_gk : go_string := "github.com/mit-pdos/gokv/memkv/error_gk".

End pkg_id.
Export pkg_id.
Module error_gk.

Definition E {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go.type := go.Named "github.com/mit-pdos/gokv/memkv/error_gk.E"%go [].

Definition ENone {ext : ffi_syntax} {go_gctx : GoGlobalContext} : val := #(W32 0).

Definition EDontHaveShard {ext : ffi_syntax} {go_gctx : GoGlobalContext} : val := #(W32 1).

Definition Name {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/gokv/memkv/error_gk.Name"%go.

Definition Value {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/gokv/memkv/error_gk.Value"%go.

Definition Marshal {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/gokv/memkv/error_gk.Marshal"%go.

Definition Unmarshal {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/gokv/memkv/error_gk.Unmarshal"%go.
...
Definition initialize' {ext : ffi_syntax} {go_gctx : GoGlobalContext} : val :=
  λ: <>,
    package.init pkg_id.error_gk (λ: <>,
      ...
      let: "$r0" := (CompositeLiteral (go.MapType go.uint32 go.string) (LiteralValue [KeyedElement (Some (KeyExpression go.uint32 #(W32 0))) (ElementExpression go.string #"ENone"%go); KeyedElement (Some (KeyExpression go.uint32 #(W32 1))) (ElementExpression go.string #"EDontHaveShard"%go)])) in
      do:  ((GlobalVarAddr Name #()) <-[go.MapType go.uint32 go.string] "$r0");;;
      let: "$r0" := (CompositeLiteral (go.MapType go.string go.uint32) (LiteralValue [KeyedElement (Some (KeyExpression go.string #"ENone"%go)) (ElementExpression go.uint32 #(W32 0)); KeyedElement (Some (KeyExpression go.string #"EDontHaveShard"%go)) (ElementExpression go.uint32 #(W32 1))])) in
