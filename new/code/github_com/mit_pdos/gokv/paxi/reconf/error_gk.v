...
Definition E {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go.type := go.Named "github.com/mit-pdos/gokv/paxi/reconf/error_gk.E"%go [].

Definition ENone {ext : ffi_syntax} {go_gctx : GoGlobalContext} : val := #(W32 0).

Definition ETermStale {ext : ffi_syntax} {go_gctx : GoGlobalContext} : val := #(W32 1).

Definition ENotLeader {ext : ffi_syntax} {go_gctx : GoGlobalContext} : val := #(W32 2).

Definition EQuorumFailed {ext : ffi_syntax} {go_gctx : GoGlobalContext} : val := #(W32 3).

Definition Name {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/gokv/paxi/reconf/error_gk.Name"%go.

Definition Value {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/gokv/paxi/reconf/error_gk.Value"%go.

Definition Marshal {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/gokv/paxi/reconf/error_gk.Marshal"%go.

Definition Unmarshal {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/gokv/paxi/reconf/error_gk.Unmarshal"%go.
...
Definition initialize' {ext : ffi_syntax} {go_gctx : GoGlobalContext} : val :=
  λ: <>,
    package.init pkg_id.error_gk (λ: <>,
      ...
      let: "$r0" := (CompositeLiteral (go.MapType go.uint32 go.string) (LiteralValue [KeyedElement (Some (KeyExpression go.uint32 #(W32 0))) (ElementExpression go.string #"ENone"%go); KeyedElement (Some (KeyExpression go.uint32 #(W32 1))) (ElementExpression go.string #"ETermStale"%go); KeyedElement (Some (KeyExpression go.uint32 #(W32 2))) (ElementExpression go.string #"ENotLeader"%go); KeyedElement (Some (KeyExpression go.uint32 #(W32 3))) (ElementExpression go.string #"EQuorumFailed"%go)])) in
      do:  ((GlobalVarAddr Name #()) <-[go.MapType go.uint32 go.string] "$r0");;;
      let: "$r0" := (CompositeLiteral (go.MapType go.string go.uint32) (LiteralValue [KeyedElement (Some (KeyExpression go.string #"ENone"%go)) (ElementExpression go.uint32 #(W32 0)); KeyedElement (Some (KeyExpression go.string #"ETermStale"%go)) (ElementExpression go.uint32 #(W32 1)); KeyedElement (Some (KeyExpression go.string #"ENotLeader"%go)) (ElementExpression go.uint32 #(W32 2)); KeyedElement (Some (KeyExpression go.string #"EQuorumFailed"%go)) (ElementExpression go.uint32 #(W32 3))])) in
