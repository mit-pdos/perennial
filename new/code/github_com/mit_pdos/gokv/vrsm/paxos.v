...
#[global] Instance info' : PkgInfo pkg_name' :=
  {|
    ...
    pkg_msets := msets';
    pkg_imported_pkgs := [grove_ffi.pkg_name'; reconnectclient.pkg_name'; marshal.pkg_name'; log.pkg_name'; sync.pkg_name'; std.pkg_name'; asyncfile.pkg_name'; urpc.pkg_name'];
  |}.
