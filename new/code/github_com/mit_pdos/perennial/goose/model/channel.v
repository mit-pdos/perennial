(* autogenerated from github.com/mit-pdos/perennial/goose/model/channel *)
Require Export New.code.github_com.goose_lang.primitive.
From New.golang Require Import defn.pre.
From New.golang.defn Require Export slice defer.
Module pkg_id.
Definition channel : go_string := "github.com/mit-pdos/perennial/goose/model/channel".

End pkg_id.
Export pkg_id.
Module channel.

Definition offerState {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go.type := go.Named "github.com/mit-pdos/perennial/goose/model/channel.offerState"%go [].

#[global] Opaque offerState.

Definition Channel {ext : ffi_syntax} {go_gctx : GoGlobalContext} (T : go.type) : go.type := go.Named "github.com/mit-pdos/perennial/goose/model/channel.Channel"%go [T].

#[global] Opaque Channel.

Definition SelectDir {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go.type := go.Named "github.com/mit-pdos/perennial/goose/model/channel.SelectDir"%go [].
...
Definition NewChannel {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/model/channel.NewChannel"%go.

Definition NonBlockingSelect1 {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/model/channel.NonBlockingSelect1"%go.

Definition BlockingSelect2 {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/model/channel.BlockingSelect2"%go.

Definition NonBlockingSelect2 {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/model/channel.NonBlockingSelect2"%go.

Definition BlockingSelect3 {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/model/channel.BlockingSelect3"%go.

Definition NonBlockingSelect3 {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/model/channel.NonBlockingSelect3"%go.
...
Definition NewChannelⁱᵐᵖˡ {ext : ffi_syntax} {go_gctx : GoGlobalContext} (T : go.type) : val :=
  λ: "cap",
    ...
    (if: Convert go.untyped_bool go.bool ((![go.int] "cap") >⟨go.int⟩ #(W64 0))
    then
      let: "$r0" := buffered in
      do:  ("local_state" <-[offerState] "$r0")
    else do:  #());;;
...
Definition Channel__TrySendⁱᵐᵖˡ {ext : ffi_syntax} {go_gctx : GoGlobalContext} (T : go.type) : val :=
  λ: "c" "val" "blocking",
    ...
    then
      do:  (let: "$a0" := (Convert go.string (go.InterfaceType []) #"send on closed channel"%go) in
      (FuncResolve go.panic [] #()) "$a0")
    else
      (if: "$sw" =⟨offerState⟩ buffered
      then
        (if: Convert go.untyped_bool go.bool ((let: "$a0" := (![go.SliceType T] (StructFieldRef (Channel T) "buffer"%go (![go.PointerType (Channel T)] "c"))) in
...
Definition Channel__tryCloseⁱᵐᵖˡ {ext : ffi_syntax} {go_gctx : GoGlobalContext} (T : go.type) : val :=
  λ: "c" <>,
    ...
    (if: "$sw" =⟨offerState⟩ closed
    then
      do:  (let: "$a0" := (Convert go.string (go.InterfaceType []) #"close of closed channel"%go) in
      (FuncResolve go.panic [] #()) "$a0")
    else
...
Definition offerStateⁱᵐᵖˡ {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go.type := go.uint64.
...
Definition SelectDirⁱᵐᵖˡ {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go.type := go.uint64.
