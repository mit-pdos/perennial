(* autogenerated from github.com/mit-pdos/perennial/goose/model/strings *)
From New.golang Require Import defn.pre.
From New.golang.defn Require Export slice defer.
Module pkg_id.
Definition strings : go_string := "github.com/mit-pdos/perennial/goose/model/strings".

End pkg_id.
Export pkg_id.
Module strings.

Definition StringToByteSlice {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/model/strings.StringToByteSlice"%go.

Definition ByteSliceToString {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/model/strings.ByteSliceToString"%go.
