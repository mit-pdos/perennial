(* autogenerated from github.com/mit-pdos/perennial/goose/testdata/examples/append_log *)
...
Module pkg_id.
Definition append_log : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/append_log".

End pkg_id.
Export pkg_id.
Module append_log.

Definition Log {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go.type := go.Named "github.com/mit-pdos/perennial/goose/testdata/examples/append_log.Log"%go [].

#[global] Opaque Log.

Definition Init {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/append_log.Init"%go.

Definition Open {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/append_log.Open"%go.

Definition writeAll {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/append_log.writeAll"%go.
