(* autogenerated from github.com/mit-pdos/perennial/goose/testdata/examples/channel/workq *)
Require Export New.code.strings.
Require Export New.code.sync.atomic.
From New.golang Require Import defn.
Module pkg_id.
Definition workq : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/channel/workq".

End pkg_id.
Export pkg_id.
Module workq.

Definition Worker {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go.type := go.Named "github.com/mit-pdos/perennial/goose/testdata/examples/channel/workq.Worker"%go [].

#[global] Opaque Worker.

Definition shared {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go.type := go.Named "github.com/mit-pdos/perennial/goose/testdata/examples/channel/workq.shared"%go [].

#[global] Opaque shared.

Definition wordCount {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/channel/workq.wordCount"%go.
