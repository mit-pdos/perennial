(* autogenerated from github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics *)
Require Export New.code.github_com.mit_pdos.perennial.goose.testdata.examples.unittest.generics.helpers.
From New.golang Require Import defn.
Module pkg_id.
Definition generics : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics".

End pkg_id.
Export pkg_id.
Module generics.

Definition Box {ext : ffi_syntax} {go_gctx : GoGlobalContext} (T : go.type) : go.type := go.Named "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.Box"%go [T].

#[global] Opaque Box.

Definition Container {ext : ffi_syntax} {go_gctx : GoGlobalContext} (T : go.type) : go.type := go.Named "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.Container"%go [T].

#[global] Opaque Container.

Definition UseContainer {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go.type := go.Named "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.UseContainer"%go [].

#[global] Opaque UseContainer.

Definition OnlyIndirect {ext : ffi_syntax} {go_gctx : GoGlobalContext} (T : go.type) : go.type := go.Named "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.OnlyIndirect"%go [T].

#[global] Opaque OnlyIndirect.

Definition MultiParam {ext : ffi_syntax} {go_gctx : GoGlobalContext} (A : go.type) (B : go.type) : go.type := go.Named "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.MultiParam"%go [A; B].
...
Definition useNonStructGeneric {ext : ffi_syntax} {go_gctx : GoGlobalContext} (T : go.type) : go.type := go.Named "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.useNonStructGeneric"%go [T].

#[global] Opaque useNonStructGeneric.

Definition UnderlyingSlice {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.UnderlyingSlice"%go.

Definition Clone {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.Clone"%go.

Definition BoxGet {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.BoxGet"%go.

Definition BoxGet2 {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.BoxGet2"%go.

Definition makeGenericBox {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.makeGenericBox"%go.

Definition makeBox {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.makeBox"%go.

Definition useBoxGet {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.useBoxGet"%go.

Definition useContainer {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.useContainer"%go.

Definition useMultiParam {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.useMultiParam"%go.

Definition swapMultiParam {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.swapMultiParam"%go.

Definition multiParamFunc {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.multiParamFunc"%go.

Definition useMultiParamFunc {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.useMultiParamFunc"%go.

Definition useAnyPointer {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/mit-pdos/perennial/goose/testdata/examples/unittest/generics.useAnyPointer"%go.
...
Definition makeGenericBoxⁱᵐᵖˡ {ext : ffi_syntax} {go_gctx : GoGlobalContext} (T : go.type) : val :=
  λ: "value",
    ...
    return: (let: "$v0" := (![T] "value") in
     CompositeLiteral (Box T) (LiteralValue [KeyedElement (Some (KeyField "Value"%go)) (ElementExpression T "$v0")]))).

(* go: generics.go:29:6 *)
Definition makeBoxⁱᵐᵖˡ {ext : ffi_syntax} {go_gctx : GoGlobalContext} : val :=
  λ: <>,
    exception_do (return: (let: "$v0" := #(W64 42) in
     CompositeLiteral (Box go.uint64) (LiteralValue [KeyedElement (Some (KeyField "Value"%go)) (ElementExpression go.uint64 "$v0")]))).
...
Definition useContainerⁱᵐᵖˡ {ext : ffi_syntax} {go_gctx : GoGlobalContext} : val :=
  λ: <>,
    ...
    let: "$v1" := (let: "$k0" := #(W64 1) in
    let: "$v1" := #(W64 2) in
    CompositeLiteral (go.MapType go.int go.uint64) (LiteralValue [KeyedElement (Some (KeyExpression go.int "$k0")) (ElementExpression go.uint64 "$v1")])) in
    let: "$v2" := (GoAlloc go.uint64 (GoZeroVal go.uint64 #())) in
    let: "$v3" := #(W64 3) in
    CompositeLiteral (Container go.uint64) (LiteralValue [KeyedElement (Some (KeyField "X"%go)) (ElementExpression go.uint64 "$v0"); KeyedElement (Some (KeyField "Y"%go)) (ElementExpression (go.MapType go.int go.uint64) "$v1"); KeyedElement (Some (KeyField "Z"%go)) (ElementExpression (go.PointerType go.uint64) "$v2"); KeyedElement (Some (KeyField "W"%go)) (ElementExpression go.uint64 "$v3")])) in
...
Definition useMultiParamⁱᵐᵖˡ {ext : ffi_syntax} {go_gctx : GoGlobalContext} : val :=
  λ: <>,
    ...
    let: "$r0" := (let: "$v0" := #true in
    let: "$v1" := #(W64 1) in
    CompositeLiteral (MultiParam go.uint64 go.bool) (LiteralValue [KeyedElement (Some (KeyField "Y"%go)) (ElementExpression go.bool "$v0"); KeyedElement (Some (KeyField "X"%go)) (ElementExpression go.uint64 "$v1")])) in
...
{|
  pkg_imported_pkgs := [code.github_com.mit_pdos.perennial.goose.testdata.examples.unittest.generics.helpers.pkg_id.helpers]
|}.
