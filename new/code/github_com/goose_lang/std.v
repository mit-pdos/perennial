...
{|
  pkg_imported_pkgs := [code.math.pkg_id.math; code.sync.pkg_id.sync; code.github_com.goose_lang.primitive.pkg_id.primitive; code.github_com.goose_lang.std.std_core.pkg_id.std_core]
|}.
