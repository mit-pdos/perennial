...
Definition msets' : list (go_string * (list (go_string * val))) := [(unitⁱᵈ, []); (ptrTⁱᵈ unitⁱᵈ, []); (Encⁱᵈ, []); (ptrTⁱᵈ Encⁱᵈ, [("consume"%go, Enc__consumeⁱᵐᵖˡ)]); (Decⁱᵈ, []); (ptrTⁱᵈ Decⁱᵈ, [("consume"%go, Dec__consumeⁱᵐᵖˡ)]); (Editorⁱᵈ, []); (ptrTⁱᵈ Editorⁱᵈ, [("AdvanceReturn"%go, Editor__AdvanceReturnⁱᵐᵖˡ)]); (Pairⁱᵈ, []); (ptrTⁱᵈ Pairⁱᵈ, []); (Uint32ⁱᵈ, []); (ptrTⁱᵈ Uint32ⁱᵈ, []); (SquareStructⁱᵈ, [("Square"%go, SquareStruct__Squareⁱᵐᵖˡ); ("Volume"%go, SquareStruct__Volumeⁱᵐᵖˡ)]); (ptrTⁱᵈ SquareStructⁱᵈ, [("Square"%go, (λ: "$recvAddr",
                 ...
                 )%V)]); (LoopStructⁱᵈ, [("forLoopWait"%go, LoopStruct__forLoopWaitⁱᵐᵖˡ)]); (ptrTⁱᵈ LoopStructⁱᵈ, [("forLoopWait"%go, (λ: "$recvAddr",
                 method_call #semantics.semantics #"LoopStruct" #"forLoopWait" (![#LoopStruct] "$recvAddr")
                 )%V)]); (BoolTestⁱᵈ, []); (ptrTⁱᵈ BoolTestⁱᵈ, []); (ArrayEditorⁱᵈ, []); (ptrTⁱᵈ ArrayEditorⁱᵈ, [("Advance"%go, ArrayEditor__Advanceⁱᵐᵖˡ)]); (Barⁱᵈ, []); (ptrTⁱᵈ Barⁱᵈ, [("mutate"%go, Bar__mutateⁱᵐᵖˡ)]); (Fooⁱᵈ, []); (ptrTⁱᵈ Fooⁱᵈ, [("mutateBar"%go, Foo__mutateBarⁱᵐᵖˡ)]); (TwoIntsⁱᵈ, []); (ptrTⁱᵈ TwoIntsⁱᵈ, []); (Sⁱᵈ, [("readBVal"%go, S__readBValⁱᵐᵖˡ)]); (ptrTⁱᵈ Sⁱᵈ, [("negateC"%go, S__negateCⁱᵐᵖˡ); ("readA"%go, S__readAⁱᵐᵖˡ); ("readB"%go, S__readBⁱᵐᵖˡ); ("readBVal"%go, (λ: "$recvAddr",
                 method_call #semantics.semantics #"S" #"readBVal" (![#S] "$recvAddr")
                 )%V); ("updateBValX"%go, S__updateBValXⁱᵐᵖˡ)]); (StructWrapⁱᵈ, []); (ptrTⁱᵈ StructWrapⁱᵈ, []); (StructWithFuncⁱᵈ, []); (ptrTⁱᵈ StructWithFuncⁱᵈ, []); (switchConcreteⁱᵈ, []); (ptrTⁱᵈ switchConcreteⁱᵈ, [("marker"%go, switchConcrete__markerⁱᵐᵖˡ)]); (Logⁱᵈ, [("Apply"%go, Log__Applyⁱᵐᵖˡ); ("BeginTxn"%go, Log__BeginTxnⁱᵐᵖˡ); ("Commit"%go, Log__Commitⁱᵐᵖˡ); ("Read"%go, Log__Readⁱᵐᵖˡ); ("Size"%go, Log__Sizeⁱᵐᵖˡ); ("Write"%go, Log__Writeⁱᵐᵖˡ); ("lock"%go, Log__lockⁱᵐᵖˡ); ("unlock"%go, Log__unlockⁱᵐᵖˡ)]); (ptrTⁱᵈ Logⁱᵈ, [("Apply"%go, (λ: "$recvAddr",
