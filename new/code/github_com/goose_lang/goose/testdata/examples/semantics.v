...
#[global] Instance info' : PkgInfo semantics.semantics :=
  {|
    ...
    pkg_msets := msets';
    pkg_imported_pkgs := [github_com.goose_lang.primitive.primitive; sync.sync; github_com.goose_lang.primitive.disk.disk];
  |}.
