...
Definition Cond {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go.type := go.Named "github.com/goose-lang/goose/testdata/examples/channel.Cond"%go [].
...
Definition Lock {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go.type := go.Named "github.com/goose-lang/goose/testdata/examples/channel.Lock"%go [].
...
Definition NewLock {ext : ffi_syntax} {go_gctx : GoGlobalContext} : go_string := "github.com/goose-lang/goose/testdata/examples/channel.NewLock"%go.
...
{|
  pkg_imported_pkgs := [code.time.pkg_id.time; code.sync.pkg_id.sync; code.strings.pkg_id.strings]
|}.
