...
{
  #[global] Box_zero_val T T' `{!ZeroVal T'} `{!go.TypeRepr T T'} :: go.TypeRepr (Box T) (Box.t T');
...
{
  #[global] Container_zero_val T T' `{!ZeroVal T'} `{!go.TypeRepr T T'} :: go.TypeRepr (Container T) (Container.t T');
...
{
  #[global] UseContainer_zero_val  :: go.TypeRepr UseContainer UseContainer.t;
...
{
  #[global] OnlyIndirect_zero_val T T' `{!ZeroVal T'} `{!go.TypeRepr T T'} :: go.TypeRepr (OnlyIndirect T) (OnlyIndirect.t T');
...
{
  #[global] MultiParam_zero_val A A' `{!ZeroVal A'} `{!go.TypeRepr A A'}B B' `{!ZeroVal B'} `{!go.TypeRepr B B'} :: go.TypeRepr (MultiParam A B) (MultiParam.t A' B');
