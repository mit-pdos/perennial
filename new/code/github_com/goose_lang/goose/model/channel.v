...
Definition Select2 : val :=
  rec: "Select2" "T1" "T2" "case1" "case2" "blocking" :=
    ...
    ((func_call #channel.channel #"TrySelectCase2"%go) "T1" "T2") "$a0" "$a1" "$a2") in
    do:  ("selected" <-[#boolT] "$r0");;;
    (if: ![#boolT] "selected"
    ...
    (for: (λ: <>, #true); (λ: <>, Skip) := λ: <>,
      ...
      let: "$r0" := (let: "$a0" := (![#ptrT] "case2") in
      ((func_call #channel.channel #"TrySelect"%go) "T2") "$a0") in
      do:  ("selected" <-[#boolT] "$r0");;;
      (if: ![#boolT] "selected"
      then return: (#(W64 1))
      else do:  #());;;
...
Definition Select3 : val :=
  rec: "Select3" "T1" "T2" "T3" "case1" "case2" "case3" "blocking" :=
    ...
    ((func_call #channel.channel #"TrySelectCase3"%go) "T1" "T2" "T3") "$a0" "$a1" "$a2" "$a3") in
    do:  ("selected" <-[#boolT] "$r0");;;
    (if: ![#boolT] "selected"
    then return: (![#uint64T] "i")
    else do:  #());;;
    (for: (λ: <>, #true); (λ: <>, Skip) := λ: <>,
      ...
      let: "$r0" := (let: "$a0" := (![#ptrT] "case3") in
      ((func_call #channel.channel #"TrySelect"%go) "T3") "$a0") in
      do:  ("selected" <-[#boolT] "$r0");;;
      (if: ![#boolT] "selected"
      then return: (#(W64 2))
      else do:  #());;;
...
Definition Select4 : val :=
  rec: "Select4" "T1" "T2" "T3" "T4" "case1" "case2" "case3" "case4" "blocking" :=
    ...
    ((func_call #channel.channel #"TrySelectCase4"%go) "T1" "T2" "T3" "T4") "$a0" "$a1" "$a2" "$a3" "$a4") in
    do:  ("selected" <-[#boolT] "$r0");;;
    (if: ![#boolT] "selected"
    then return: (![#uint64T] "i")
    else do:  #());;;
    (for: (λ: <>, #true); (λ: <>, Skip) := λ: <>,
      ...
      let: "$r0" := (let: "$a0" := (![#ptrT] "case4") in
      ((func_call #channel.channel #"TrySelect"%go) "T4") "$a0") in
      do:  ("selected" <-[#boolT] "$r0");;;
      (if: ![#boolT] "selected"
      then return: (#(W64 3))
      else do:  #());;;
...
Definition Select5 : val :=
  rec: "Select5" "T1" "T2" "T3" "T4" "T5" "case1" "case2" "case3" "case4" "case5" "blocking" :=
    ...
    ((func_call #channel.channel #"TrySelectCase5"%go) "T1" "T2" "T3" "T4" "T5") "$a0" "$a1" "$a2" "$a3" "$a4" "$a5") in
    do:  ("selected" <-[#boolT] "$r0");;;
    (if: ![#boolT] "selected"
    then return: (![#uint64T] "i")
    else do:  #());;;
    (for: (λ: <>, #true); (λ: <>, Skip) := λ: <>,
      ...
      let: "$r0" := (let: "$a0" := (![#ptrT] "case5") in
      ((func_call #channel.channel #"TrySelect"%go) "T5") "$a0") in
      do:  ("selected" <-[#boolT] "$r0");;;
      (if: ![#boolT] "selected"
      then return: (#(W64 4))
      else do:  #());;;
