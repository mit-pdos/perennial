...
Definition deadlineExceededErrorⁱᵈ : go_string := "context.deadlineExceededError"%go.
...
Definition emptyCtxⁱᵈ : go_string := "context.emptyCtx"%go.
...
Definition backgroundCtxⁱᵈ : go_string := "context.backgroundCtx"%go.
...
Definition todoCtxⁱᵈ : go_string := "context.todoCtx"%go.
...
Definition Backgroundⁱᵐᵖˡ : val :=
  λ: <>,
    exception_do (return: (interface.make #backgroundCtxⁱᵈ (struct.make #backgroundCtx [{
...
Definition TODOⁱᵐᵖˡ : val :=
  λ: <>,
    exception_do (return: (interface.make #todoCtxⁱᵈ (struct.make #todoCtx [{
       "emptyCtx" ::= type.zero_val #emptyCtx
     }]))).
...
Definition cancelCtxⁱᵈ : go_string := "context.cancelCtx"%go.
...
Definition WithCancelⁱᵐᵖˡ : val :=
  λ: "parent",
    ...
    do:  ("c" <-[#ptrT] "$r0");;;
    return: (interface.make #(ptrTⁱᵈ cancelCtxⁱᵈ) (![#ptrT] "c"), (λ: <>,
       exception_do (do:  (let: "$a0" := #true in
       let: "$a1" := (![#error] (globals.get #Canceled)) in
       let: "$a2" := #interface.nil in
       (method_call #(ptrTⁱᵈ cancelCtxⁱᵈ) #"cancel"%go (![#ptrT] "c")) "$a0" "$a1" "$a2");;;
       return: #())
       ))).

Definition CancelCauseFuncⁱᵈ : go_string := "context.CancelCauseFunc"%go.
...
Definition WithCancelCauseⁱᵐᵖˡ : val :=
  λ: "parent",
    ...
    (func_call #withCancel) "$a0") in
    do:  ("c" <-[#ptrT] "$r0");;;
    return: (interface.make #(ptrTⁱᵈ cancelCtxⁱᵈ) (![#ptrT] "c"), (λ: "cause",
...
Definition withCancelⁱᵐᵖˡ : val :=
  λ: "parent",
    ...
    then
      do:  (let: "$a0" := (interface.make #stringTⁱᵈ #"cannot create context from nil parent"%go) in
      Panic "$a0")
    else do:  #());;;
    let: "c" := (mem.alloc (type.zero_val #ptrT)) in
    ...
    let: "$a1" := (interface.make #(ptrTⁱᵈ cancelCtxⁱᵈ) (![#ptrT] "c")) in
    (method_call #(ptrTⁱᵈ cancelCtxⁱᵈ) #"propagateCancel"%go (![#ptrT] "c")) "$a0" "$a1");;;
    return: (![#ptrT] "c")).
...
Definition Causeⁱᵐᵖˡ : val :=
  λ: "c",
    ...
    let: ("$ret0", "$ret1") := (interface.checked_type_assert #ptrT (let: "$a0" := (interface.make #(ptrTⁱᵈ intTⁱᵈ) (globals.get #cancelCtxKey)) in
    (interface.get #"Value"%go (![#Context] "c")) "$a0") #(ptrTⁱᵈ cancelCtxⁱᵈ)) in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    do:  ("cc" <-[#ptrT] "$r0");;;
    do:  ("ok" <-[#boolT] "$r1");;;
    (if: ![#boolT] "ok"
    then
      do:  ((method_call #(ptrTⁱᵈ sync.Mutexⁱᵈ) #"Lock"%go (struct.field_ref #cancelCtx #"mu"%go (![#ptrT] "cc"))) #());;;
      do:  (let: "$f" := (method_call #(ptrTⁱᵈ sync.Mutexⁱᵈ) #"Unlock"%go (struct.field_ref #cancelCtx #"mu"%go (![#ptrT] "cc"))) in
...
Definition afterFuncCtxⁱᵈ : go_string := "context.afterFuncCtx"%go.
...
Definition AfterFuncⁱᵐᵖˡ : val :=
  λ: "ctx" "f",
    ...
    let: "$a1" := (interface.make #(ptrTⁱᵈ afterFuncCtxⁱᵈ) (![#ptrT] "a")) in
    (method_call #(ptrTⁱᵈ cancelCtxⁱᵈ) #"propagateCancel"%go (struct.field_ref #afterFuncCtx #"cancelCtx"%go (![#ptrT] "a"))) "$a0" "$a1");;;
    return: ((λ: <>,
       ...
       (method_call #(ptrTⁱᵈ sync.Onceⁱᵈ) #"Do"%go (struct.field_ref #afterFuncCtx #"once"%go (![#ptrT] "a"))) "$a0");;;
       (if: ![#boolT] "stopped"
       then
         do:  (let: "$a0" := #true in
         let: "$a1" := (![#error] (globals.get #Canceled)) in
         let: "$a2" := #interface.nil in
         (method_call #(ptrTⁱᵈ afterFuncCtxⁱᵈ) #"cancel"%go (![#ptrT] "a")) "$a0" "$a1" "$a2")
       else do:  #());;;
       return: (![#boolT] "stopped"))
       ))).

Definition afterFuncerⁱᵈ : go_string := "context.afterFuncer"%go.
...
Definition afterFuncCtx__cancelⁱᵐᵖˡ : val :=
  λ: "a" "removeFromParent" "err" "cause",
    ...
    let: "$a1" := (![#error] "err") in
    let: "$a2" := (![#error] "cause") in
    (method_call #(ptrTⁱᵈ cancelCtxⁱᵈ) #"cancel"%go (struct.field_ref #afterFuncCtx #"cancelCtx"%go (![#ptrT] "a"))) "$a0" "$a1" "$a2");;;
...
Definition stopCtxⁱᵈ : go_string := "context.stopCtx"%go.
...
Definition parentCancelCtxⁱᵐᵖˡ : val :=
  λ: "parent",
    ...
    let: ("$ret0", "$ret1") := (interface.checked_type_assert #ptrT (let: "$a0" := (interface.make #(ptrTⁱᵈ intTⁱᵈ) (globals.get #cancelCtxKey)) in
    (interface.get #"Value"%go (![#Context] "parent")) "$a0") #(ptrTⁱᵈ cancelCtxⁱᵈ)) in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    do:  ("p" <-[#ptrT] "$r0");;;
    do:  ("ok" <-[#boolT] "$r1");;;
    ...
    ])) ((method_call #(ptrTⁱᵈ atomic.Valueⁱᵈ) #"Load"%go (struct.field_ref #cancelCtx #"done"%go (![#ptrT] "p"))) #()) #(chanTⁱᵈ (structTⁱᵈ []))) in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
...
Definition removeChildⁱᵐᵖˡ : val :=
  λ: "parent" "child",
    ...
    let: ("$ret0", "$ret1") := (interface.checked_type_assert #stopCtx (![#Context] "parent") #stopCtxⁱᵈ) in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    do:  ("s" <-[#stopCtx] "$r0");;;
    do:  ("ok" <-[#boolT] "$r1");;;
    ...
    do:  ((method_call #(ptrTⁱᵈ sync.Mutexⁱᵈ) #"Lock"%go (struct.field_ref #cancelCtx #"mu"%go (![#ptrT] "p"))) #());;;
    ...
    do:  ((method_call #(ptrTⁱᵈ sync.Mutexⁱᵈ) #"Unlock"%go (struct.field_ref #cancelCtx #"mu"%go (![#ptrT] "p"))) #());;;
    return: #()).

Definition cancelerⁱᵈ : go_string := "context.canceler"%go.
...
Definition cancelCtx__Valueⁱᵐᵖˡ : val :=
  λ: "c" "key",
    ...
    (if: interface.eq (![#interfaceT] "key") (interface.make #(ptrTⁱᵈ intTⁱᵈ) (globals.get #cancelCtxKey))
    then return: (interface.make #(ptrTⁱᵈ cancelCtxⁱᵈ) (![#ptrT] "c"))
    else do:  #());;;
...
Definition cancelCtx__Doneⁱᵐᵖˡ : val :=
  λ: "c" <>,
    ...
    let: "$r0" := ((method_call #(ptrTⁱᵈ atomic.Valueⁱᵈ) #"Load"%go (struct.field_ref #cancelCtx #"done"%go (![#ptrT] "c"))) #()) in
    do:  ("d" <-[#interfaceT] "$r0");;;
    (if: (~ (interface.eq (![#interfaceT] "d") #interface.nil))
    then return: (interface.type_assert (![#interfaceT] "d") #(chanTⁱᵈ (structTⁱᵈ [])))
    else do:  #());;;
    do:  ((method_call #(ptrTⁱᵈ sync.Mutexⁱᵈ) #"Lock"%go (struct.field_ref #cancelCtx #"mu"%go (![#ptrT] "c"))) #());;;
    do:  (let: "$f" := (method_call #(ptrTⁱᵈ sync.Mutexⁱᵈ) #"Unlock"%go (struct.field_ref #cancelCtx #"mu"%go (![#ptrT] "c"))) in
    "$defer" <-[#funcT] (let: "$oldf" := (![#funcT] "$defer") in
    (λ: <>,
      "$f" #();;
      "$oldf" #()
    ...
    (if: interface.eq (![#interfaceT] "d") #interface.nil
    then
      let: "$r0" := (interface.make #(chanTⁱᵈ (structTⁱᵈ [])) (chan.make (type.structT [
      ]) #(W64 0))) in
      do:  ("d" <-[#interfaceT] "$r0");;;
      do:  (let: "$a0" := (![#interfaceT] "d") in
      (method_call #(ptrTⁱᵈ atomic.Valueⁱᵈ) #"Store"%go (struct.field_ref #cancelCtx #"done"%go (![#ptrT] "c"))) "$a0")
    else do:  #());;;
    return: (interface.type_assert (![#interfaceT] "d") #(chanTⁱᵈ (structTⁱᵈ [])))).
...
Definition cancelCtx__Errⁱᵐᵖˡ : val :=
  λ: "c" <>,
    ...
    do:  ("err" <-[#error] "$r0");;;
    do:  ((method_call #(ptrTⁱᵈ sync.Mutexⁱᵈ) #"Unlock"%go (struct.field_ref #cancelCtx #"mu"%go (![#ptrT] "c"))) #());;;
    return: (![#error] "err")).
...
Definition cancelCtx__propagateCancelⁱᵐᵖˡ : val :=
  λ: "c" "parent" "child",
    ...
    let: ("$ret0", "$ret1") := (interface.checked_type_assert #afterFuncer (![#Context] "parent") #afterFuncerⁱᵈ) in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    do:  ("a" <-[#afterFuncer] "$r0");;;
    do:  ("ok" <-[#boolT] "$r1");;;
    ...
    then
      ...
      do:  ("stop" <-[#funcT] "$r0");;;
      let: "$r0" := (interface.make #stopCtxⁱᵈ (let: "$Context" := (![#Context] "parent") in
    ...
    do:  (let: "$a0" := #(W32 1) in
    (method_call #(ptrTⁱᵈ atomic.Int32ⁱᵈ) #"Add"%go (globals.get #goroutines)) "$a0");;;
    let: "$go" := (λ: <>,
...
Definition stringerⁱᵈ : go_string := "context.stringer"%go.
...
Definition contextNameⁱᵐᵖˡ : val :=
  λ: "c",
    ...
    let: ("$ret0", "$ret1") := (interface.checked_type_assert #stringer (![#Context] "c") #stringerⁱᵈ) in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    do:  ("s" <-[#stringer] "$r0");;;
    do:  ("ok" <-[#boolT] "$r1");;;
...
Definition cancelCtx__cancelⁱᵐᵖˡ : val :=
  λ: "c" "removeFromParent" "err" "cause",
    ...
    then
      do:  (let: "$a0" := (interface.make #stringTⁱᵈ #"context: internal error: missing cancel error"%go) in
      Panic "$a0")
    else do:  #());;;
    ...
    let: ("$ret0", "$ret1") := (interface.checked_type_assert (type.chanT (type.structT [
    ])) ((method_call #(ptrTⁱᵈ atomic.Valueⁱᵈ) #"Load"%go (struct.field_ref #cancelCtx #"done"%go (![#ptrT] "c"))) #()) #(chanTⁱᵈ (structTⁱᵈ []))) in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    ...
    then
      do:  (let: "$a0" := (interface.make #(chanTⁱᵈ (structTⁱᵈ [])) (![type.chanT (type.structT [
...
Definition withoutCancelCtxⁱᵈ : go_string := "context.withoutCancelCtx"%go.
...
Definition WithoutCancelⁱᵐᵖˡ : val :=
  λ: "parent",
    ...
    return: (interface.make #withoutCancelCtxⁱᵈ (struct.make #withoutCancelCtx [{
       "c" ::= ![#Context] "parent"
     }]))).
...
Definition withoutCancelCtx__Valueⁱᵐᵖˡ : val :=
  λ: "c" "key",
    exception_do (let: "c" := (mem.alloc "c") in
    let: "key" := (mem.alloc "key") in
    return: (let: "$a0" := (interface.make #withoutCancelCtxⁱᵈ (![#withoutCancelCtx] "c")) in
     let: "$a1" := (![#interfaceT] "key") in
     (func_call #value) "$a0" "$a1")).
...
Definition timerCtxⁱᵈ : go_string := "context.timerCtx"%go.
...
Definition WithDeadlineCauseⁱᵐᵖˡ : val :=
  λ: "parent" "d" "cause",
    ...
    (method_call #time.Timeⁱᵈ #"Before"%go (![#time.Time] "cur")) "$a0")
    then
      let: ("$ret0", "$ret1") := ((let: "$a0" := (![#Context] "parent") in
      (func_call #WithCancel) "$a0")) in
      return: ("$ret0", "$ret1")
    ...
    do:  ("c" <-[#ptrT] "$r0");;;
    do:  (let: "$a0" := (![#Context] "parent") in
    let: "$a1" := (interface.make #(ptrTⁱᵈ timerCtxⁱᵈ) (![#ptrT] "c")) in
    (method_call #(ptrTⁱᵈ cancelCtxⁱᵈ) #"propagateCancel"%go (struct.field_ref #timerCtx #"cancelCtx"%go (![#ptrT] "c"))) "$a0" "$a1");;;
    ...
    then
      ...
      let: "$a2" := (![#error] "cause") in
      (method_call #(ptrTⁱᵈ timerCtxⁱᵈ) #"cancel"%go (![#ptrT] "c")) "$a0" "$a1" "$a2");;;
      return: (interface.make #(ptrTⁱᵈ timerCtxⁱᵈ) (![#ptrT] "c"), (λ: <>,
         exception_do (do:  (let: "$a0" := #false in
         let: "$a1" := (![#error] (globals.get #Canceled)) in
         let: "$a2" := #interface.nil in
         (method_call #(ptrTⁱᵈ timerCtxⁱᵈ) #"cancel"%go (![#ptrT] "c")) "$a0" "$a1" "$a2");;;
    ...
    do:  ((method_call #(ptrTⁱᵈ sync.Mutexⁱᵈ) #"Lock"%go (struct.field_ref #cancelCtx #"mu"%go (struct.field_ref #timerCtx #"cancelCtx"%go (![#ptrT] "c")))) #());;;
    do:  (let: "$f" := (method_call #(ptrTⁱᵈ sync.Mutexⁱᵈ) #"Unlock"%go (struct.field_ref #cancelCtx #"mu"%go (struct.field_ref #timerCtx #"cancelCtx"%go (![#ptrT] "c")))) in
    "$defer" <-[#funcT] (let: "$oldf" := (![#funcT] "$defer") in
    (λ: <>,
      "$f" #();;
      "$oldf" #()
...
Definition timerCtx__Stringⁱᵐᵖˡ : val :=
  λ: "c" <>,
    ...
    return: ((((((let: "$a0" := (![#Context] (struct.field_ref #cancelCtx #"Context"%go (struct.field_ref #timerCtx #"cancelCtx"%go (![#ptrT] "c")))) in
     (func_call #contextName) "$a0") + #".WithDeadline("%go) + ((method_call #time.Timeⁱᵈ #"String"%go (![#time.Time] (struct.field_ref #timerCtx #"deadline"%go (![#ptrT] "c")))) #())) + #" ["%go) + ((method_call #time.Durationⁱᵈ #"String"%go (let: "$a0" := (![#time.Time] (struct.field_ref #timerCtx #"deadline"%go (![#ptrT] "c"))) in
...
Definition timerCtx__cancelⁱᵐᵖˡ : val :=
  λ: "c" "removeFromParent" "err" "cause",
    ...
    let: "$a1" := (![#error] "err") in
    let: "$a2" := (![#error] "cause") in
    (method_call #(ptrTⁱᵈ cancelCtxⁱᵈ) #"cancel"%go (struct.field_ref #timerCtx #"cancelCtx"%go (![#ptrT] "c"))) "$a0" "$a1" "$a2");;;
    (if: ![#boolT] "removeFromParent"
    then
    ...
    then
      do:  ((method_call #(ptrTⁱᵈ time.Timerⁱᵈ) #"Stop"%go (![#ptrT] (struct.field_ref #timerCtx #"timer"%go (![#ptrT] "c")))) #());;;
      let: "$r0" := #null in
      do:  ((struct.field_ref #timerCtx #"timer"%go (![#ptrT] "c")) <-[#ptrT] "$r0")
    else do:  #());;;
    do:  ((method_call #(ptrTⁱᵈ sync.Mutexⁱᵈ) #"Unlock"%go (struct.field_ref #cancelCtx #"mu"%go (struct.field_ref #timerCtx #"cancelCtx"%go (![#ptrT] "c")))) #());;;
    return: #()).
...
Definition WithTimeoutⁱᵐᵖˡ : val :=
  λ: "parent" "timeout",
    ...
    (method_call #time.Timeⁱᵈ #"Add"%go ((func_call #time.Now) #())) "$a0") in
...
Definition valueCtxⁱᵈ : go_string := "context.valueCtx"%go.
...
Definition WithValueⁱᵐᵖˡ : val :=
  λ: "parent" "key" "val",
    ...
    then
      do:  (let: "$a0" := (interface.make #stringTⁱᵈ #"nil key"%go) in
      Panic "$a0")
    else do:  #());;;
    (if: (~ ((interface.get #"Comparable"%go (let: "$a0" := (![#interfaceT] "key") in
    (func_call #reflectlite.TypeOf) "$a0")) #()))
    then
      do:  (let: "$a0" := (interface.make #stringTⁱᵈ #"key is not comparable"%go) in
      Panic "$a0")
    else do:  #());;;
    return: (interface.make #(ptrTⁱᵈ valueCtxⁱᵈ) (mem.alloc (struct.make #valueCtx [{
...
Definition stringifyⁱᵐᵖˡ : val :=
  λ: "v",
    ...
    let: ("$x", "$ok") := (interface.checked_type_assert #stringer "$y" #stringerⁱᵈ) in
    (if: "$ok"
    then
...
Definition valueⁱᵐᵖˡ : val :=
  λ: "c" "key",
    ...
    (for: (λ: <>, #true); (λ: <>, #()) := λ: <>,
      let: "$y" := (![#Context] "c") in
      let: ("$x", "$ok") := (interface.checked_type_assert #ptrT "$y" #(ptrTⁱᵈ valueCtxⁱᵈ)) in
      (if: "$ok"
      then
        ...
        let: ("$x", "$ok") := (interface.checked_type_assert #ptrT "$y" #(ptrTⁱᵈ cancelCtxⁱᵈ)) in
        (if: "$ok"
        then
          let: "ctx" := (mem.alloc "$x") in
          (if: interface.eq (![#interfaceT] "key") (interface.make #(ptrTⁱᵈ intTⁱᵈ) (globals.get #cancelCtxKey))
          ...
          let: ("$x", "$ok") := (interface.checked_type_assert #withoutCancelCtx "$y" #withoutCancelCtxⁱᵈ) in
          (if: "$ok"
          then
            let: "ctx" := (mem.alloc "$x") in
            (if: interface.eq (![#interfaceT] "key") (interface.make #(ptrTⁱᵈ intTⁱᵈ) (globals.get #cancelCtxKey))
            ...
            let: ("$x", "$ok") := (interface.checked_type_assert #ptrT "$y" #(ptrTⁱᵈ timerCtxⁱᵈ)) in
            (if: "$ok"
            then
              let: "ctx" := (mem.alloc "$x") in
              (if: interface.eq (![#interfaceT] "key") (interface.make #(ptrTⁱᵈ intTⁱᵈ) (globals.get #cancelCtxKey))
              then return: (interface.make #(ptrTⁱᵈ cancelCtxⁱᵈ) (struct.field_ref #timerCtx #"cancelCtx"%go (![#ptrT] "ctx")))
              else do:  #());;;
              let: "$r0" := (![#Context] (struct.field_ref #cancelCtx #"Context"%go (struct.field_ref #timerCtx #"cancelCtx"%go (![#ptrT] "ctx")))) in
              do:  ("c" <-[#Context] "$r0")
            else
              let: "$ok" := ((Snd (interface.checked_type_assert #backgroundCtx "$y" #backgroundCtxⁱᵈ)) || (Snd (interface.checked_type_assert #backgroundCtx "$y" #backgroundCtxⁱᵈ))) in
              let: "$x" := "$y" in
              (if: "$ok"
              then
                let: "ctx" := (mem.alloc "$x") in
...
Definition msets' : list (go_string * (list (go_string * val))) := [(deadlineExceededErrorⁱᵈ, [("Error"%go, deadlineExceededError__Errorⁱᵐᵖˡ); ("Temporary"%go, deadlineExceededError__Temporaryⁱᵐᵖˡ); ("Timeout"%go, deadlineExceededError__Timeoutⁱᵐᵖˡ)]); (ptrTⁱᵈ deadlineExceededErrorⁱᵈ, [("Error"%go, (λ: "$recvAddr",
                 ...
                 )%V)]); (emptyCtxⁱᵈ, [("Deadline"%go, emptyCtx__Deadlineⁱᵐᵖˡ); ("Done"%go, emptyCtx__Doneⁱᵐᵖˡ); ("Err"%go, emptyCtx__Errⁱᵐᵖˡ); ("Value"%go, emptyCtx__Valueⁱᵐᵖˡ)]); (ptrTⁱᵈ emptyCtxⁱᵈ, [("Deadline"%go, (λ: "$recvAddr",
                 ...
                 )%V)]); (backgroundCtxⁱᵈ, [("Deadline"%go, (λ: "$recv",
                 ...
                 )%V)]); (ptrTⁱᵈ backgroundCtxⁱᵈ, [("Deadline"%go, (λ: "$recvAddr",
                 ...
                 )%V)]); (todoCtxⁱᵈ, [("Deadline"%go, (λ: "$recv",
                 ...
                 )%V)]); (ptrTⁱᵈ todoCtxⁱᵈ, [("Deadline"%go, (λ: "$recvAddr",
                 ...
                 )%V)]); (CancelFuncⁱᵈ, []); (ptrTⁱᵈ CancelFuncⁱᵈ, []); (CancelCauseFuncⁱᵈ, []); (ptrTⁱᵈ CancelCauseFuncⁱᵈ, []); (afterFuncCtxⁱᵈ, [("Deadline"%go, (λ: "$recv",
                 interface.get #"Deadline"%go (struct.field_get #cancelCtx "Context" (struct.field_get #afterFuncCtx "cancelCtx" "$recv"))
                 )%V)]); (ptrTⁱᵈ afterFuncCtxⁱᵈ, [("Deadline"%go, (λ: "$recvAddr",
                 ...
                 )%V)]); (stopCtxⁱᵈ, [("Deadline"%go, (λ: "$recv",
                 ...
                 )%V)]); (ptrTⁱᵈ stopCtxⁱᵈ, [("Deadline"%go, (λ: "$recvAddr",
                 ...
                 )%V)]); (timerCtxⁱᵈ, []); (ptrTⁱᵈ timerCtxⁱᵈ, [("Deadline"%go, timerCtx__Deadlineⁱᵐᵖˡ); ("Done"%go, (λ: "$recvAddr",
                 ...
                 )%V)]); (valueCtxⁱᵈ, [("Deadline"%go, (λ: "$recv",
                 ...
                 )%V)]); (ptrTⁱᵈ valueCtxⁱᵈ, [("Deadline"%go, (λ: "$recvAddr",
...
#[global] Instance info' : PkgInfo context.context :=
  {|
    ...
    pkg_msets := msets';
    pkg_imported_pkgs := [errors.errors; reflectlite.reflectlite; sync.sync; atomic.atomic; time.time];
  |}.
...
Definition initialize' : val :=
  λ: <>,
    package.init #context.context (λ: <>,
      ...
      let: "$r0" := (interface.make #deadlineExceededErrorⁱᵈ (struct.make #deadlineExceededError [{
      }])) in
