...
Axiom EtcdServer__processInternalRaftRequestOnceⁱᵐᵖˡ : val.
...
#[global] Instance info' : PkgInfo etcdserver.etcdserver :=
  {|
    ...
    pkg_msets := msets';
    pkg_imported_pkgs := [code.context.context; code.go_etcd_io.etcd.api.v3.etcdserverpb.etcdserverpb; code.go_etcd_io.etcd.api.v3.etcdserverpb.etcdserverpb; code.go_etcd_io.etcd.pkg.v3.traceutil.traceutil; code.github_com.gogo.protobuf.proto.proto];
  |}.
