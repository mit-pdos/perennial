...
Definition raftⁱᵈ : go_string := "go.etcd.io/raft/v3.raft"%go.
...
Definition raftLogⁱᵈ : go_string := "go.etcd.io/raft/v3.raftLog"%go.
...
Definition RawNode__Bootstrapⁱᵐᵖˡ : val :=
  λ: "rn" "peers",
    ...
    do:  (let: "$a0" := #(W64 1) in
    let: "$a1" := None in
    (method_call #(ptrTⁱᵈ raftⁱᵈ) #"becomeFollower"%go (![#ptrT] (struct.field_ref #RawNode #"raft"%go (![#ptrT] "rn")))) "$a0" "$a1");;;
    ...
    slice.for_range #Peer "$range" (λ: "$key" "$value",
      ...
      let: ("$ret0", "$ret1") := ((method_call #(ptrTⁱᵈ raftpb.ConfChangeⁱᵈ) #"Marshal"%go "cc") #()) in
      let: "$r0" := "$ret0" in
      let: "$r1" := "$ret1" in
      do:  ("data" <-[#sliceT] "$r0");;;
      do:  ("err" <-[#error] "$r1");;;
    ...
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"append"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] (struct.field_ref #RawNode #"raft"%go (![#ptrT] "rn")))))) "$a0");;;
    ...
    slice.for_range #Peer "$range" (λ: "$key" "$value",
      do:  ("peer" <-[#Peer] "$value");;;
      do:  "$key";;;
      do:  (let: "$a0" := ((method_call #raftpb.ConfChangeⁱᵈ #"AsV2"%go (let: "$NodeID" := (![#uint64T] (struct.field_ref #Peer #"ID"%go "peer")) in
      ...
      (method_call #(ptrTⁱᵈ raftⁱᵈ) #"applyConfChange"%go (![#ptrT] (struct.field_ref #RawNode #"raft"%go (![#ptrT] "rn")))) "$a0")));;;
...
Definition raftLog__Stringⁱᵐᵖˡ : val :=
  λ: "l" <>,
    ...
    return: (let: "$a0" := #"committed=%d, applied=%d, applying=%d, unstable.offset=%d, unstable.offsetInProgress=%d, len(unstable.Entries)=%d"%go in
     let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftLog #"committed"%go (![#ptrT] "l")))) in
     let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftLog #"applied"%go (![#ptrT] "l")))) in
     let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftLog #"applying"%go (![#ptrT] "l")))) in
     let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #unstable #"offset"%go (struct.field_ref #raftLog #"unstable"%go (![#ptrT] "l"))))) in
     let: "$sl4" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #unstable #"offsetInProgress"%go (struct.field_ref #raftLog #"unstable"%go (![#ptrT] "l"))))) in
     let: "$sl5" := (interface.make #intTⁱᵈ (let: "$a0" := (![#sliceT] (struct.field_ref #unstable #"entries"%go (struct.field_ref #raftLog #"unstable"%go (![#ptrT] "l")))) in
     slice.len "$a0")) in
...
Definition raftLog__maybeAppendⁱᵐᵖˡ : val :=
  λ: "l" "a" "committed",
    ...
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"matchTerm"%go (![#ptrT] "l")) "$a0"))
    ...
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"findConflict"%go (![#ptrT] "l")) "$a0") in
    do:  ("ci" <-[#uint64T] "$r0");;;
    let: "$sw" := #true in
    ...
    then do:  #()
      ...
      then
        ...
        let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] "ci")) in
        let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftLog #"committed"%go (![#ptrT] "l")))) in
        ...
        then
          ...
          let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ ((![#uint64T] "ci") - (![#uint64T] "offset"))) in
          let: "$sl1" := (interface.make #intTⁱᵈ (let: "$a0" := (![#sliceT] (struct.field_ref #logSlice #"entries"%go "a")) in
          slice.len "$a0")) in
          slice.literal #interfaceT ["$sl0"; "$sl1"])) in
          (interface.get #"Panicf"%go (![#Logger] (struct.field_ref #raftLog #"logger"%go (![#ptrT] "l")))) "$a0" "$a1")
        else do:  #());;;
        ...
        (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"append"%go (![#ptrT] "l")) "$a0")));;;
    do:  (let: "$a0" := (let: "$a0" := (![#uint64T] "committed") in
    let: "$a1" := (![#uint64T] "lastnewi") in
    (minUint64 2) "$a0" "$a1") in
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"commitTo"%go (![#ptrT] "l")) "$a0");;;
    return: (![#uint64T] "lastnewi", #true)).

Definition unstableⁱᵈ : go_string := "go.etcd.io/raft/v3.unstable"%go.
...
Definition raftLog__appendⁱᵐᵖˡ : val :=
  λ: "l" "ents",
    ...
    slice.len "$a0") = #(W64 0)
    then return: ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] "l")) #())
    else do:  #());;;
    ...
    then
      ...
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] "after")) in
      let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftLog #"committed"%go (![#ptrT] "l")))) in
      slice.literal #interfaceT ["$sl0"; "$sl1"])) in
      (interface.get #"Panicf"%go (![#Logger] (struct.field_ref #raftLog #"logger"%go (![#ptrT] "l")))) "$a0" "$a1")
    else do:  #()));;;
    do:  (let: "$a0" := (![#sliceT] "ents") in
    (method_call #(ptrTⁱᵈ unstableⁱᵈ) #"truncateAndAppend"%go (struct.field_ref #raftLog #"unstable"%go (![#ptrT] "l"))) "$a0");;;
    return: ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] "l")) #())).
...
Definition raftLog__findConflictⁱᵐᵖˡ : val :=
  λ: "l" "ents",
    ...
    slice.for_range #raftpb.Entry "$range" (λ: "$key" "$value",
      ...
      (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"matchTerm"%go (![#ptrT] "l")) "$a0"))
      then
        (if: (![#uint64T] (struct.field_ref #entryID #"index"%go "id")) ≤ ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] "l")) #())
        then
          do:  (let: "$a0" := #"found conflict at index %d [existing term: %d, conflicting term: %d]"%go in
          let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"index"%go "id"))) in
          let: "$sl1" := (interface.make #uint64Tⁱᵈ (let: ("$ret0", "$ret1") := ((let: "$a0" := (![#uint64T] (struct.field_ref #entryID #"index"%go "id")) in
          (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"term"%go (![#ptrT] "l")) "$a0")) in
          let: "$a0" := "$ret0" in
          let: "$a1" := "$ret1" in
          (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"zeroTermOnOutOfBounds"%go (![#ptrT] "l")) "$a0" "$a1")) in
          let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"term"%go "id"))) in
...
Definition raftLog__nextUnstableEntsⁱᵐᵖˡ : val :=
  λ: "l" <>,
    exception_do (let: "l" := (mem.alloc "l") in
    return: ((method_call #(ptrTⁱᵈ unstableⁱᵈ) #"nextEntries"%go (struct.field_ref #raftLog #"unstable"%go (![#ptrT] "l"))) #())).
...
Definition raftLog__hasNextUnstableEntsⁱᵐᵖˡ : val :=
  λ: "l" <>,
    exception_do (let: "l" := (mem.alloc "l") in
    return: (int_gt (let: "$a0" := ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"nextUnstableEnts"%go (![#ptrT] "l")) #()) in
     slice.len "$a0") #(W64 0))).
...
Definition entryEncodingSizeⁱᵈ : go_string := "go.etcd.io/raft/v3.entryEncodingSize"%go.
...
Definition raftLog__nextCommittedEntsⁱᵐᵖˡ : val :=
  λ: "l" "allowUnstable",
    ...
    (if: (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"hasNextOrInProgressSnapshot"%go (![#ptrT] "l")) #()
    then return: (#slice.nil)
    else do:  #());;;
    ...
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"maxAppliableIndex"%go (![#ptrT] "l")) "$a0") + #(W64 1)) in
    do:  ("lo" <-[#uint64T] "$r0");;;
    do:  ("hi" <-[#uint64T] "$r1");;;
    ...
    then
      ...
      let: "$a1" := ((let: "$sl0" := (interface.make #entryEncodingSizeⁱᵈ (![#entryEncodingSize] (struct.field_ref #raftLog #"maxApplyingEntsSize"%go (![#ptrT] "l")))) in
      let: "$sl1" := (interface.make #entryEncodingSizeⁱᵈ (![#entryEncodingSize] (struct.field_ref #raftLog #"applyingEntsSize"%go (![#ptrT] "l")))) in
      let: "$sl2" := (interface.make #entryEncodingSizeⁱᵈ (![#entryEncodingSize] "maxSize")) in
      slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"])) in
      (interface.get #"Panicf"%go (![#Logger] (struct.field_ref #raftLog #"logger"%go (![#ptrT] "l")))) "$a0" "$a1")
    else do:  #());;;
    let: "err" := (mem.alloc (type.zero_val #error)) in
    ...
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"slice"%go (![#ptrT] "l")) "$a0" "$a1" "$a2") in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    do:  ("ents" <-[#sliceT] "$r0");;;
    do:  ("err" <-[#error] "$r1");;;
...
Definition raftLog__nextUnstableSnapshotⁱᵐᵖˡ : val :=
  λ: "l" <>,
    exception_do (let: "l" := (mem.alloc "l") in
    return: ((method_call #(ptrTⁱᵈ unstableⁱᵈ) #"nextSnapshot"%go (struct.field_ref #raftLog #"unstable"%go (![#ptrT] "l"))) #())).
...
Definition raftLog__hasNextUnstableSnapshotⁱᵐᵖˡ : val :=
  λ: "l" <>,
    exception_do (let: "l" := (mem.alloc "l") in
    return: (((method_call #(ptrTⁱᵈ unstableⁱᵈ) #"nextSnapshot"%go (struct.field_ref #raftLog #"unstable"%go (![#ptrT] "l"))) #()) ≠ #null)).
...
Definition raftLog__firstIndexⁱᵐᵖˡ : val :=
  λ: "l" <>,
    ...
    let: ("$ret0", "$ret1") := ((method_call #(ptrTⁱᵈ unstableⁱᵈ) #"maybeFirstIndex"%go (struct.field_ref #raftLog #"unstable"%go (![#ptrT] "l"))) #()) in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    do:  ("i" <-[#uint64T] "$r0");;;
    do:  ("ok" <-[#boolT] "$r1");;;
...
Definition raftLog__lastIndexⁱᵐᵖˡ : val :=
  λ: "l" <>,
    ...
    (let: "ok" := (mem.alloc (type.zero_val #boolT)) in
    let: "i" := (mem.alloc (type.zero_val #uint64T)) in
    let: ("$ret0", "$ret1") := ((method_call #(ptrTⁱᵈ unstableⁱᵈ) #"maybeLastIndex"%go (struct.field_ref #raftLog #"unstable"%go (![#ptrT] "l"))) #()) in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    do:  ("i" <-[#uint64T] "$r0");;;
    do:  ("ok" <-[#boolT] "$r1");;;
...
Definition raftLog__commitToⁱᵐᵖˡ : val :=
  λ: "l" "tocommit",
    ...
    then
      (if: ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] "l")) #()) < (![#uint64T] "tocommit")
      then
        do:  (let: "$a0" := #"tocommit(%d) is out of range [lastIndex(%d)]. Was the raft log corrupted, truncated, or lost?"%go in
        let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] "tocommit")) in
        let: "$sl1" := (interface.make #uint64Tⁱᵈ ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] "l")) #())) in
        slice.literal #interfaceT ["$sl0"; "$sl1"])) in
        (interface.get #"Panicf"%go (![#Logger] (struct.field_ref #raftLog #"logger"%go (![#ptrT] "l")))) "$a0" "$a1")
      else do:  #());;;
...
Definition raftLog__appliedToⁱᵐᵖˡ : val :=
  λ: "l" "i" "size",
    ...
    then
      ...
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] "i")) in
      let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftLog #"applied"%go (![#ptrT] "l")))) in
      let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftLog #"committed"%go (![#ptrT] "l")))) in
      slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"])) in
      (interface.get #"Panicf"%go (![#Logger] (struct.field_ref #raftLog #"logger"%go (![#ptrT] "l")))) "$a0" "$a1")
    else do:  #());;;
    let: "$r0" := (![#uint64T] "i") in
...
Definition raftLog__acceptApplyingⁱᵐᵖˡ : val :=
  λ: "l" "i" "size" "allowUnstable",
    ...
    then
      ...
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] "i")) in
      let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftLog #"applying"%go (![#ptrT] "l")))) in
      let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftLog #"committed"%go (![#ptrT] "l")))) in
      slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"])) in
      (interface.get #"Panicf"%go (![#Logger] (struct.field_ref #raftLog #"logger"%go (![#ptrT] "l")))) "$a0" "$a1")
    else do:  #());;;
    ...
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"maxAppliableIndex"%go (![#ptrT] "l")) "$a0"))) in
    do:  ((struct.field_ref #raftLog #"applyingEntsPaused"%go (![#ptrT] "l")) <-[#boolT] "$r0");;;
    return: #()).
...
Definition raftLog__stableToⁱᵐᵖˡ : val :=
  λ: "l" "id",
    ...
    (method_call #(ptrTⁱᵈ unstableⁱᵈ) #"stableTo"%go (struct.field_ref #raftLog #"unstable"%go (![#ptrT] "l"))) "$a0");;;
    return: #()).
...
Definition raftLog__stableSnapToⁱᵐᵖˡ : val :=
  λ: "l" "i",
    ...
    (method_call #(ptrTⁱᵈ unstableⁱᵈ) #"stableSnapTo"%go (struct.field_ref #raftLog #"unstable"%go (![#ptrT] "l"))) "$a0");;;
    return: #()).
...
Definition raftLog__acceptUnstableⁱᵐᵖˡ : val :=
  λ: "l" <>,
    exception_do (let: "l" := (mem.alloc "l") in
    do:  ((method_call #(ptrTⁱᵈ unstableⁱᵈ) #"acceptInProgress"%go (struct.field_ref #raftLog #"unstable"%go (![#ptrT] "l"))) #());;;
    return: #()).
...
Definition raftLog__lastEntryIDⁱᵐᵖˡ : val :=
  λ: "l" <>,
    exception_do (let: "l" := (mem.alloc "l") in
    let: "index" := (mem.alloc (type.zero_val #uint64T)) in
    let: "$r0" := ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] "l")) #()) in
    do:  ("index" <-[#uint64T] "$r0");;;
    let: "err" := (mem.alloc (type.zero_val #error)) in
    ...
    then
      ...
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] "index")) in
...
Definition raftLog__termⁱᵐᵖˡ : val :=
  λ: "l" "i",
    ...
    (method_call #(ptrTⁱᵈ unstableⁱᵈ) #"maybeTerm"%go (struct.field_ref #raftLog #"unstable"%go (![#ptrT] "l"))) "$a0") in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    do:  ("t" <-[#uint64T] "$r0");;;
    do:  ("ok" <-[#boolT] "$r1");;;
    ...
    (if: ((![#uint64T] "i") + #(W64 1)) < ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"firstIndex"%go (![#ptrT] "l")) #())
    then return: (#(W64 0), ![#error] (globals.get #ErrCompacted))
    else do:  #());;;
    (if: (![#uint64T] "i") > ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] "l")) #())
...
Definition raftLog__entriesⁱᵐᵖˡ : val :=
  λ: "l" "i" "maxSize",
    ...
    let: ("$ret0", "$ret1") := ((let: "$a0" := (![#uint64T] "i") in
    let: "$a1" := (((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] "l")) #()) + #(W64 1)) in
    let: "$a2" := (![#entryEncodingSize] "maxSize") in
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"slice"%go (![#ptrT] "l")) "$a0" "$a1" "$a2")) in
    return: ("$ret0", "$ret1")).
...
Definition raftLog__allEntriesⁱᵐᵖˡ : val :=
  λ: "l" <>,
    ...
    let: "err" := (mem.alloc (type.zero_val #error)) in
    let: "ents" := (mem.alloc (type.zero_val #sliceT)) in
    let: ("$ret0", "$ret1") := (let: "$a0" := ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"firstIndex"%go (![#ptrT] "l")) #()) in
    let: "$a1" := #(W64 noLimit) in
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"entries"%go (![#ptrT] "l")) "$a0" "$a1") in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    do:  ("ents" <-[#sliceT] "$r0");;;
    do:  ("err" <-[#error] "$r1");;;
    ...
    then return: ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"allEntries"%go (![#ptrT] "l")) #())
    else do:  #());;;
    do:  (let: "$a0" := (![#error] "err") in
    Panic "$a0")).
...
Definition raftLog__isUpToDateⁱᵐᵖˡ : val :=
  λ: "l" "their",
    ...
    let: "$r0" := ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastEntryID"%go (![#ptrT] "l")) #()) in
    do:  ("our" <-[#entryID] "$r0");;;
...
Definition raftLog__restoreⁱᵐᵖˡ : val :=
  λ: "l" "s",
    ...
    let: "$a1" := ((let: "$sl0" := (interface.make #(ptrTⁱᵈ raftLogⁱᵈ) (![#ptrT] "l")) in
    let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.SnapshotMetadata #"Index"%go (struct.field_ref #raftpb.Snapshot #"Metadata"%go "s")))) in
    let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.SnapshotMetadata #"Term"%go (struct.field_ref #raftpb.Snapshot #"Metadata"%go "s")))) in
    slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"])) in
    (interface.get #"Infof"%go (![#Logger] (struct.field_ref #raftLog #"logger"%go (![#ptrT] "l")))) "$a0" "$a1");;;
    ...
    (method_call #(ptrTⁱᵈ unstableⁱᵈ) #"restore"%go (struct.field_ref #raftLog #"unstable"%go (![#ptrT] "l"))) "$a0");;;
    return: #()).
      ...
      then return: (![#error] "err")
        ...
        then
          return: (let: "$a0" := #"got 0 entries in [%d, %d)"%go in
           let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] "lo")) in
           let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] "hi")) in
           slice.literal #interfaceT ["$sl0"; "$sl1"])) in
...
Definition raftLog__sliceⁱᵐᵖˡ : val :=
  λ: "l" "lo" "hi" "maxSize",
    ...
    let: "$a1" := (![#uint64T] "hi") in
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"mustCheckOutOfBounds"%go (![#ptrT] "l")) "$a0" "$a1") in
    do:  ("err" <-[#error] "$r0");;;
    (if: (~ (interface.eq (![#error] "err") #interface.nil))
    ...
    then
      ...
      let: "$a1" := (![#uint64T] "hi") in
      (method_call #(ptrTⁱᵈ unstableⁱᵈ) #"slice"%go (struct.field_ref #raftLog #"unstable"%go (![#ptrT] "l"))) "$a0" "$a1") in
    ...
    then return: (#slice.nil, ![#error] "err")
      ...
      then
        ...
        let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] "lo")) in
        let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] "cut")) in
        slice.literal #interfaceT ["$sl0"; "$sl1"])) in
        (interface.get #"Panicf"%go (![#Logger] (struct.field_ref #raftLog #"logger"%go (![#ptrT] "l")))) "$a0" "$a1")
      else
        (if: (~ (interface.eq (![#error] "err") #interface.nil))
...
Definition raftLog__mustCheckOutOfBoundsⁱᵐᵖˡ : val :=
  λ: "l" "lo" "hi",
    ...
    let: "$r0" := ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"firstIndex"%go (![#ptrT] "l")) #()) in
    do:  ("fi" <-[#uint64T] "$r0");;;
    (if: (![#uint64T] "lo") < (![#uint64T] "fi")
    then return: (![#error] (globals.get #ErrCompacted))
    else do:  #());;;
    let: "length" := (mem.alloc (type.zero_val #uint64T)) in
    let: "$r0" := ((((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] "l")) #()) + #(W64 1)) - (![#uint64T] "fi")) in
    ...
    then
      ...
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] "lo")) in
      let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] "hi")) in
      let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] "fi")) in
      let: "$sl3" := (interface.make #uint64Tⁱᵈ ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] "l")) #())) in
...
Definition unstable__maybeTermⁱᵐᵖˡ : val :=
  λ: "u" "i",
    ...
    let: ("$ret0", "$ret1") := ((method_call #(ptrTⁱᵈ unstableⁱᵈ) #"maybeLastIndex"%go (![#ptrT] "u")) #()) in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    do:  ("last" <-[#uint64T] "$r0");;;
    do:  ("ok" <-[#boolT] "$r1");;;
...
Definition unstable__stableToⁱᵐᵖˡ : val :=
  λ: "u" "id",
    ...
    let: ("$ret0", "$ret1") := (let: "$a0" := (![#uint64T] (struct.field_ref #entryID #"index"%go "id")) in
    (method_call #(ptrTⁱᵈ unstableⁱᵈ) #"maybeTerm"%go (![#ptrT] "u")) "$a0") in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    do:  ("gt" <-[#uint64T] "$r0");;;
    do:  ("ok" <-[#boolT] "$r1");;;
    ...
    then
      ...
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"index"%go "id"))) in
      let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"term"%go "id"))) in
      let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"index"%go "id"))) in
      let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] "gt")) in
      slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"])) in
      (interface.get #"Infof"%go (![#Logger] (struct.field_ref #unstable #"logger"%go (![#ptrT] "u")))) "$a0" "$a1");;;
      return: (#())
    else do:  #());;;
    ...
    (maxUint64 2) "$a0" "$a1") in
    do:  ((struct.field_ref #unstable #"offsetInProgress"%go (![#ptrT] "u")) <-[#uint64T] "$r0");;;
    do:  ((method_call #(ptrTⁱᵈ unstableⁱᵈ) #"shrinkEntriesArray"%go (![#ptrT] "u")) #());;;
    return: #()).
  ...
  λ: "u" "ents",
    ...
    then
      ...
      then
        ...
        let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] "fromIndex")) in
        slice.literal #interfaceT ["$sl0"])) in
        (interface.get #"Infof"%go (![#Logger] (struct.field_ref #unstable #"logger"%go (![#ptrT] "u")))) "$a0" "$a1");;;
        ...
        (method_call #(ptrTⁱᵈ unstableⁱᵈ) #"slice"%go (![#ptrT] "u")) "$a0" "$a1") in
        do:  ("keep" <-[#sliceT] "$r0");;;
...
Definition unstable__sliceⁱᵐᵖˡ : val :=
  λ: "u" "lo" "hi",
    ...
    let: "$a1" := (![#uint64T] "hi") in
    (method_call #(ptrTⁱᵈ unstableⁱᵈ) #"mustCheckOutOfBounds"%go (![#ptrT] "u")) "$a0" "$a1");;;
    return: (let: "$s" := (![#sliceT] (struct.field_ref #unstable #"entries"%go (![#ptrT] "u"))) in
...
Definition unstable__mustCheckOutOfBoundsⁱᵐᵖˡ : val :=
  λ: "u" "lo" "hi",
    ...
    then
      ...
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] "lo")) in
      let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] "hi")) in
      let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #unstable #"offset"%go (![#ptrT] "u")))) in
      let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] "upper")) in
      slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"])) in
      (interface.get #"Panicf"%go (![#Logger] (struct.field_ref #unstable #"logger"%go (![#ptrT] "u")))) "$a0" "$a1")
    else do:  #());;;
    return: #()).

Definition Loggerⁱᵈ : go_string := "go.etcd.io/raft/v3.Logger"%go.
...
Definition SetLoggerⁱᵐᵖˡ : val :=
  λ: "l",
    exception_do (let: "l" := (mem.alloc "l") in
    do:  ((method_call #(ptrTⁱᵈ sync.Mutexⁱᵈ) #"Lock"%go (globals.get #raftLoggerMu)) #());;;
    let: "$r0" := (![#Logger] "l") in
    do:  ((globals.get #raftLogger) <-[#Logger] "$r0");;;
    do:  ((method_call #(ptrTⁱᵈ sync.Mutexⁱᵈ) #"Unlock"%go (globals.get #raftLoggerMu)) #());;;
    return: #()).
...
Definition ResetDefaultLoggerⁱᵐᵖˡ : val :=
  λ: <>,
    exception_do (do:  (let: "$a0" := (interface.make #(ptrTⁱᵈ DefaultLoggerⁱᵈ) (![#ptrT] (globals.get #defaultLogger))) in
...
Definition getLoggerⁱᵐᵖˡ : val :=
  λ: <>,
    with_defer: (do:  ((method_call #(ptrTⁱᵈ sync.Mutexⁱᵈ) #"Lock"%go (globals.get #raftLoggerMu)) #());;;
    do:  (let: "$f" := (method_call #(ptrTⁱᵈ sync.Mutexⁱᵈ) #"Unlock"%go (globals.get #raftLoggerMu)) in
...
Definition DefaultLogger__EnableTimestampsⁱᵐᵖˡ : val :=
  λ: "l" <>,
    exception_do (let: "l" := (mem.alloc "l") in
    do:  (let: "$a0" := ((((method_call #(ptrTⁱᵈ DefaultLoggerⁱᵈ) #"Flags"%go (![#ptrT] "l")) #()) `or` #(W64 log.Ldate)) `or` #(W64 log.Ltime)) in
    (method_call #(ptrTⁱᵈ DefaultLoggerⁱᵈ) #"SetFlags"%go (![#ptrT] "l")) "$a0");;;
    return: #()).
...
Definition DefaultLogger__Debugⁱᵐᵖˡ : val :=
  λ: "l" "v",
    ...
    then
      ...
      (method_call #(ptrTⁱᵈ DefaultLoggerⁱᵈ) #"Output"%go (![#ptrT] "l")) "$a0" "$a1")
    else do:  #());;;
    return: #()).
...
Definition DefaultLogger__Panicⁱᵐᵖˡ : val :=
  λ: "l" "v",
    ...
    (method_call #(ptrTⁱᵈ log.Loggerⁱᵈ) #"Panic"%go (![#ptrT] (struct.field_ref #DefaultLogger #"Logger"%go (![#ptrT] "l")))) "$a0");;;
    return: #()).
...
Definition DefaultLogger__Panicfⁱᵐᵖˡ : val :=
  λ: "l" "format" "v",
    ...
    let: "$a1" := (![#sliceT] "v") in
    (method_call #(ptrTⁱᵈ log.Loggerⁱᵈ) #"Panicf"%go (![#ptrT] (struct.field_ref #DefaultLogger #"Logger"%go (![#ptrT] "l")))) "$a0" "$a1");;;
    return: #()).
...
Definition headerⁱᵐᵖˡ : val :=
  λ: "lvl" "msg",
    ...
    return: (let: "$a0" := #"%s: %s"%go in
     let: "$a1" := ((let: "$sl0" := (interface.make #stringTⁱᵈ (![#stringT] "lvl")) in
     let: "$sl1" := (interface.make #stringTⁱᵈ (![#stringT] "msg")) in
     slice.literal #interfaceT ["$sl0"; "$sl1"])) in
     (func_call #fmt.Sprintf) "$a0" "$a1")).

Definition SnapshotStatusⁱᵈ : go_string := "go.etcd.io/raft/v3.SnapshotStatus"%go.
...
Definition SoftStateⁱᵈ : go_string := "go.etcd.io/raft/v3.SoftState"%go.
...
Definition Readyⁱᵈ : go_string := "go.etcd.io/raft/v3.Ready"%go.
...
Definition Nodeⁱᵈ : go_string := "go.etcd.io/raft/v3.Node"%go.

Definition Node : go_type := interfaceT.

Definition Peerⁱᵈ : go_string := "go.etcd.io/raft/v3.Peer"%go.
...
Definition RawNodeⁱᵈ : go_string := "go.etcd.io/raft/v3.RawNode"%go.
...
Definition setupNodeⁱᵐᵖˡ : val :=
  λ: "c" "peers",
    ...
    slice.len "$a0") = #(W64 0)
    then
      do:  (let: "$a0" := (interface.make #stringTⁱᵈ #"no peers given; use RestartNode instead"%go) in
      Panic "$a0")
    else do:  #());;;
    let: "err" := (mem.alloc (type.zero_val #error)) in
    ...
    (method_call #(ptrTⁱᵈ RawNodeⁱᵈ) #"Bootstrap"%go (![#ptrT] "rn")) "$a0") in
    do:  ("err" <-[#error] "$r0");;;
    (if: (~ (interface.eq (![#error] "err") #interface.nil))
    then
...
Definition StartNodeⁱᵐᵖˡ : val :=
  λ: "c" "peers",
    ...
    do:  ("n" <-[#ptrT] "$r0");;;
    let: "$go" := (method_call #(ptrTⁱᵈ nodeⁱᵈ) #"run"%go (![#ptrT] "n")) in
    do:  (Fork ("$go" #()));;;
    return: (interface.make #(ptrTⁱᵈ nodeⁱᵈ) (![#ptrT] "n"))).
...
Definition RestartNodeⁱᵐᵖˡ : val :=
  λ: "c",
    ...
    (func_call #newNode) "$a0") in
    do:  ("n" <-[#node] "$r0");;;
    let: "$go" := (method_call #(ptrTⁱᵈ nodeⁱᵈ) #"run"%go "n") in
    do:  (Fork ("$go" #()));;;
    return: (interface.make #(ptrTⁱᵈ nodeⁱᵈ) "n")).

Definition msgWithResultⁱᵈ : go_string := "go.etcd.io/raft/v3.msgWithResult"%go.
...
Definition node__Stopⁱᵐᵖˡ : val :=
  λ: "n" <>,
    ...
    chan.select [chan.select_send (struct.make (type.structT [
     ...
     ])] (struct.field_ref #node #"stop"%go (![#ptrT] "n"))) (λ: <>,
       do:  #()
...
Definition node__runⁱᵐᵖˡ : val :=
  λ: "n" <>,
    ...
    (for: (λ: <>, #true); (λ: <>, #()) := λ: <>,
      ...
      ])] "advancec") = #null) && ((method_call #(ptrTⁱᵈ RawNodeⁱᵈ) #"HasReady"%go (![#ptrT] (struct.field_ref #node #"rn"%go (![#ptrT] "n")))) #())
      then
        let: "$r0" := ((method_call #(ptrTⁱᵈ RawNodeⁱᵈ) #"readyWithoutAccept"%go (![#ptrT] (struct.field_ref #node #"rn"%go (![#ptrT] "n")))) #()) in
        do:  ("rd" <-[#Ready] "$r0");;;
      ...
      then
        (if: (method_call #(ptrTⁱᵈ raftⁱᵈ) #"hasLeader"%go (![#ptrT] "r")) #()
        then
          (if: (![#uint64T] "lead") = None
          then
            do:  (let: "$a0" := #"raft.node: %x elected leader %x at term %d"%go in
            let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
            let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"lead"%go (![#ptrT] "r")))) in
            let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r")))) in
            slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"])) in
            ...
            let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
            let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] "lead")) in
            let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"lead"%go (![#ptrT] "r")))) in
            let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r")))) in
            slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"])) in
            (interface.get #"Infof"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1"));;;
      ...
      chan.select [chan.select_receive (![type.chanT #msgWithResult] "propc") (λ: "$recvVal",
         ...
         (method_call #(ptrTⁱᵈ raftⁱᵈ) #"Step"%go (![#ptrT] "r")) "$a0") in
         do:  ("err" <-[#error] "$r0");;;
         ...
         ); chan.select_receive (![type.chanT #raftpb.Message] (struct.field_ref #node #"recvc"%go (![#ptrT] "n"))) (λ: "$recvVal",
         let: "m" := (mem.alloc (type.zero_val #raftpb.Message)) in
         let: "$r0" := (Fst "$recvVal") in
         do:  ("m" <-[#raftpb.Message] "$r0");;;
         ...
         (method_call #(ptrTⁱᵈ raftⁱᵈ) #"Step"%go (![#ptrT] "r")) "$a0")
         ); chan.select_receive (![type.chanT #raftpb.ConfChangeV2] (struct.field_ref #node #"confc"%go (![#ptrT] "n"))) (λ: "$recvVal",
         ...
         (method_call #(ptrTⁱᵈ raftⁱᵈ) #"applyConfChange"%go (![#ptrT] "r")) "$a0") in
         ...
         chan.select [chan.select_send (![#raftpb.ConfState] "cs") (![type.chanT #raftpb.ConfState] (struct.field_ref #node #"confstatec"%go (![#ptrT] "n"))) (λ: <>,
            do:  #()
            ); chan.select_receive (![type.chanT (type.structT [
          ])] (struct.field_ref #node #"done"%go (![#ptrT] "n"))) (λ: "$recvVal",
            do:  #()
         ...
         do:  ((method_call #(ptrTⁱᵈ RawNodeⁱᵈ) #"Tick"%go (![#ptrT] (struct.field_ref #node #"rn"%go (![#ptrT] "n")))) #())
         ); chan.select_send (![#Ready] "rd") (![type.chanT #Ready] "readyc") (λ: <>,
         do:  (let: "$a0" := (![#Ready] "rd") in
         (method_call #(ptrTⁱᵈ RawNodeⁱᵈ) #"acceptReady"%go (![#ptrT] (struct.field_ref #node #"rn"%go (![#ptrT] "n")))) "$a0");;;
         ...
         do:  (let: "$a0" := (![#Ready] "rd") in
         (method_call #(ptrTⁱᵈ RawNodeⁱᵈ) #"Advance"%go (![#ptrT] (struct.field_ref #node #"rn"%go (![#ptrT] "n")))) "$a0");;;
         let: "$r0" := (struct.make #Ready [{
           "SoftState" ::= type.zero_val #ptrT;
           "HardState" ::= type.zero_val #raftpb.HardState;
           "ReadStates" ::= type.zero_val #sliceT;
         ...
         ); chan.select_receive (![type.chanT (type.chanT #Status)] (struct.field_ref #node #"status"%go (![#ptrT] "n"))) (λ: "$recvVal",
...
Definition node__Tickⁱᵐᵖˡ : val :=
  λ: "n" <>,
    ...
    chan.select [chan.select_send (struct.make (type.structT [
     ...
     ])] (struct.field_ref #node #"tickc"%go (![#ptrT] "n"))) (λ: <>,
       do:  #()
       ); chan.select_receive (![type.chanT (type.structT [
     ])] (struct.field_ref #node #"done"%go (![#ptrT] "n"))) (λ: "$recvVal",
       do:  #()
      ...
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] (struct.field_ref #RawNode #"raft"%go (![#ptrT] (struct.field_ref #node #"rn"%go (![#ptrT] "n")))))))) in
      slice.literal #interfaceT ["$sl0"])) in
...
Definition node__Campaignⁱᵐᵖˡ : val :=
  λ: "n" "ctx",
    ...
    return: (let: "$a0" := (![#context.Context] "ctx") in
     ...
     (method_call #(ptrTⁱᵈ nodeⁱᵈ) #"step"%go (![#ptrT] "n")) "$a0" "$a1")).
...
Definition node__Proposeⁱᵐᵖˡ : val :=
  λ: "n" "ctx" "data",
    ...
    return: (let: "$a0" := (![#context.Context] "ctx") in
     ...
     (method_call #(ptrTⁱᵈ nodeⁱᵈ) #"stepWait"%go (![#ptrT] "n")) "$a0" "$a1")).
...
Definition node__stepⁱᵐᵖˡ : val :=
  λ: "n" "ctx" "m",
    ...
    return: (let: "$a0" := (![#context.Context] "ctx") in
     let: "$a1" := (![#raftpb.Message] "m") in
     let: "$a2" := #false in
     (method_call #(ptrTⁱᵈ nodeⁱᵈ) #"stepWithWaitOption"%go (![#ptrT] "n")) "$a0" "$a1" "$a2")).
...
Definition node__stepWithWaitOptionⁱᵐᵖˡ : val :=
  λ: "n" "ctx" "m" "wait",
    ...
    then
      chan.select [chan.select_send (![#raftpb.Message] "m") (![type.chanT #raftpb.Message] (struct.field_ref #node #"recvc"%go (![#ptrT] "n"))) (λ: <>,
         return: (#interface.nil)
    ...
    chan.select [chan.select_send (![#msgWithResult] "pm") (![type.chanT #msgWithResult] "ch") (λ: <>,
       (if: (~ (![#boolT] "wait"))
       then return: (#interface.nil)
       else do:  #())
       ); chan.select_receive ((interface.get #"Done"%go (![#context.Context] "ctx")) #()) (λ: "$recvVal",
...
Definition node__Advanceⁱᵐᵖˡ : val :=
  λ: "n" <>,
    ...
    chan.select [chan.select_send (struct.make (type.structT [
     ...
     ])] (struct.field_ref #node #"advancec"%go (![#ptrT] "n"))) (λ: <>,
       do:  #()
       ); chan.select_receive (![type.chanT (type.structT [
     ])] (struct.field_ref #node #"done"%go (![#ptrT] "n"))) (λ: "$recvVal",
       do:  #()
...
Definition node__ApplyConfChangeⁱᵐᵖˡ : val :=
  λ: "n" "cc",
    ...
    let: "cc" := (mem.alloc "cc") in
    let: "cs" := (mem.alloc (type.zero_val #raftpb.ConfState)) in
    chan.select [chan.select_send ((interface.get #"AsV2"%go (![#raftpb.ConfChangeI] "cc")) #()) (![type.chanT #raftpb.ConfChangeV2] (struct.field_ref #node #"confc"%go (![#ptrT] "n"))) (λ: <>,
       do:  #()
       ); chan.select_receive (![type.chanT (type.structT [
     ])] (struct.field_ref #node #"done"%go (![#ptrT] "n"))) (λ: "$recvVal",
       do:  #()
       )] chan.select_no_default;;;
    chan.select [chan.select_receive (![type.chanT #raftpb.ConfState] (struct.field_ref #node #"confstatec"%go (![#ptrT] "n"))) (λ: "$recvVal",
       let: "$r0" := (Fst "$recvVal") in
       do:  ("cs" <-[#raftpb.ConfState] "$r0");;;
       do:  #()
       ); chan.select_receive (![type.chanT (type.structT [
...
Definition node__Statusⁱᵐᵖˡ : val :=
  λ: "n" <>,
    ...
    do:  ("c" <-[type.chanT #Status] "$r0");;;
    chan.select [chan.select_send (![type.chanT #Status] "c") (![type.chanT (type.chanT #Status)] (struct.field_ref #node #"status"%go (![#ptrT] "n"))) (λ: <>,
       return: (Fst (chan.receive (![type.chanT #Status] "c")))
       ); chan.select_receive (![type.chanT (type.structT [
     ])] (struct.field_ref #node #"done"%go (![#ptrT] "n"))) (λ: "$recvVal",
  ...
  λ: "n" "id",
    ...
    chan.select [chan.select_send (let: "$Type" := raftpb.MsgUnreachable in
     ...
     struct.make #raftpb.Message [{
       ...
       "Context" ::= type.zero_val #sliceT;
       "Responses" ::= type.zero_val #sliceT
     }]) (![type.chanT #raftpb.Message] (struct.field_ref #node #"recvc"%go (![#ptrT] "n"))) (λ: <>,
       do:  #()
       ); chan.select_receive (![type.chanT (type.structT [
     ])] (struct.field_ref #node #"done"%go (![#ptrT] "n"))) (λ: "$recvVal",
       do:  #()
...
Definition ReadOnlyOptionⁱᵈ : go_string := "go.etcd.io/raft/v3.ReadOnlyOption"%go.
...
Definition lockedRandⁱᵈ : go_string := "go.etcd.io/raft/v3.lockedRand"%go.
...
Definition lockedRand__Intnⁱᵐᵖˡ : val :=
  λ: "r" "n",
    ...
    do:  ((method_call #(ptrTⁱᵈ sync.Mutexⁱᵈ) #"Lock"%go (struct.field_ref #lockedRand #"mu"%go (![#ptrT] "r"))) #());;;
    ...
    do:  ("v" <-[#ptrT] "$r0");;;
    do:  "$r1";;;
    do:  ((method_call #(ptrTⁱᵈ sync.Mutexⁱᵈ) #"Unlock"%go (struct.field_ref #lockedRand #"mu"%go (![#ptrT] "r"))) #());;;
    return: (s_to_w64 ((method_call #(ptrTⁱᵈ big.Intⁱᵈ) #"Int64"%go (![#ptrT] "v")) #()))).

Definition globalRand : go_string := "go.etcd.io/raft/v3.globalRand"%go.

Definition CampaignTypeⁱᵈ : go_string := "go.etcd.io/raft/v3.CampaignType"%go.

Definition CampaignType : go_type := stringT.

Definition StateTypeⁱᵈ : go_string := "go.etcd.io/raft/v3.StateType"%go.
...
Definition Configⁱᵈ : go_string := "go.etcd.io/raft/v3.Config"%go.
...
Definition newRaftⁱᵐᵖˡ : val :=
  λ: "c",
    exception_do (let: "c" := (mem.alloc "c") in
    (let: "err" := (mem.alloc (type.zero_val #error)) in
    let: "$r0" := ((method_call #(ptrTⁱᵈ Configⁱᵈ) #"validate"%go (![#ptrT] "c")) #()) in
    do:  ("err" <-[#error] "$r0");;;
    (if: (~ (interface.eq (![#error] "err") #interface.nil))
    then
      do:  (let: "$a0" := (interface.make #stringTⁱᵈ ((interface.get #"Error"%go (![#error] "err")) #())) in
      Panic "$a0")
    else do:  #()));;;
    ...
    let: "$r0" := ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastEntryID"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #()) in
    ...
    (method_call #(ptrTⁱᵈ raftⁱᵈ) #"switchToConfig"%go (![#ptrT] "r")) "$a0" "$a1") in
    ...
    then
      ...
      (method_call #(ptrTⁱᵈ raftⁱᵈ) #"loadState"%go (![#ptrT] "r")) "$a0")
    else do:  #());;;
    (if: (![#uint64T] (struct.field_ref #Config #"Applied"%go (![#ptrT] "c"))) > #(W64 0)
    then
      do:  (let: "$a0" := (![#uint64T] (struct.field_ref #Config #"Applied"%go (![#ptrT] "c"))) in
      let: "$a1" := #(W64 0) in
      (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"appliedTo"%go (![#ptrT] "raftlog")) "$a0" "$a1")
    else do:  #());;;
    do:  (let: "$a0" := (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r"))) in
    let: "$a1" := None in
    (method_call #(ptrTⁱᵈ raftⁱᵈ) #"becomeFollower"%go (![#ptrT] "r")) "$a0" "$a1");;;
    let: "nodesStrs" := (mem.alloc (type.zero_val #sliceT)) in
    let: "$range" := ((method_call #(ptrTⁱᵈ tracker.ProgressTrackerⁱᵈ) #"VoterNodes"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r"))) #()) in
    ...
    slice.for_range #uint64T "$range" (λ: "$key" "$value",
      ...
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] "n")) in
      slice.literal #interfaceT ["$sl0"])) in
      (func_call #fmt.Sprintf) "$a0" "$a1") in
    ...
    let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
    let: "$sl1" := (interface.make #stringTⁱᵈ (let: "$a0" := (![#sliceT] "nodesStrs") in
    let: "$a1" := #","%go in
    (func_call #strings.Join) "$a0" "$a1")) in
    let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r")))) in
    let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftLog #"committed"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))))) in
    let: "$sl4" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftLog #"applied"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))))) in
    let: "$sl5" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"index"%go "lastID"))) in
    let: "$sl6" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"term"%go "lastID"))) in
  ...
  λ: "r" "m",
    ...
    then
      ...
      then
        ...
        let: "$a1" := ((let: "$sl0" := (interface.make #raftpb.MessageTypeⁱᵈ (![#raftpb.MessageType] (struct.field_ref #raftpb.Message #"Type"%go "m"))) in
        slice.literal #interfaceT ["$sl0"])) in
      ...
      then
        ...
        let: "$a1" := ((let: "$sl0" := (interface.make #raftpb.MessageTypeⁱᵈ (![#raftpb.MessageType] (struct.field_ref #raftpb.Message #"Type"%go "m"))) in
        let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"Term"%go "m"))) in
        slice.literal #interfaceT ["$sl0"; "$sl1"])) in
        (interface.get #"Panicf"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1")
      else do:  #());;;
...
Definition raft__sendAppendⁱᵐᵖˡ : val :=
  λ: "r" "to",
    ...
    let: "$a1" := #true in
    (method_call #(ptrTⁱᵈ raftⁱᵈ) #"maybeSendAppend"%go (![#ptrT] "r")) "$a0" "$a1");;;
    return: #()).
...
Definition raft__maybeSendAppendⁱᵐᵖˡ : val :=
  λ: "r" "to" "sendIfEmpty",
    ...
    do:  ("pr" <-[#ptrT] "$r0");;;
    (if: (method_call #(ptrTⁱᵈ tracker.Progressⁱᵈ) #"IsPaused"%go (![#ptrT] "pr")) #()
    then return: (#false)
    else do:  #());;;
    ...
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"term"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0") in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    ...
    then
      return: (let: "$a0" := (![#uint64T] "to") in
       let: "$a1" := (![#ptrT] "pr") in
       (method_call #(ptrTⁱᵈ raftⁱᵈ) #"maybeSendSnapshot"%go (![#ptrT] "r")) "$a0" "$a1")
    else do:  #());;;
    let: "ents" := (mem.alloc (type.zero_val #sliceT)) in
    (if: ((![#tracker.StateType] (struct.field_ref #tracker.Progress #"State"%go (![#ptrT] "pr"))) ≠ tracker.StateReplicate) || (~ ((method_call #(ptrTⁱᵈ tracker.Inflightsⁱᵈ) #"Full"%go (![#ptrT] (struct.field_ref #tracker.Progress #"Inflights"%go (![#ptrT] "pr")))) #()))
    then
      ...
      (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"entries"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0" "$a1") in
      let: "$r0" := "$ret0" in
      let: "$r1" := "$ret1" in
      do:  ("ents" <-[#sliceT] "$r0");;;
      do:  ("err" <-[#error] "$r1")
...
Definition raft__maybeSendSnapshotⁱᵐᵖˡ : val :=
  λ: "r" "to" "pr",
    ...
    then
      ...
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] "to")) in
      slice.literal #interfaceT ["$sl0"])) in
    ...
    let: ("$ret0", "$ret1") := ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"snapshot"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #()) in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    ...
    then
      ...
      then
        ...
        let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
        let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] "to")) in
        slice.literal #interfaceT ["$sl0"; "$sl1"])) in
        (interface.get #"Debugf"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
        return: (#false)
      else do:  #());;;
    ...
    then
      do:  (let: "$a0" := (interface.make #stringTⁱᵈ #"need non-empty snapshot"%go) in
      Panic "$a0")
    else do:  #());;;
    ...
    let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
    let: "$sl1" := (interface.make #uint64Tⁱᵈ ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"firstIndex"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #())) in
    let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftLog #"committed"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))))) in
    let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] "sindex")) in
    let: "$sl4" := (interface.make #uint64Tⁱᵈ (![#uint64T] "sterm")) in
    let: "$sl5" := (interface.make #uint64Tⁱᵈ (![#uint64T] "to")) in
    let: "$sl6" := (interface.make #(ptrTⁱᵈ tracker.Progressⁱᵈ) (![#ptrT] "pr")) in
    slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"; "$sl4"; "$sl5"; "$sl6"])) in
    (interface.get #"Debugf"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
    do:  (let: "$a0" := (![#uint64T] "sindex") in
    (method_call #(ptrTⁱᵈ tracker.Progressⁱᵈ) #"BecomeSnapshot"%go (![#ptrT] "pr")) "$a0");;;
    do:  (let: "$a0" := #"%x paused sending replication messages to %x [%s]"%go in
    let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
    let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] "to")) in
    let: "$sl2" := (interface.make #(ptrTⁱᵈ tracker.Progressⁱᵈ) (![#ptrT] "pr")) in
    slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"])) in
    (interface.get #"Debugf"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
    do:  (let: "$a0" := (let: "$To" := (![#uint64T] "to") in
...
Definition raft__bcastAppendⁱᵐᵖˡ : val :=
  λ: "r" <>,
    ...
    do:  (let: "$a0" := (λ: "id" <>,
      ...
      (method_call #(ptrTⁱᵈ raftⁱᵈ) #"sendAppend"%go (![#ptrT] "r")) "$a0");;;
      return: #())
      ) in
    (method_call #(ptrTⁱᵈ tracker.ProgressTrackerⁱᵈ) #"Visit"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r"))) "$a0");;;
    return: #()).

Definition readOnlyⁱᵈ : go_string := "go.etcd.io/raft/v3.readOnly"%go.
...
Definition raft__bcastHeartbeatⁱᵐᵖˡ : val :=
  λ: "r" <>,
    ...
    let: "$r0" := ((method_call #(ptrTⁱᵈ readOnlyⁱᵈ) #"lastPendingRequestCtx"%go (![#ptrT] (struct.field_ref #raft #"readOnly"%go (![#ptrT] "r")))) #()) in
    do:  ("lastCtx" <-[#stringT] "$r0");;;
    (if: (let: "$a0" := (![#stringT] "lastCtx") in
    StringLength "$a0") = #(W64 0)
    then
      do:  (let: "$a0" := #slice.nil in
      (method_call #(ptrTⁱᵈ raftⁱᵈ) #"bcastHeartbeatWithCtx"%go (![#ptrT] "r")) "$a0")
    else
...
Definition raft__bcastHeartbeatWithCtxⁱᵐᵖˡ : val :=
  λ: "r" "ctx",
    ...
    do:  (let: "$a0" := (λ: "id" <>,
      ...
      (method_call #(ptrTⁱᵈ raftⁱᵈ) #"sendHeartbeat"%go (![#ptrT] "r")) "$a0" "$a1");;;
      return: #())
      ) in
    (method_call #(ptrTⁱᵈ tracker.ProgressTrackerⁱᵈ) #"Visit"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r"))) "$a0");;;
    return: #()).
...
Definition raft__appliedToⁱᵐᵖˡ : val :=
  λ: "r" "index" "size",
    ...
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"appliedTo"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0" "$a1");;;
    ...
    then
      ...
      then
        ...
        let: "$a1" := ((let: "$sl0" := (interface.make #tracker.Configⁱᵈ (![#tracker.Config] (struct.field_ref #tracker.ProgressTracker #"Config"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r"))))) in
        let: "$sl1" := (![#error] "err") in
        slice.literal #interfaceT ["$sl0"; "$sl1"])) in
        (interface.get #"Debugf"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1")
      else
...
Definition raft__appliedSnapⁱᵐᵖˡ : val :=
  λ: "r" "snap",
    ...
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"stableSnapTo"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0");;;
    do:  (let: "$a0" := (![#uint64T] "index") in
    let: "$a1" := #(W64 0) in
    (method_call #(ptrTⁱᵈ raftⁱᵈ) #"appliedTo"%go (![#ptrT] "r")) "$a0" "$a1");;;
    return: #()).
...
Definition raft__maybeCommitⁱᵐᵖˡ : val :=
  λ: "r" <>,
    ...
    return: (let: "$a0" := (let: "$term" := (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r"))) in
     let: "$index" := ((method_call #(ptrTⁱᵈ tracker.ProgressTrackerⁱᵈ) #"Committed"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r"))) #()) in
     struct.make #entryID [{
       "term" ::= "$term";
       "index" ::= "$index"
     }]) in
     (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"maybeCommit"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0")).
...
Definition raft__resetⁱᵐᵖˡ : val :=
  λ: "r" "term",
    ...
    do:  ((method_call #(ptrTⁱᵈ raftⁱᵈ) #"resetRandomizedElectionTimeout"%go (![#ptrT] "r")) #());;;
    do:  ((method_call #(ptrTⁱᵈ raftⁱᵈ) #"abortLeaderTransfer"%go (![#ptrT] "r")) #());;;
    do:  ((method_call #(ptrTⁱᵈ tracker.ProgressTrackerⁱᵈ) #"ResetVotes"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r"))) #());;;
    do:  (let: "$a0" := (λ: "id" "pr",
      exception_do (let: "pr" := (mem.alloc "pr") in
      let: "id" := (mem.alloc "id") in
      let: "$r0" := (let: "$Match" := #(W64 0) in
      let: "$Next" := (((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #()) + #(W64 1)) in
      ...
      (if: (![#uint64T] "id") = (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))
      then
        let: "$r0" := ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #()) in
...
Definition raft__appendEntryⁱᵐᵖˡ : val :=
  λ: "r" "es",
    ...
    (method_call #(ptrTⁱᵈ raftⁱᵈ) #"increaseUncommittedSize"%go (![#ptrT] "r")) "$a0"))
    then
    ...
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"append"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0") in
    do:  ("li" <-[#uint64T] "$r0");;;
...
Definition raft__tickElectionⁱᵐᵖˡ : val :=
  λ: "r" <>,
    ...
    (if: ((method_call #(ptrTⁱᵈ raftⁱᵈ) #"promotable"%go (![#ptrT] "r")) #()) && ((method_call #(ptrTⁱᵈ raftⁱᵈ) #"pastElectionTimeout"%go (![#ptrT] "r")) #())
    then
      let: "$r0" := #(W64 0) in
      do:  ((struct.field_ref #raft #"electionElapsed"%go (![#ptrT] "r")) <-[#intT] "$r0");;;
      (let: "err" := (mem.alloc (type.zero_val #error)) in
...
Definition raft__tickHeartbeatⁱᵐᵖˡ : val :=
  λ: "r" <>,
    ...
    then
      ...
      then do:  ((method_call #(ptrTⁱᵈ raftⁱᵈ) #"abortLeaderTransfer"%go (![#ptrT] "r")) #())
      else do:  #())
    else do:  #());;;
...
Definition raft__becomeFollowerⁱᵐᵖˡ : val :=
  λ: "r" "term" "lead",
    ...
    (method_call #(ptrTⁱᵈ raftⁱᵈ) #"reset"%go (![#ptrT] "r")) "$a0");;;
    let: "$r0" := (method_call #(ptrTⁱᵈ raftⁱᵈ) #"tickElection"%go (![#ptrT] "r")) in
    ...
    let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
    let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r")))) in
    slice.literal #interfaceT ["$sl0"; "$sl1"])) in
    (interface.get #"Infof"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
    do:  (let: "$a0" := (![#ptrT] "r") in
...
Definition raft__becomeCandidateⁱᵐᵖˡ : val :=
  λ: "r" <>,
    ...
    (if: (![#StateType] (struct.field_ref #raft #"state"%go (![#ptrT] "r"))) = StateLeader
    then
      do:  (let: "$a0" := (interface.make #stringTⁱᵈ #"invalid transition [leader -> candidate]"%go) in
      Panic "$a0")
    else do:  #());;;
...
Definition raft__becomePreCandidateⁱᵐᵖˡ : val :=
  λ: "r" <>,
    ...
    (if: (![#StateType] (struct.field_ref #raft #"state"%go (![#ptrT] "r"))) = StateLeader
    then
      do:  (let: "$a0" := (interface.make #stringTⁱᵈ #"invalid transition [leader -> pre-candidate]"%go) in
      Panic "$a0")
    else do:  #());;;
    let: "$r0" := (func_call #stepCandidate) in
    do:  ((struct.field_ref #raft #"step"%go (![#ptrT] "r")) <-[#stepFunc] "$r0");;;
...
Definition raft__becomeLeaderⁱᵐᵖˡ : val :=
  λ: "r" <>,
    ...
    then
      do:  (let: "$a0" := (interface.make #stringTⁱᵈ #"invalid transition [follower -> leader]"%go) in
      Panic "$a0")
    else do:  #());;;
    ...
    do:  (let: "$a0" := (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r"))) in
    (method_call #(ptrTⁱᵈ raftⁱᵈ) #"reset"%go (![#ptrT] "r")) "$a0");;;
    let: "$r0" := (method_call #(ptrTⁱᵈ raftⁱᵈ) #"tickHeartbeat"%go (![#ptrT] "r")) in
    do:  ((struct.field_ref #raft #"tick"%go (![#ptrT] "r")) <-[#funcT] "$r0");;;
    let: "$r0" := (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r"))) in
    do:  ((struct.field_ref #raft #"lead"%go (![#ptrT] "r")) <-[#uint64T] "$r0");;;
    ...
    do:  ("pr" <-[#ptrT] "$r0");;;
    do:  ((method_call #(ptrTⁱᵈ tracker.Progressⁱᵈ) #"BecomeReplicate"%go (![#ptrT] "pr")) #());;;
    let: "$r0" := #true in
    ...
    slice.literal #raftpb.Entry ["$sl0"])) in
    (method_call #(ptrTⁱᵈ raftⁱᵈ) #"appendEntry"%go (![#ptrT] "r")) "$a0"))
    then
      do:  (let: "$a0" := ((let: "$sl0" := (interface.make #stringTⁱᵈ #"empty entry was dropped"%go) in
      slice.literal #interfaceT ["$sl0"])) in
...
Definition raft__hupⁱᵐᵖˡ : val :=
  λ: "r" "t",
    ...
    (if: (~ ((method_call #(ptrTⁱᵈ raftⁱᵈ) #"promotable"%go (![#ptrT] "r")) #()))
    then
    ...
    (if: (method_call #(ptrTⁱᵈ raftⁱᵈ) #"hasUnappliedConfChanges"%go (![#ptrT] "r")) #()
    then
    ...
    (method_call #(ptrTⁱᵈ raftⁱᵈ) #"campaign"%go (![#ptrT] "r")) "$a0");;;
    return: #()).
...
Definition raft__hasUnappliedConfChangesⁱᵐᵖˡ : val :=
  λ: "r" <>,
    ...
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"scan"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0" "$a1" "$a2" "$a3") in
    do:  ("err" <-[#error] "$r0");;;
...
Definition raft__campaignⁱᵐᵖˡ : val :=
  λ: "r" "t",
    ...
    let: "$r0" := ((method_call #quorum.JointConfigⁱᵈ #"IDs"%go (![#quorum.JointConfig] (struct.field_ref #tracker.Config #"Voters"%go (struct.field_ref #tracker.ProgressTracker #"Config"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r")))))) #()) in
    ...
    slice.for_range #uint64T "$range" (λ: "$key" "$value",
      ...
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
      let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"term"%go "last"))) in
      let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"index"%go "last"))) in
      let: "$sl3" := (interface.make #raftpb.MessageTypeⁱᵈ (![#raftpb.MessageType] "voteMsg")) in
      let: "$sl4" := (interface.make #uint64Tⁱᵈ (![#uint64T] "id")) in
      let: "$sl5" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r")))) in
      slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"; "$sl4"; "$sl5"])) in
      (interface.get #"Infof"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
...
Definition raft__pollⁱᵐᵖˡ : val :=
  λ: "r" "id" "t" "v",
    ...
    then
      ...
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
      let: "$sl1" := (interface.make #raftpb.MessageTypeⁱᵈ (![#raftpb.MessageType] "t")) in
      let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] "id")) in
      let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r")))) in
      slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"])) in
      (interface.get #"Infof"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1")
    else
    ...
    do:  (let: "$a0" := (![#uint64T] "id") in
    let: "$a1" := (![#boolT] "v") in
    (method_call #(ptrTⁱᵈ tracker.ProgressTrackerⁱᵈ) #"RecordVote"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r"))) "$a0" "$a1");;;
    let: (("$ret0", "$ret1"), "$ret2") := (((method_call #(ptrTⁱᵈ tracker.ProgressTrackerⁱᵈ) #"TallyVotes"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r"))) #())) in
  ...
  λ: "r" "m",
      ...
      then
        ...
        then
          ...
          then
            ...
            let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"term"%go "last"))) in
            let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"index"%go "last"))) in
            let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"Vote"%go (![#ptrT] "r")))) in
            let: "$sl4" := (interface.make #raftpb.MessageTypeⁱᵈ (![#raftpb.MessageType] (struct.field_ref #raftpb.Message #"Type"%go "m"))) in
            let: "$sl5" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"From"%go "m"))) in
            let: "$sl6" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"LogTerm"%go "m"))) in
            let: "$sl7" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"Index"%go "m"))) in
            let: "$sl8" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r")))) in
            let: "$sl9" := (interface.make #intTⁱᵈ ((![#intT] (struct.field_ref #raft #"electionTimeout"%go (![#ptrT] "r"))) - (![#intT] (struct.field_ref #raft #"electionElapsed"%go (![#ptrT] "r"))))) in
        ...
        then do:  #()
          ...
          then do:  #()
            ...
            let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
            let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r")))) in
            let: "$sl2" := (interface.make #raftpb.MessageTypeⁱᵈ (![#raftpb.MessageType] (struct.field_ref #raftpb.Message #"Type"%go "m"))) in
            let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"From"%go "m"))) in
            let: "$sl4" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"Term"%go "m"))) in
            ...
            then
              ...
              then
                ...
                then
                  ...
                  let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r")))) in
                  let: "$sl2" := (interface.make #raftpb.MessageTypeⁱᵈ (![#raftpb.MessageType] (struct.field_ref #raftpb.Message #"Type"%go "m"))) in
                  let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"Term"%go "m"))) in
                  slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"])) in
                  (interface.get #"Infof"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1")
                else do:  #());;;
                ...
                then
                  ...
                  (method_call #(ptrTⁱᵈ raftⁱᵈ) #"appliedSnap"%go (![#ptrT] "r")) "$a0")
                else do:  #())
              else
    ...
    then
      ...
      then
        ...
        (method_call #(ptrTⁱᵈ raftⁱᵈ) #"hup"%go (![#ptrT] "r")) "$a0")
      else
      ...
      then
        ...
        then
          ...
          (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"stableTo"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0")
        else do:  #());;;
        (if: (![#ptrT] (struct.field_ref #raftpb.Message #"Snapshot"%go "m")) ≠ #null
        then
          do:  (let: "$a0" := (![#ptrT] (struct.field_ref #raftpb.Message #"Snapshot"%go "m")) in
        ...
        then
          ...
          then
            ...
            (func_call #payloadsSize) "$a0") in
            (method_call #(ptrTⁱᵈ raftⁱᵈ) #"reduceUncommittedSize"%go (![#ptrT] "r")) "$a0")
          else do:  #())
        else
          ...
          then
            ...
            (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"isUpToDate"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0")
            then
              do:  (let: "$a0" := #"%x [logterm: %d, index: %d, vote: %x] cast %s for %x [logterm: %d, index: %d] at term %d"%go in
              let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
              let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"term"%go "lastID"))) in
              let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"index"%go "lastID"))) in
              let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"Vote"%go (![#ptrT] "r")))) in
              let: "$sl4" := (interface.make #raftpb.MessageTypeⁱᵈ (![#raftpb.MessageType] (struct.field_ref #raftpb.Message #"Type"%go "m"))) in
              let: "$sl5" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"From"%go "m"))) in
              let: "$sl6" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"term"%go "candLastID"))) in
              let: "$sl7" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"index"%go "candLastID"))) in
              let: "$sl8" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r")))) in
              slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"; "$sl4"; "$sl5"; "$sl6"; "$sl7"; "$sl8"])) in
              (interface.get #"Infof"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
              do:  (let: "$a0" := (let: "$To" := (![#uint64T] (struct.field_ref #raftpb.Message #"From"%go "m")) in
...
Definition stepFuncⁱᵈ : go_string := "go.etcd.io/raft/v3.stepFunc"%go.
...
Definition stepLeaderⁱᵐᵖˡ : val :=
  λ: "r" "m",
    ...
    then
      do:  ((method_call #(ptrTⁱᵈ raftⁱᵈ) #"bcastHeartbeat"%go (![#ptrT] "r")) #());;;
      return: (#interface.nil)
    else
      (if: "$sw" = raftpb.MsgCheckQuorum
      then
        (if: (~ ((method_call #(ptrTⁱᵈ tracker.ProgressTrackerⁱᵈ) #"QuorumActive"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r"))) #()))
        then
        ...
        then
          ...
          then
            ...
            let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
            let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r")))) in
            let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"leadTransferee"%go (![#ptrT] "r")))) in
            slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"])) in
            (interface.get #"Debugf"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
          ...
          slice.for_range #raftpb.Entry "$range" (λ: "$key" "$value",
            ...
            then
              ...
              (method_call #(ptrTⁱᵈ raftpb.ConfChangeⁱᵈ) #"Unmarshal"%go "ccc") "$a0") in
              do:  ("err" <-[#error] "$r0");;;
              (if: (~ (interface.eq (![#error] "err") #interface.nil))
              then
                do:  (let: "$a0" := (![#error] "err") in
              ...
              let: "$r0" := (interface.make #raftpb.ConfChangeⁱᵈ (![#raftpb.ConfChange] "ccc")) in
              ...
              then
                ...
                (let: "err" := (mem.alloc (type.zero_val #error)) in
                let: "$r0" := (let: "$a0" := (![#sliceT] (struct.field_ref #raftpb.Entry #"Data"%go (![#ptrT] "e"))) in
                (method_call #(ptrTⁱᵈ raftpb.ConfChangeV2ⁱᵈ) #"Unmarshal"%go "ccc") "$a0") in
                do:  ("err" <-[#error] "$r0");;;
                (if: (~ (interface.eq (![#error] "err") #interface.nil))
                then
                  do:  (let: "$a0" := (![#error] "err") in
                ...
                let: "$r0" := (interface.make #raftpb.ConfChangeV2ⁱᵈ (![#raftpb.ConfChangeV2] "ccc")) in
                do:  ("cc" <-[#raftpb.ConfChangeI] "$r0")
              else do:  #()));;;
            ...
            then
              ...
              then
                ...
                let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"pendingConfIndex"%go (![#ptrT] "r")))) in
                let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftLog #"applied"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))))) in
                slice.literal #interfaceT ["$sl0"; "$sl1"])) in
                (func_call #fmt.Sprintf) "$a0" "$a1") in
              ...
              then
                ...
                let: "$sl2" := (interface.make #tracker.Configⁱᵈ (![#tracker.Config] (struct.field_ref #tracker.ProgressTracker #"Config"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r"))))) in
                let: "$sl3" := (interface.make #stringTⁱᵈ (![#stringT] "failedCheck")) in
                slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"])) in
                (interface.get #"Infof"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
                ...
                let: "$r0" := ((((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #()) + (s_to_w64 (![#intT] "i"))) + #(W64 1)) in
                do:  ((struct.field_ref #raft #"pendingConfIndex"%go (![#ptrT] "r")) <-[#uint64T] "$r0");;;
          ...
          do:  ((method_call #(ptrTⁱᵈ raftⁱᵈ) #"bcastAppend"%go (![#ptrT] "r")) #());;;
          return: (#interface.nil)
        else
          (if: "$sw" = raftpb.MsgReadIndex
          then
            (if: (method_call #(ptrTⁱᵈ tracker.ProgressTrackerⁱᵈ) #"IsSingleton"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r"))) #()
            then
              (let: "resp" := (mem.alloc (type.zero_val #raftpb.Message)) in
              let: "$r0" := (let: "$a0" := (![#raftpb.Message] "m") in
              let: "$a1" := (![#uint64T] (struct.field_ref #raftLog #"committed"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r"))))) in
              (method_call #(ptrTⁱᵈ raftⁱᵈ) #"responseToReadIndexReq"%go (![#ptrT] "r")) "$a0" "$a1") in
            ...
            (if: (~ ((method_call #(ptrTⁱᵈ raftⁱᵈ) #"committedEntryInCurrentTerm"%go (![#ptrT] "r")) #()))
            then
    ...
    then
      ...
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
      let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"From"%go "m"))) in
      slice.literal #interfaceT ["$sl0"; "$sl1"])) in
      (interface.get #"Debugf"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
      return: (#interface.nil)
    else do:  #());;;
    ...
    then
      ...
      then
        ...
        let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
        let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"RejectHint"%go "m"))) in
        let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"LogTerm"%go "m"))) in
        let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"From"%go "m"))) in
        let: "$sl4" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"Index"%go "m"))) in
        slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"; "$sl4"])) in
        (interface.get #"Debugf"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
        ...
        then
          ...
          (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"findConflictByTerm"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0" "$a1") in
          let: "$r0" := "$ret0" in
          let: "$r1" := "$ret1" in
          do:  ("nextProbeIdx" <-[#uint64T] "$r0");;;
          do:  "$r1"
        ...
        (method_call #(ptrTⁱᵈ tracker.Progressⁱᵈ) #"MaybeDecrTo"%go (![#ptrT] "pr")) "$a0" "$a1"
        then
          ...
          then do:  ((method_call #(ptrTⁱᵈ tracker.Progressⁱᵈ) #"BecomeProbe"%go (![#ptrT] "pr")) #())
          else do:  #());;;
        ...
        (if: (let: "$a0" := (![#uint64T] (struct.field_ref #raftpb.Message #"Index"%go "m")) in
        (method_call #(ptrTⁱᵈ tracker.Progressⁱᵈ) #"MaybeUpdate"%go (![#ptrT] "pr")) "$a0") || (((![#uint64T] (struct.field_ref #tracker.Progress #"Match"%go (![#ptrT] "pr"))) = (![#uint64T] (struct.field_ref #raftpb.Message #"Index"%go "m"))) && ((![#tracker.StateType] (struct.field_ref #tracker.Progress #"State"%go (![#ptrT] "pr"))) = tracker.StateProbe))
        then
          let: "$sw" := #true in
          (if: "$sw" = ((![#tracker.StateType] (struct.field_ref #tracker.Progress #"State"%go (![#ptrT] "pr"))) = tracker.StateProbe)
          then do:  ((method_call #(ptrTⁱᵈ tracker.Progressⁱᵈ) #"BecomeReplicate"%go (![#ptrT] "pr")) #())
          else
            (if: "$sw" = (((![#tracker.StateType] (struct.field_ref #tracker.Progress #"State"%go (![#ptrT] "pr"))) = tracker.StateSnapshot) && (((![#uint64T] (struct.field_ref #tracker.Progress #"Match"%go (![#ptrT] "pr"))) + #(W64 1)) ≥ ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"firstIndex"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #())))
            then
              ...
              slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"])) in
              (interface.get #"Debugf"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
              do:  ((method_call #(ptrTⁱᵈ tracker.Progressⁱᵈ) #"BecomeProbe"%go (![#ptrT] "pr")) #());;;
              do:  ((method_call #(ptrTⁱᵈ tracker.Progressⁱᵈ) #"BecomeReplicate"%go (![#ptrT] "pr")) #())
            else
              ...
              then
                ...
                (method_call #(ptrTⁱᵈ tracker.Inflightsⁱᵈ) #"FreeLE"%go (![#ptrT] (struct.field_ref #tracker.Progress #"Inflights"%go (![#ptrT] "pr")))) "$a0")
              else do:  #())));;;
          (if: (method_call #(ptrTⁱᵈ raftⁱᵈ) #"maybeCommit"%go (![#ptrT] "r")) #()
          then
            do:  (let: "$a0" := (![#ptrT] "r") in
            ...
            (method_call #(ptrTⁱᵈ tracker.Progressⁱᵈ) #"CanBumpCommit"%go (![#ptrT] "pr")) "$a0")
            then
              do:  (let: "$a0" := (![#uint64T] (struct.field_ref #raftpb.Message #"From"%go "m")) in
              (method_call #(ptrTⁱᵈ raftⁱᵈ) #"sendAppend"%go (![#ptrT] "r")) "$a0")
            else do:  #()));;;
          ...
          then
            ...
            let: "$a1" := #false in
            (method_call #(ptrTⁱᵈ raftⁱᵈ) #"maybeSendAppend"%go (![#ptrT] "r")) "$a0" "$a1"); (λ: <>, #()) := λ: <>,
              do:  #())
          else do:  #());;;
          (if: ((![#uint64T] (struct.field_ref #raftpb.Message #"From"%go "m")) = (![#uint64T] (struct.field_ref #raft #"leadTransferee"%go (![#ptrT] "r")))) && ((![#uint64T] (struct.field_ref #tracker.Progress #"Match"%go (![#ptrT] "pr"))) = ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #()))
          then
            ...
            (interface.get #"Infof"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
            do:  (let: "$a0" := (![#uint64T] (struct.field_ref #raftpb.Message #"From"%go "m")) in
            (method_call #(ptrTⁱᵈ raftⁱᵈ) #"sendTimeoutNow"%go (![#ptrT] "r")) "$a0")
          else do:  #())
        else do:  #()))
    else
      ...
      then
        ...
        (if: ((![#uint64T] (struct.field_ref #tracker.Progress #"Match"%go (![#ptrT] "pr"))) < ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #())) || ((![#tracker.StateType] (struct.field_ref #tracker.Progress #"State"%go (![#ptrT] "pr"))) = tracker.StateProbe)
        then
          do:  (let: "$a0" := (![#uint64T] (struct.field_ref #raftpb.Message #"From"%go "m")) in
          (method_call #(ptrTⁱᵈ raftⁱᵈ) #"sendAppend"%go (![#ptrT] "r")) "$a0")
        else do:  #());;;
        ...
        (method_call #(ptrTⁱᵈ readOnlyⁱᵈ) #"recvAck"%go (![#ptrT] (struct.field_ref #raft #"readOnly"%go (![#ptrT] "r")))) "$a0" "$a1") in
        (method_call #quorum.JointConfigⁱᵈ #"VoteResult"%go (![#quorum.JointConfig] (struct.field_ref #tracker.Config #"Voters"%go (struct.field_ref #tracker.ProgressTracker #"Config"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r")))))) "$a0") ≠ quorum.VoteWon
        then return: (#interface.nil)
        else do:  #());;;
        let: "rss" := (mem.alloc (type.zero_val #sliceT)) in
        let: "$r0" := (let: "$a0" := (![#raftpb.Message] "m") in
        (method_call #(ptrTⁱᵈ readOnlyⁱᵈ) #"advance"%go (![#ptrT] (struct.field_ref #raft #"readOnly"%go (![#ptrT] "r")))) "$a0") in
        do:  ("rss" <-[#sliceT] "$r0");;;
            ...
            then
              ...
              then
                ...
                then
                  ...
                  let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
                  let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r")))) in
                  let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] "leadTransferee")) in
                  let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] "leadTransferee")) in
                  slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"])) in
                  (interface.get #"Infof"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
                  return: (#interface.nil)
                else do:  #());;;
                ...
                let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
                let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r")))) in
                let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] "lastLeadTransferee")) in
                slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"])) in
                (interface.get #"Infof"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1")
              else do:  #());;;
              ...
              (if: (![#uint64T] (struct.field_ref #tracker.Progress #"Match"%go (![#ptrT] "pr"))) = ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #())
              then
                ...
                let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
                let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] "leadTransferee")) in
                let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] "leadTransferee")) in
                slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"])) in
                (interface.get #"Infof"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1")
              else
  ...
  λ: "r" "m",
    ...
    then
      ...
      then
        ...
        (method_call #(ptrTⁱᵈ raftⁱᵈ) #"becomeFollower"%go (![#ptrT] "r")) "$a0" "$a1");;;
        do:  (let: "$a0" := (![#raftpb.Message] "m") in
        (method_call #(ptrTⁱᵈ raftⁱᵈ) #"handleAppendEntries"%go (![#ptrT] "r")) "$a0")
      else
        ...
        then
          ...
          (method_call #(ptrTⁱᵈ raftⁱᵈ) #"becomeFollower"%go (![#ptrT] "r")) "$a0" "$a1");;;
          do:  (let: "$a0" := (![#raftpb.Message] "m") in
          (method_call #(ptrTⁱᵈ raftⁱᵈ) #"handleHeartbeat"%go (![#ptrT] "r")) "$a0")
        else
          ...
          then
            ...
            (method_call #(ptrTⁱᵈ raftⁱᵈ) #"becomeFollower"%go (![#ptrT] "r")) "$a0" "$a1");;;
            do:  (let: "$a0" := (![#raftpb.Message] "m") in
            (method_call #(ptrTⁱᵈ raftⁱᵈ) #"handleSnapshot"%go (![#ptrT] "r")) "$a0")
          else
            ...
            then
              ...
              (method_call #(ptrTⁱᵈ raftⁱᵈ) #"poll"%go (![#ptrT] "r")) "$a0" "$a1" "$a2") in
              let: "$r0" := "$ret0" in
              let: "$r1" := "$ret1" in
              let: "$r2" := "$ret2" in
              do:  ("gr" <-[#intT] "$r0");;;
              ...
              let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
              let: "$sl1" := (interface.make #intTⁱᵈ (![#intT] "gr")) in
              let: "$sl2" := (interface.make #raftpb.MessageTypeⁱᵈ (![#raftpb.MessageType] (struct.field_ref #raftpb.Message #"Type"%go "m"))) in
              let: "$sl3" := (interface.make #intTⁱᵈ (![#intT] "rj")) in
              slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"])) in
              (interface.get #"Infof"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
              ...
              then
                ...
                then
                  ...
                  do:  ((method_call #(ptrTⁱᵈ raftⁱᵈ) #"becomeLeader"%go (![#ptrT] "r")) #());;;
                  do:  ((method_call #(ptrTⁱᵈ raftⁱᵈ) #"bcastAppend"%go (![#ptrT] "r")) #()))
              else
              ...
              then
                ...
                let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
                let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r")))) in
                let: "$sl2" := (interface.make #StateTypeⁱᵈ (![#StateType] (struct.field_ref #raft #"state"%go (![#ptrT] "r")))) in
                let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"From"%go "m"))) in
                slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"])) in
                (interface.get #"Debugf"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1")
              else do:  #()))))));;;
          ...
          then
            ...
            then
              ...
              then
                ...
                then
                  do:  (let: "$a0" := ((let: "$sl0" := (interface.make #stringTⁱᵈ #"ignoring MsgForgetLeader due to ReadOnlyLeaseBased"%go) in
                  slice.literal #interfaceT ["$sl0"])) in
                ...
                then
                  ...
                  let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
                  let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r")))) in
                  let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"From"%go "m"))) in
                  slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"])) in
                  (interface.get #"Infof"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
                  ...
                  then
                    ...
                    then
                      ...
                      then
                        ...
                        let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
                        let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"From"%go "m"))) in
                        let: "$sl2" := (interface.make #intTⁱᵈ (let: "$a0" := (![#sliceT] (struct.field_ref #raftpb.Message #"Entries"%go "m")) in
                        slice.len "$a0")) in
                        slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"])) in
...
Definition raft__handleAppendEntriesⁱᵐᵖˡ : val :=
  λ: "r" "m",
    ...
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"maybeAppend"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0" "$a1") in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    ...
    let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
    let: "$sl1" := (interface.make #uint64Tⁱᵈ (let: ("$ret0", "$ret1") := ((let: "$a0" := (![#uint64T] (struct.field_ref #raftpb.Message #"Index"%go "m")) in
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"term"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0")) in
    let: "$a0" := "$ret0" in
    let: "$a1" := "$ret1" in
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"zeroTermOnOutOfBounds"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0" "$a1")) in
    let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"Index"%go "m"))) in
    let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"LogTerm"%go "m"))) in
    let: "$sl4" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"Index"%go "m"))) in
    let: "$sl5" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"From"%go "m"))) in
    slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"; "$sl4"; "$sl5"])) in
    (interface.get #"Debugf"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
    ...
    let: "$a1" := ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #()) in
    (minUint64 2) "$a0" "$a1") in
...
Definition raft__handleHeartbeatⁱᵐᵖˡ : val :=
  λ: "r" "m",
    ...
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"commitTo"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0");;;
    do:  (let: "$a0" := (let: "$To" := (![#uint64T] (struct.field_ref #raftpb.Message #"From"%go "m")) in
...
Definition raft__handleSnapshotⁱᵐᵖˡ : val :=
  λ: "r" "m",
    ...
    (method_call #(ptrTⁱᵈ raftⁱᵈ) #"restore"%go (![#ptrT] "r")) "$a0"
    then
      do:  (let: "$a0" := #"%x [commit: %d] restored snapshot [index: %d, term: %d]"%go in
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
      let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftLog #"committed"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))))) in
      let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] "sindex")) in
      let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] "sterm")) in
      slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"])) in
      (interface.get #"Infof"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
      do:  (let: "$a0" := (let: "$To" := (![#uint64T] (struct.field_ref #raftpb.Message #"From"%go "m")) in
      let: "$Type" := raftpb.MsgAppResp in
      let: "$Index" := ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #()) in
      struct.make #raftpb.Message [{
        "Type" ::= "$Type";
        "To" ::= "$To";
        "From" ::= type.zero_val #uint64T;
...
Definition raft__restoreⁱᵐᵖˡ : val :=
  λ: "r" "s",
    ...
    then
      ...
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
      let: "$sl1" := (interface.make #raftpb.ConfStateⁱᵈ (![#raftpb.ConfState] "cs")) in
      slice.literal #interfaceT ["$sl0"; "$sl1"])) in
      (interface.get #"Warningf"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
      return: (#false)
    else do:  #());;;
    ...
    do:  ("id" <-[#entryID] "$r0");;;
    (if: let: "$a0" := (![#entryID] "id") in
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"matchTerm"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0"
    then
      let: "last" := (mem.alloc (type.zero_val #entryID)) in
      let: "$r0" := ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastEntryID"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #()) in
      do:  ("last" <-[#entryID] "$r0");;;
      ...
      let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftLog #"committed"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))))) in
      let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"index"%go "last"))) in
      let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"term"%go "last"))) in
      let: "$sl4" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"index"%go "id"))) in
      let: "$sl5" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #entryID #"term"%go "id"))) in
      slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"; "$sl4"; "$sl5"])) in
      (interface.get #"Infof"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
    ...
    do:  (let: "$a0" := (![#raftpb.Snapshot] "s") in
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"restore"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0");;;
    ...
    let: "cfg" := (mem.alloc (type.zero_val #tracker.Config)) in
    let: (("$ret0", "$ret1"), "$ret2") := (let: "$a0" := (let: "$Tracker" := (![#tracker.ProgressTracker] (struct.field_ref #raft #"trk"%go (![#ptrT] "r"))) in
    let: "$LastIndex" := ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #()) in
    struct.make #confchange.Changer [{
      "Tracker" ::= "$Tracker";
      "LastIndex" ::= "$LastIndex"
    }]) in
    ...
    (if: (~ (interface.eq (![#error] "err") #interface.nil))
    then
      do:  (let: "$a0" := (interface.make #stringTⁱᵈ (let: "$a0" := #"unable to restore config %+v: %s"%go in
      let: "$a1" := ((let: "$sl0" := (interface.make #raftpb.ConfStateⁱᵈ (![#raftpb.ConfState] "cs")) in
      let: "$sl1" := (![#error] "err") in
      slice.literal #interfaceT ["$sl0"; "$sl1"])) in
      (func_call #fmt.Sprintf) "$a0" "$a1")) in
      Panic "$a0")
...
Definition raft__promotableⁱᵐᵖˡ : val :=
  λ: "r" <>,
    ...
    let: "$r0" := (Fst (map.get (![#tracker.ProgressMap] (struct.field_ref #tracker.ProgressTracker #"Progress"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r")))) (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r"))))) in
    do:  ("pr" <-[#ptrT] "$r0");;;
    return: ((((![#ptrT] "pr") ≠ #null) && (~ (![#boolT] (struct.field_ref #tracker.Progress #"IsLearner"%go (![#ptrT] "pr"))))) && (~ ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"hasNextOrInProgressSnapshot"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #())))).
...
Definition raft__applyConfChangeⁱᵐᵖˡ : val :=
  λ: "r" "cc",
    ...
    let: (("$ret0", "$ret1"), "$ret2") := ((λ: <>,
      ...
      (if: (method_call #raftpb.ConfChangeV2ⁱᵈ #"LeaveJoint"%go (![#raftpb.ConfChangeV2] "cc")) #()
      then
        let: (("$ret0", "$ret1"), "$ret2") := (((method_call #confchange.Changerⁱᵈ #"LeaveJoint"%go (![#confchange.Changer] "changer")) #())) in
        return: ("$ret0", "$ret1", "$ret2")
      else
        (let: "ok" := (mem.alloc (type.zero_val #boolT)) in
        let: "autoLeave" := (mem.alloc (type.zero_val #boolT)) in
        let: ("$ret0", "$ret1") := ((method_call #raftpb.ConfChangeV2ⁱᵈ #"EnterJoint"%go (![#raftpb.ConfChangeV2] "cc")) #()) in
        let: "$r0" := "$ret0" in
        let: "$r1" := "$ret1" in
        ...
        then
          ...
          (method_call #confchange.Changerⁱᵈ #"EnterJoint"%go (![#confchange.Changer] "changer")) "$a0" "$a1")) in
          return: ("$ret0", "$ret1", "$ret2")
        else do:  #())));;;
      let: (("$ret0", "$ret1"), "$ret2") := ((let: "$a0" := (![#sliceT] (struct.field_ref #raftpb.ConfChangeV2 #"Changes"%go "cc")) in
      (method_call #confchange.Changerⁱᵈ #"Simple"%go (![#confchange.Changer] "changer")) "$a0")) in
      return: ("$ret0", "$ret1", "$ret2"))
      ) #()) in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    ...
    return: (let: "$a0" := (![#tracker.Config] "cfg") in
     let: "$a1" := (![#tracker.ProgressMap] "trk") in
     (method_call #(ptrTⁱᵈ raftⁱᵈ) #"switchToConfig"%go (![#ptrT] "r")) "$a0" "$a1")).
...
Definition raft__switchToConfigⁱᵐᵖˡ : val :=
  λ: "r" "cfg" "trk",
    ...
    let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
    let: "$sl1" := (interface.make #tracker.Configⁱᵈ (![#tracker.Config] (struct.field_ref #tracker.ProgressTracker #"Config"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r"))))) in
    slice.literal #interfaceT ["$sl0"; "$sl1"])) in
    (interface.get #"Infof"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1");;;
    let: "cs" := (mem.alloc (type.zero_val #raftpb.ConfState)) in
    let: "$r0" := ((method_call #(ptrTⁱᵈ tracker.ProgressTrackerⁱᵈ) #"ConfState"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r"))) #()) in
    do:  ("cs" <-[#raftpb.ConfState] "$r0");;;
    let: "ok" := (mem.alloc (type.zero_val #boolT)) in
    let: "pr" := (mem.alloc (type.zero_val #ptrT)) in
    let: ("$ret0", "$ret1") := (map.get (![#tracker.ProgressMap] (struct.field_ref #tracker.ProgressTracker #"Progress"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r")))) (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
    ...
    (if: (method_call #(ptrTⁱᵈ raftⁱᵈ) #"maybeCommit"%go (![#ptrT] "r")) #()
    then do:  ((method_call #(ptrTⁱᵈ raftⁱᵈ) #"bcastAppend"%go (![#ptrT] "r")) #())
    else
      do:  (let: "$a0" := (λ: "id" <>,
        exception_do (let: "id" := (mem.alloc "id") in
        (if: (![#uint64T] "id") = (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))
    ...
    let: ("$ret0", "$ret1") := (map.get ((method_call #quorum.JointConfigⁱᵈ #"IDs"%go (![#quorum.JointConfig] (struct.field_ref #tracker.Config #"Voters"%go (struct.field_ref #tracker.ProgressTracker #"Config"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r")))))) #()) (![#uint64T] (struct.field_ref #raft #"leadTransferee"%go (![#ptrT] "r")))) in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    do:  "$r0";;;
    do:  ("tOK" <-[#boolT] "$r1");;;
...
Definition raft__loadStateⁱᵐᵖˡ : val :=
  λ: "r" "state",
    ...
    (if: ((![#uint64T] (struct.field_ref #raftpb.HardState #"Commit"%go "state")) < (![#uint64T] (struct.field_ref #raftLog #"committed"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))))) || ((![#uint64T] (struct.field_ref #raftpb.HardState #"Commit"%go "state")) > ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #()))
    then
      do:  (let: "$a0" := #"%x state.commit %d is out of range [%d, %d]"%go in
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raft #"id"%go (![#ptrT] "r")))) in
      let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.HardState #"Commit"%go "state"))) in
      let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftLog #"committed"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))))) in
      let: "$sl3" := (interface.make #uint64Tⁱᵈ ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastIndex"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #())) in
      slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"])) in
      (interface.get #"Panicf"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0" "$a1")
    else do:  #());;;
...
Definition raft__resetRandomizedElectionTimeoutⁱᵐᵖˡ : val :=
  λ: "r" <>,
    ...
    (method_call #(ptrTⁱᵈ lockedRandⁱᵈ) #"Intn"%go (![#ptrT] (globals.get #globalRand))) "$a0")) in
...
Definition raft__committedEntryInCurrentTermⁱᵐᵖˡ : val :=
  λ: "r" <>,
    ...
    return: ((let: ("$ret0", "$ret1") := ((let: "$a0" := (![#uint64T] (struct.field_ref #raftLog #"committed"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r"))))) in
     ...
     let: "$a0" := "$ret0" in
     let: "$a1" := "$ret1" in
     (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"zeroTermOnOutOfBounds"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0" "$a1") = (![#uint64T] (struct.field_ref #raft #"Term"%go (![#ptrT] "r"))))).
...
Definition releasePendingReadIndexMessagesⁱᵐᵖˡ : val :=
  λ: "r",
    ...
    (if: (~ ((method_call #(ptrTⁱᵈ raftⁱᵈ) #"committedEntryInCurrentTerm"%go (![#ptrT] "r")) #()))
    then
      do:  (let: "$a0" := ((let: "$sl0" := (interface.make #stringTⁱᵈ #"pending MsgReadIndex should be released only after first commit in current term"%go) in
      slice.literal #interfaceT ["$sl0"])) in
      (interface.get #"Error"%go (![#Logger] (struct.field_ref #raft #"logger"%go (![#ptrT] "r")))) "$a0");;;
      return: (#())
    else do:  #());;;
...
Definition sendMsgReadIndexResponseⁱᵐᵖˡ : val :=
  λ: "r" "m",
    ...
    then
      do:  (let: "$a0" := (![#uint64T] (struct.field_ref #raftLog #"committed"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r"))))) in
      let: "$a1" := (![#raftpb.Message] "m") in
      (method_call #(ptrTⁱᵈ readOnlyⁱᵈ) #"addRequest"%go (![#ptrT] (struct.field_ref #raft #"readOnly"%go (![#ptrT] "r")))) "$a0" "$a1");;;
      ...
      (method_call #(ptrTⁱᵈ readOnlyⁱᵈ) #"recvAck"%go (![#ptrT] (struct.field_ref #raft #"readOnly"%go (![#ptrT] "r")))) "$a0" "$a1");;;
...
Definition NewRawNodeⁱᵐᵖˡ : val :=
  λ: "config",
    ...
    let: "$r0" := ((method_call #(ptrTⁱᵈ raftⁱᵈ) #"softState"%go (![#ptrT] "r")) #()) in
    do:  ("ss" <-[#SoftState] "$r0");;;
    let: "$r0" := "ss" in
    do:  ((struct.field_ref #RawNode #"prevSoftSt"%go (![#ptrT] "rn")) <-[#ptrT] "$r0");;;
    let: "$r0" := ((method_call #(ptrTⁱᵈ raftⁱᵈ) #"hardState"%go (![#ptrT] "r")) #()) in
    do:  ((struct.field_ref #RawNode #"prevHardSt"%go (![#ptrT] "rn")) <-[#raftpb.HardState] "$r0");;;
...
Definition RawNode__Campaignⁱᵐᵖˡ : val :=
  λ: "rn" <>,
    ...
    return: (let: "$a0" := (let: "$Type" := raftpb.MsgHup in
     ...
     (method_call #(ptrTⁱᵈ raftⁱᵈ) #"Step"%go (![#ptrT] (struct.field_ref #RawNode #"raft"%go (![#ptrT] "rn")))) "$a0")).
...
Definition RawNode__ApplyConfChangeⁱᵐᵖˡ : val :=
  λ: "rn" "cc",
    ...
    (method_call #(ptrTⁱᵈ raftⁱᵈ) #"applyConfChange"%go (![#ptrT] (struct.field_ref #RawNode #"raft"%go (![#ptrT] "rn")))) "$a0") in
    do:  ("cs" <-[#raftpb.ConfState] "$r0");;;
    return: ("cs")).
...
Definition RawNode__Readyⁱᵐᵖˡ : val :=
  λ: "rn" <>,
    exception_do (let: "rn" := (mem.alloc "rn") in
    let: "rd" := (mem.alloc (type.zero_val #Ready)) in
    let: "$r0" := ((method_call #(ptrTⁱᵈ RawNodeⁱᵈ) #"readyWithoutAccept"%go (![#ptrT] "rn")) #()) in
    do:  ("rd" <-[#Ready] "$r0");;;
    do:  (let: "$a0" := (![#Ready] "rd") in
    (method_call #(ptrTⁱᵈ RawNodeⁱᵈ) #"acceptReady"%go (![#ptrT] "rn")) "$a0");;;
    return: (![#Ready] "rd")).
...
Definition RawNode__readyWithoutAcceptⁱᵐᵖˡ : val :=
  λ: "rn" <>,
    ...
    do:  ("r" <-[#ptrT] "$r0");;;
    let: "rd" := (mem.alloc (type.zero_val #Ready)) in
    let: "$r0" := (let: "$Entries" := ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"nextUnstableEnts"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #()) in
    let: "$CommittedEntries" := (let: "$a0" := ((method_call #(ptrTⁱᵈ RawNodeⁱᵈ) #"applyUnstableEntries"%go (![#ptrT] "rn")) #()) in
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"nextCommittedEnts"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0") in
    ...
    (method_call #(ptrTⁱᵈ SoftStateⁱᵈ) #"equal"%go "softSt") "$a0"))
    then
    ...
    (if: (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"hasNextUnstableSnapshot"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #()
    then
      let: "$r0" := (![#raftpb.Snapshot] ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"nextUnstableSnapshot"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #())) in
    ...
    let: "$r0" := (let: "$a0" := ((method_call #(ptrTⁱᵈ raftⁱᵈ) #"hardState"%go (![#ptrT] "r")) #()) in
    let: "$a1" := (![#raftpb.HardState] (struct.field_ref #RawNode #"prevHardSt"%go (![#ptrT] "rn"))) in
...
Definition needStorageAppendRespMsgⁱᵐᵖˡ : val :=
  λ: "r" "rd",
    exception_do (let: "rd" := (mem.alloc "rd") in
    let: "r" := (mem.alloc "r") in
    return: (((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"hasNextOrInProgressUnstableEnts"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #()) || (~ (let: "$a0" := (![#raftpb.Snapshot] (struct.field_ref #Ready #"Snapshot"%go "rd")) in
     (func_call #IsEmptySnap) "$a0")))).
...
Definition newStorageAppendRespMsgⁱᵐᵖˡ : val :=
  λ: "r" "rd",
    ...
    do:  ("m" <-[#raftpb.Message] "$r0");;;
    (if: (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"hasNextOrInProgressUnstableEnts"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #()
    then
      let: "last" := (mem.alloc (type.zero_val #entryID)) in
      let: "$r0" := ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"lastEntryID"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #()) in
      do:  ("last" <-[#entryID] "$r0");;;
...
Definition RawNode__acceptReadyⁱᵐᵖˡ : val :=
  λ: "rn" "rd",
    ...
    do:  ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"acceptUnstable"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] (struct.field_ref #RawNode #"raft"%go (![#ptrT] "rn")))))) #());;;
    ...
    then
      ...
      let: "$a1" := (let: "$a0" := (![#sliceT] "ents") in
      (func_call #entsSize) "$a0") in
      let: "$a2" := ((method_call #(ptrTⁱᵈ RawNodeⁱᵈ) #"applyUnstableEntries"%go (![#ptrT] "rn")) #()) in
      (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"acceptApplying"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] (struct.field_ref #RawNode #"raft"%go (![#ptrT] "rn")))))) "$a0" "$a1" "$a2")
    else do:  #());;;
...
Definition RawNode__HasReadyⁱᵐᵖˡ : val :=
  λ: "rn" <>,
    ...
    (if: ((method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"hasNextUnstableEnts"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) #()) || (let: "$a0" := ((method_call #(ptrTⁱᵈ RawNodeⁱᵈ) #"applyUnstableEntries"%go (![#ptrT] "rn")) #()) in
    (method_call #(ptrTⁱᵈ raftLogⁱᵈ) #"hasNextCommittedEnts"%go (![#ptrT] (struct.field_ref #raft #"raftLog"%go (![#ptrT] "r")))) "$a0")
    then return: (#true)
    else do:  #());;;
    (if: (let: "$a0" := (![#sliceT] (struct.field_ref #raft #"readStates"%go (![#ptrT] "r"))) in
    slice.len "$a0") ≠ #(W64 0)
...
Definition RawNode__Advanceⁱᵐᵖˡ : val :=
  λ: "rn" <>,
    ...
    slice.for_range #raftpb.Message "$range" (λ: "$key" "$value",
      ...
      do:  ("i" <-[#intT] "$key");;;
      let: "$r0" := (let: "$a0" := (![#raftpb.Message] "m") in
      (method_call #(ptrTⁱᵈ raftⁱᵈ) #"Step"%go (![#ptrT] (struct.field_ref #RawNode #"raft"%go (![#ptrT] "rn")))) "$a0") in
      do:  "$r0";;;
...
Definition ProgressTypeⁱᵈ : go_string := "go.etcd.io/raft/v3.ProgressType"%go.
...
Definition RawNode__WithProgressⁱᵐᵖˡ : val :=
  λ: "rn" "visitor",
    ...
    (method_call #(ptrTⁱᵈ tracker.ProgressTrackerⁱᵈ) #"Visit"%go (struct.field_ref #raft #"trk"%go (![#ptrT] (struct.field_ref #RawNode #"raft"%go (![#ptrT] "rn"))))) "$a0");;;
    return: #()).
...
Definition ReadStateⁱᵈ : go_string := "go.etcd.io/raft/v3.ReadState"%go.

Definition readIndexStatusⁱᵈ : go_string := "go.etcd.io/raft/v3.readIndexStatus"%go.
...
Definition readOnly__advanceⁱᵐᵖˡ : val :=
  λ: "ro" "m",
    ...
    slice.for_range #stringT "$range" (λ: "$key" "$value",
      ...
      (if: (~ (![#boolT] "ok"))
      then
        do:  (let: "$a0" := (interface.make #stringTⁱᵈ #"cannot find corresponding read state from pending map"%go) in
        Panic "$a0")
      else do:  #());;;
...
Definition TraceLoggerⁱᵈ : go_string := "go.etcd.io/raft/v3.TraceLogger"%go.

Definition TracingEventⁱᵈ : go_string := "go.etcd.io/raft/v3.TracingEvent"%go.
...
Definition Statusⁱᵈ : go_string := "go.etcd.io/raft/v3.Status"%go.

Definition BasicStatusⁱᵈ : go_string := "go.etcd.io/raft/v3.BasicStatus"%go.
...
Definition getProgressCopyⁱᵐᵖˡ : val :=
  λ: "r",
    ...
    do:  (let: "$a0" := (λ: "id" "pr",
      ...
      let: "$r0" := (![#tracker.Progress] (![#ptrT] "pr")) in
      do:  ("p" <-[#tracker.Progress] "$r0");;;
      let: "$r0" := ((method_call #(ptrTⁱᵈ tracker.Inflightsⁱᵈ) #"Clone"%go (![#ptrT] (struct.field_ref #tracker.Progress #"Inflights"%go (![#ptrT] "pr")))) #()) in
      do:  ((struct.field_ref #tracker.Progress #"Inflights"%go "p") <-[#ptrT] "$r0");;;
      let: "$r0" := #null in
      do:  ("pr" <-[#ptrT] "$r0");;;
...
Definition getStatusⁱᵐᵖˡ : val :=
  λ: "r",
    ...
    let: "$r0" := ((method_call #(ptrTⁱᵈ tracker.Configⁱᵈ) #"Clone"%go (struct.field_ref #tracker.ProgressTracker #"Config"%go (struct.field_ref #raft #"trk"%go (![#ptrT] "r")))) #()) in
...
Definition Status__MarshalJSONⁱᵐᵖˡ : val :=
  λ: "s" <>,
    ...
    let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #BasicStatus #"ID"%go (struct.field_ref #Status #"BasicStatus"%go "s")))) in
    let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.HardState #"Term"%go (struct.field_ref #BasicStatus #"HardState"%go (struct.field_ref #Status #"BasicStatus"%go "s"))))) in
    let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.HardState #"Vote"%go (struct.field_ref #BasicStatus #"HardState"%go (struct.field_ref #Status #"BasicStatus"%go "s"))))) in
    let: "$sl3" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.HardState #"Commit"%go (struct.field_ref #BasicStatus #"HardState"%go (struct.field_ref #Status #"BasicStatus"%go "s"))))) in
    let: "$sl4" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #SoftState #"Lead"%go (struct.field_ref #BasicStatus #"SoftState"%go (struct.field_ref #Status #"BasicStatus"%go "s"))))) in
    let: "$sl5" := (interface.make #StateTypeⁱᵈ (![#StateType] (struct.field_ref #SoftState #"RaftState"%go (struct.field_ref #BasicStatus #"SoftState"%go (struct.field_ref #Status #"BasicStatus"%go "s"))))) in
    let: "$sl6" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #BasicStatus #"Applied"%go (struct.field_ref #Status #"BasicStatus"%go "s")))) in
    slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"; "$sl4"; "$sl5"; "$sl6"])) in
    (func_call #fmt.Sprintf) "$a0" "$a1") in
    do:  ("j" <-[#stringT] "$r0");;;
    ...
    then do:  ("j" <-[#stringT] ((![#stringT] "j") + #"},"%go))
      ...
      map.for_range "$range" (λ: "$key" "value",
        ...
        let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] "k")) in
        let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #tracker.Progress #"Match"%go "v"))) in
        let: "$sl2" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #tracker.Progress #"Next"%go "v"))) in
        let: "$sl3" := (interface.make #tracker.StateTypeⁱᵈ (![#tracker.StateType] (struct.field_ref #tracker.Progress #"State"%go "v"))) in
        slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"])) in
        (func_call #fmt.Sprintf) "$a0" "$a1") in
        do:  ("subj" <-[#stringT] "$r0");;;
    ...
    let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #BasicStatus #"LeadTransferee"%go (struct.field_ref #Status #"BasicStatus"%go "s")))) in
    slice.literal #interfaceT ["$sl0"])) in
    (func_call #fmt.Sprintf) "$a0" "$a1")));;;
...
Definition Status__Stringⁱᵐᵖˡ : val :=
  λ: "s" <>,
    ...
    let: ("$ret0", "$ret1") := ((method_call #Statusⁱᵈ #"MarshalJSON"%go (![#Status] "s")) #()) in
    let: "$r0" := "$ret0" in
    let: "$r1" := "$ret1" in
    do:  ("b" <-[#sliceT] "$r0");;;
    do:  ("err" <-[#error] "$r1");;;
...
Definition inMemStorageCallStatsⁱᵈ : go_string := "go.etcd.io/raft/v3.inMemStorageCallStats"%go.
...
Definition MemoryStorageⁱᵈ : go_string := "go.etcd.io/raft/v3.MemoryStorage"%go.
...
Definition MemoryStorage__SetHardStateⁱᵐᵖˡ : val :=
  λ: "ms" "st",
    ...
    let: "st" := (mem.alloc "st") in
    do:  ((method_call #(ptrTⁱᵈ MemoryStorageⁱᵈ) #"Lock"%go (![#ptrT] "ms")) #());;;
    do:  (let: "$f" := (method_call #(ptrTⁱᵈ MemoryStorageⁱᵈ) #"Unlock"%go (![#ptrT] "ms")) in
    "$defer" <-[#funcT] (let: "$oldf" := (![#funcT] "$defer") in
    (λ: <>,
      "$f" #();;
      "$oldf" #()
...
Definition MemoryStorage__Entriesⁱᵐᵖˡ : val :=
  λ: "ms" "lo" "hi" "maxSize",
    ...
    (if: (![#uint64T] "hi") > (((method_call #(ptrTⁱᵈ MemoryStorageⁱᵈ) #"lastIndex"%go (![#ptrT] "ms")) #()) + #(W64 1))
    then
      do:  (let: "$a0" := #"entries' hi(%d) is out of bound lastindex(%d)"%go in
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] "hi")) in
      let: "$sl1" := (interface.make #uint64Tⁱᵈ ((method_call #(ptrTⁱᵈ MemoryStorageⁱᵈ) #"lastIndex"%go (![#ptrT] "ms")) #())) in
      slice.literal #interfaceT ["$sl0"; "$sl1"])) in
      (interface.get #"Panicf"%go ((func_call #getLogger) #())) "$a0" "$a1")
    else do:  #());;;
...
Definition MemoryStorage__LastIndexⁱᵐᵖˡ : val :=
  λ: "ms" <>,
    ...
    return: ((method_call #(ptrTⁱᵈ MemoryStorageⁱᵈ) #"lastIndex"%go (![#ptrT] "ms")) #(), #interface.nil)).
...
Definition MemoryStorage__FirstIndexⁱᵐᵖˡ : val :=
  λ: "ms" <>,
    ...
    return: ((method_call #(ptrTⁱᵈ MemoryStorageⁱᵈ) #"firstIndex"%go (![#ptrT] "ms")) #(), #interface.nil)).
...
Definition MemoryStorage__CreateSnapshotⁱᵐᵖˡ : val :=
  λ: "ms" "i" "cs" "data",
    ...
    let: "$r0" := (![#uint64T] (struct.field_ref #raftpb.Entry #"Index"%go (slice.elem_ref #raftpb.Entry (![#sliceT] (struct.field_ref #MemoryStorage #"ents"%go (![#ptrT] "ms"))) #(W64 0)))) in
    do:  ("offset" <-[#uint64T] "$r0");;;
    (if: (![#uint64T] "i") > ((method_call #(ptrTⁱᵈ MemoryStorageⁱᵈ) #"lastIndex"%go (![#ptrT] "ms")) #())
    then
...
Definition MemoryStorage__Compactⁱᵐᵖˡ : val :=
  λ: "ms" "compactIndex",
    ...
    (if: (![#uint64T] "compactIndex") > ((method_call #(ptrTⁱᵈ MemoryStorageⁱᵈ) #"lastIndex"%go (![#ptrT] "ms")) #())
    then
      do:  (let: "$a0" := #"compact %d is out of bound lastindex(%d)"%go in
      let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] "compactIndex")) in
      let: "$sl1" := (interface.make #uint64Tⁱᵈ ((method_call #(ptrTⁱᵈ MemoryStorageⁱᵈ) #"lastIndex"%go (![#ptrT] "ms")) #())) in
      slice.literal #interfaceT ["$sl0"; "$sl1"])) in
      (interface.get #"Panicf"%go ((func_call #getLogger) #())) "$a0" "$a1")
    else do:  #());;;
...
Definition MemoryStorage__Appendⁱᵐᵖˡ : val :=
  λ: "ms" "entries",
    ...
    let: "$r0" := ((method_call #(ptrTⁱᵈ MemoryStorageⁱᵈ) #"firstIndex"%go (![#ptrT] "ms")) #()) in
    do:  ("first" <-[#uint64T] "$r0");;;
    let: "last" := (mem.alloc (type.zero_val #uint64T)) in
    ...
    then
      ...
      then
        ...
        let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ ((method_call #(ptrTⁱᵈ MemoryStorageⁱᵈ) #"lastIndex"%go (![#ptrT] "ms")) #())) in
        let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Entry #"Index"%go (slice.elem_ref #raftpb.Entry (![#sliceT] "entries") #(W64 0))))) in
        slice.literal #interfaceT ["$sl0"; "$sl1"])) in
        (interface.get #"Panicf"%go ((func_call #getLogger) #())) "$a0" "$a1")));;;
    return: (#interface.nil)).

Definition entryIDⁱᵈ : go_string := "go.etcd.io/raft/v3.entryID"%go.
...
Definition logSliceⁱᵈ : go_string := "go.etcd.io/raft/v3.logSlice"%go.
    ...
    slice.for_range #raftpb.Entry "$range" (λ: "$key" "$value",
      ...
      then
        return: (let: "$a0" := #"leader term %d: entries %+v and %+v not consistent"%go in
         let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #logSlice #"term"%go "s"))) in
         let: "$sl1" := (interface.make #entryIDⁱᵈ (![#entryID] "prev")) in
         let: "$sl2" := (interface.make #entryIDⁱᵈ (![#entryID] "id")) in
         slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"])) in
         (func_call #fmt.Errorf) "$a0" "$a1")
      else do:  #());;;
...
Definition StateType__MarshalJSONⁱᵐᵖˡ : val :=
  λ: "st" <>,
    ...
    return: (string.to_bytes (let: "$a0" := #"%q"%go in
     let: "$a1" := ((let: "$sl0" := (interface.make #stringTⁱᵈ ((method_call #StateTypeⁱᵈ #"String"%go (![#StateType] "st")) #())) in
     slice.literal #interfaceT ["$sl0"])) in
  ...
  λ: "msgt",
    ...
    then return: (raftpb.MsgVoteResp)
      ...
      then return: (raftpb.MsgPreVoteResp)
        ...
        do:  (let: "$a0" := (interface.make #stringTⁱᵈ (let: "$a0" := #"not a vote message: %s"%go in
        let: "$a1" := ((let: "$sl0" := (interface.make #raftpb.MessageTypeⁱᵈ (![#raftpb.MessageType] "msgt")) in
        slice.literal #interfaceT ["$sl0"])) in
        (func_call #fmt.Sprintf) "$a0" "$a1")) in
        Panic "$a0")))).
...
Definition DescribeHardStateⁱᵐᵖˡ : val :=
  λ: "hs",
    ...
    let: "$a1" := #"Term:%d"%go in
    let: "$a2" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.HardState #"Term"%go "hs"))) in
    slice.literal #interfaceT ["$sl0"])) in
    ...
    then
      do:  (let: "$a0" := (interface.make #(ptrTⁱᵈ strings.Builderⁱᵈ) "buf") in
      let: "$a1" := #" Vote:%d"%go in
      let: "$a2" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.HardState #"Vote"%go "hs"))) in
      slice.literal #interfaceT ["$sl0"])) in
      (func_call #fmt.Fprintf) "$a0" "$a1" "$a2")
    else do:  #());;;
    do:  (let: "$a0" := (interface.make #(ptrTⁱᵈ strings.Builderⁱᵈ) "buf") in
    let: "$a1" := #" Commit:%d"%go in
    let: "$a2" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.HardState #"Commit"%go "hs"))) in
    slice.literal #interfaceT ["$sl0"])) in
    (func_call #fmt.Fprintf) "$a0" "$a1" "$a2");;;
...
Definition DescribeSoftStateⁱᵐᵖˡ : val :=
  λ: "ss",
    ...
    return: (let: "$a0" := #"Lead:%d State:%s"%go in
     let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #SoftState #"Lead"%go "ss"))) in
     let: "$sl1" := (interface.make #StateTypeⁱᵈ (![#StateType] (struct.field_ref #SoftState #"RaftState"%go "ss"))) in
     slice.literal #interfaceT ["$sl0"; "$sl1"])) in
     (func_call #fmt.Sprintf) "$a0" "$a1")).
...
Definition DescribeConfStateⁱᵐᵖˡ : val :=
  λ: "state",
    ...
    return: (let: "$a0" := #"Voters:%v VotersOutgoing:%v Learners:%v LearnersNext:%v AutoLeave:%v"%go in
     let: "$a1" := ((let: "$sl0" := (interface.make #(sliceTⁱᵈ uint64Tⁱᵈ) (![#sliceT] (struct.field_ref #raftpb.ConfState #"Voters"%go "state"))) in
     let: "$sl1" := (interface.make #(sliceTⁱᵈ uint64Tⁱᵈ) (![#sliceT] (struct.field_ref #raftpb.ConfState #"VotersOutgoing"%go "state"))) in
     let: "$sl2" := (interface.make #(sliceTⁱᵈ uint64Tⁱᵈ) (![#sliceT] (struct.field_ref #raftpb.ConfState #"Learners"%go "state"))) in
     let: "$sl3" := (interface.make #(sliceTⁱᵈ uint64Tⁱᵈ) (![#sliceT] (struct.field_ref #raftpb.ConfState #"LearnersNext"%go "state"))) in
     let: "$sl4" := (interface.make #boolTⁱᵈ (![#boolT] (struct.field_ref #raftpb.ConfState #"AutoLeave"%go "state"))) in
     slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"; "$sl4"])) in
     (func_call #fmt.Sprintf) "$a0" "$a1")).
...
Definition DescribeSnapshotⁱᵐᵖˡ : val :=
  λ: "snap",
    ...
    return: (let: "$a0" := #"Index:%d Term:%d ConfState:%s"%go in
     let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.SnapshotMetadata #"Index"%go "m"))) in
     let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.SnapshotMetadata #"Term"%go "m"))) in
     let: "$sl2" := (interface.make #stringTⁱᵈ (let: "$a0" := (![#raftpb.ConfState] (struct.field_ref #raftpb.SnapshotMetadata #"ConfState"%go "m")) in
...
Definition DescribeReadyⁱᵐᵖˡ : val :=
  λ: "rd" "f",
    ...
    then
      do:  (let: "$a0" := (interface.make #(ptrTⁱᵈ strings.Builderⁱᵈ) "buf") in
      let: "$a1" := ((let: "$sl0" := (interface.make #stringTⁱᵈ (let: "$a0" := (![#SoftState] (![#ptrT] (struct.field_ref #Ready #"SoftState"%go "rd"))) in
    ...
    then
      ...
      let: "$a2" := ((let: "$sl0" := (interface.make #stringTⁱᵈ (let: "$a0" := (![#raftpb.HardState] (struct.field_ref #Ready #"HardState"%go "rd")) in
    ...
    then
      ...
      let: "$a1" := #"ReadStates %v
      "%go in
      let: "$a2" := ((let: "$sl0" := (interface.make #(sliceTⁱᵈ ReadStateⁱᵈ) (![#sliceT] (struct.field_ref #Ready #"ReadStates"%go "rd"))) in
      slice.literal #interfaceT ["$sl0"])) in
      (func_call #fmt.Fprintf) "$a0" "$a1" "$a2")
    else do:  #());;;
    ...
    then
      do:  (let: "$a0" := #"Entries:
      "%go in
      (method_call #(ptrTⁱᵈ strings.Builderⁱᵈ) #"WriteString"%go "buf") "$a0");;;
      do:  (let: "$a0" := (interface.make #(ptrTⁱᵈ strings.Builderⁱᵈ) "buf") in
      let: "$a1" := ((let: "$sl0" := (interface.make #stringTⁱᵈ (let: "$a0" := (![#sliceT] (struct.field_ref #Ready #"Entries"%go "rd")) in
    ...
    then
      ...
      let: "$a1" := #"Snapshot %s
      "%go in
      let: "$a2" := ((let: "$sl0" := (interface.make #stringTⁱᵈ (let: "$a0" := (![#raftpb.Snapshot] (struct.field_ref #Ready #"Snapshot"%go "rd")) in
    ...
    then
      ...
      (method_call #(ptrTⁱᵈ strings.Builderⁱᵈ) #"WriteString"%go "buf") "$a0");;;
      do:  (let: "$a0" := (interface.make #(ptrTⁱᵈ strings.Builderⁱᵈ) "buf") in
      let: "$a1" := ((let: "$sl0" := (interface.make #stringTⁱᵈ (let: "$a0" := (![#sliceT] (struct.field_ref #Ready #"CommittedEntries"%go "rd")) in
      let: "$a1" := (![#EntryFormatter] "f") in
      (func_call #DescribeEntries) "$a0" "$a1")) in
      slice.literal #interfaceT ["$sl0"])) in
      (func_call #fmt.Fprint) "$a0" "$a1")
    ...
    then
      ...
      slice.for_range #raftpb.Message "$range" (λ: "$key" "$value",
        ...
        do:  "$key";;;
        do:  (let: "$a0" := (interface.make #(ptrTⁱᵈ strings.Builderⁱᵈ) "buf") in
        let: "$a1" := ((let: "$sl0" := (interface.make #stringTⁱᵈ (let: "$a0" := (![#raftpb.Message] "msg") in
        let: "$a1" := (![#EntryFormatter] "f") in
    ...
    (if: int_gt ((method_call #(ptrTⁱᵈ strings.Builderⁱᵈ) #"Len"%go "buf") #()) #(W64 0)
    then
      return: (let: "$a0" := #"Ready MustSync=%t:
       %s"%go in
       let: "$a1" := ((let: "$sl0" := (interface.make #boolTⁱᵈ (![#boolT] (struct.field_ref #Ready #"MustSync"%go "rd"))) in
       let: "$sl1" := (interface.make #stringTⁱᵈ ((method_call #(ptrTⁱᵈ strings.Builderⁱᵈ) #"String"%go "buf") #())) in
       slice.literal #interfaceT ["$sl0"; "$sl1"])) in
       (func_call #fmt.Sprintf) "$a0" "$a1")
    else do:  #());;;
    return: (#"<empty Ready>"%go)).

Definition EntryFormatterⁱᵈ : go_string := "go.etcd.io/raft/v3.EntryFormatter"%go.
...
Definition describeMessageWithIndentⁱᵐᵖˡ : val :=
  λ: "indent" "m" "f",
    ...
    do:  (let: "$a0" := (interface.make #(ptrTⁱᵈ bytes.Bufferⁱᵈ) "buf") in
    let: "$a1" := #"%s%s->%s %v Term:%d Log:%d/%d"%go in
    let: "$a2" := ((let: "$sl0" := (interface.make #stringTⁱᵈ (![#stringT] "indent")) in
    let: "$sl1" := (interface.make #stringTⁱᵈ (let: "$a0" := (![#uint64T] (struct.field_ref #raftpb.Message #"From"%go "m")) in
    (func_call #describeTarget) "$a0")) in
    let: "$sl2" := (interface.make #stringTⁱᵈ (let: "$a0" := (![#uint64T] (struct.field_ref #raftpb.Message #"To"%go "m")) in
    (func_call #describeTarget) "$a0")) in
    let: "$sl3" := (interface.make #raftpb.MessageTypeⁱᵈ (![#raftpb.MessageType] (struct.field_ref #raftpb.Message #"Type"%go "m"))) in
    let: "$sl4" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"Term"%go "m"))) in
    let: "$sl5" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"LogTerm"%go "m"))) in
    let: "$sl6" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"Index"%go "m"))) in
    slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"; "$sl4"; "$sl5"; "$sl6"])) in
    (func_call #fmt.Fprintf) "$a0" "$a1" "$a2");;;
    (if: ![#boolT] (struct.field_ref #raftpb.Message #"Reject"%go "m")
    then
      ...
      let: "$a2" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"RejectHint"%go "m"))) in
      slice.literal #interfaceT ["$sl0"])) in
      (func_call #fmt.Fprintf) "$a0" "$a1" "$a2")
    else do:  #());;;
    ...
    then
      do:  (let: "$a0" := (interface.make #(ptrTⁱᵈ bytes.Bufferⁱᵈ) "buf") in
      let: "$a1" := #" Commit:%d"%go in
      let: "$a2" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"Commit"%go "m"))) in
      slice.literal #interfaceT ["$sl0"])) in
      (func_call #fmt.Fprintf) "$a0" "$a1" "$a2")
    else do:  #());;;
    ...
    then
      do:  (let: "$a0" := (interface.make #(ptrTⁱᵈ bytes.Bufferⁱᵈ) "buf") in
      let: "$a1" := #" Vote:%d"%go in
      let: "$a2" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Message #"Vote"%go "m"))) in
      slice.literal #interfaceT ["$sl0"])) in
      (func_call #fmt.Fprintf) "$a0" "$a1" "$a2")
    else do:  #());;;
    (let: "ln" := (mem.alloc (type.zero_val #intT)) in
    ...
    then
      ...
      let: "$a2" := ((let: "$sl0" := (interface.make #stringTⁱᵈ (let: "$a0" := (![#raftpb.Entry] (slice.elem_ref #raftpb.Entry (![#sliceT] (struct.field_ref #raftpb.Message #"Entries"%go "m")) #(W64 0))) in
      let: "$a1" := (![#EntryFormatter] "f") in
      ...
      then
        do:  (let: "$a0" := (interface.make #(ptrTⁱᵈ bytes.Bufferⁱᵈ) "buf") in
        let: "$a1" := ((let: "$sl0" := (interface.make #stringTⁱᵈ #" Entries:["%go) in
        slice.literal #interfaceT ["$sl0"])) in
        (func_call #fmt.Fprint) "$a0" "$a1");;;
        let: "$range" := (![#sliceT] (struct.field_ref #raftpb.Message #"Entries"%go "m")) in
        ...
        slice.for_range #raftpb.Entry "$range" (λ: "$key" "$value",
          ...
          let: "$a1" := (![#EntryFormatter] "f") in
          (func_call #DescribeEntry) "$a0" "$a1") in
          (method_call #(ptrTⁱᵈ bytes.Bufferⁱᵈ) #"WriteString"%go "buf") "$a0")));;;
        do:  (let: "$a0" := (interface.make #(ptrTⁱᵈ bytes.Bufferⁱᵈ) "buf") in
        let: "$a1" := #"
        %s]"%go in
        let: "$a2" := ((let: "$sl0" := (interface.make #stringTⁱᵈ (![#stringT] "indent")) in
    ...
    then
      ...
      %s  Snapshot: %s"%go in
      let: "$a2" := ((let: "$sl0" := (interface.make #stringTⁱᵈ (![#stringT] "indent")) in
      let: "$sl1" := (interface.make #stringTⁱᵈ (let: "$a0" := (![#raftpb.Snapshot] (![#ptrT] "s")) in
      (func_call #DescribeSnapshot) "$a0")) in
      slice.literal #interfaceT ["$sl0"; "$sl1"])) in
      (func_call #fmt.Fprintf) "$a0" "$a1" "$a2")
    else do:  #()));;;
    ...
    return: ((method_call #(ptrTⁱᵈ bytes.Bufferⁱᵈ) #"String"%go "buf") #())).
      ...
      then return: (#"AppendThread"%go)
        ...
        then return: (#"ApplyThread"%go)
          ...
          return: (let: "$a0" := #"%x"%go in
           let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] "id")) in
           slice.literal #interfaceT ["$sl0"])) in
           (func_call #fmt.Sprintf) "$a0" "$a1"))))).
  ...
  λ: "e" "f",
    ...
    then
      let: "$r0" := (λ: "data",
        ...
        return: (let: "$a0" := #"%q"%go in
         let: "$a1" := ((let: "$sl0" := (interface.make #(sliceTⁱᵈ byteTⁱᵈ) (![#sliceT] "data")) in
         slice.literal #interfaceT ["$sl0"])) in
         (func_call #fmt.Sprintf) "$a0" "$a1"))
        ) in
    ...
    then
      ...
      then
        ...
        (let: "err" := (mem.alloc (type.zero_val #error)) in
        let: "$r0" := (let: "$a0" := (![#sliceT] (struct.field_ref #raftpb.Entry #"Data"%go "e")) in
        (method_call #(ptrTⁱᵈ raftpb.ConfChangeⁱᵈ) #"Unmarshal"%go "cc") "$a0") in
        do:  ("err" <-[#error] "$r0");;;
        (if: (~ (interface.eq (![#error] "err") #interface.nil))
        then
          ...
          let: "$r0" := (let: "$a0" := (interface.make #raftpb.ConfChangeⁱᵈ (![#raftpb.ConfChange] "cc")) in
        ...
        then
          ...
          (let: "err" := (mem.alloc (type.zero_val #error)) in
          let: "$r0" := (let: "$a0" := (![#sliceT] (struct.field_ref #raftpb.Entry #"Data"%go "e")) in
          (method_call #(ptrTⁱᵈ raftpb.ConfChangeV2ⁱᵈ) #"Unmarshal"%go "cc") "$a0") in
          do:  ("err" <-[#error] "$r0");;;
          (if: (~ (interface.eq (![#error] "err") #interface.nil))
          then
            let: "$r0" := ((interface.get #"Error"%go (![#error] "err")) #()) in
            ...
            let: "$r0" := (let: "$a0" := (interface.make #raftpb.ConfChangeV2ⁱᵈ (![#raftpb.ConfChangeV2] "cc")) in
            (![#funcT] "formatConfChange") "$a0") in
            do:  ("formatted" <-[#stringT] "$r0")))
        else do:  #())));;;
    ...
    return: (let: "$a0" := #"%d/%d %s%s"%go in
     let: "$a1" := ((let: "$sl0" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Entry #"Term"%go "e"))) in
     let: "$sl1" := (interface.make #uint64Tⁱᵈ (![#uint64T] (struct.field_ref #raftpb.Entry #"Index"%go "e"))) in
     let: "$sl2" := (interface.make #raftpb.EntryTypeⁱᵈ (![#raftpb.EntryType] (struct.field_ref #raftpb.Entry #"Type"%go "e"))) in
     let: "$sl3" := (interface.make #stringTⁱᵈ (![#stringT] "formatted")) in
     slice.literal #interfaceT ["$sl0"; "$sl1"; "$sl2"; "$sl3"])) in
     (func_call #fmt.Sprintf) "$a0" "$a1")).
...
Definition DescribeEntriesⁱᵐᵖˡ : val :=
  λ: "ents" "f",
    ...
    slice.for_range #raftpb.Entry "$range" (λ: "$key" "$value",
      ...
      "%go) in
      (method_call #(ptrTⁱᵈ bytes.Bufferⁱᵈ) #"WriteString"%go "buf") "$a0") in
      let: "$r0" := "$ret0" in
      let: "$r1" := "$ret1" in
      do:  "$r0";;;
      do:  "$r1"));;;
...
Definition entsSizeⁱᵐᵖˡ : val :=
  λ: "ents",
    ...
    slice.for_range #raftpb.Entry "$range" (λ: "$key" "$value",
      ...
      do:  "$key";;;
      do:  ("size" <-[#entryEncodingSize] ((![#entryEncodingSize] "size") + (s_to_w64 ((method_call #(ptrTⁱᵈ raftpb.Entryⁱᵈ) #"Size"%go "ent") #()))))));;;
...
Definition limitSizeⁱᵐᵖˡ : val :=
  λ: "ents" "maxSize",
    ...
    let: "$r0" := ((method_call #(ptrTⁱᵈ raftpb.Entryⁱᵈ) #"Size"%go (slice.elem_ref #raftpb.Entry (![#sliceT] "ents") #(W64 0))) #()) in
    do:  ("size" <-[#intT] "$r0");;;
    ...
    slice.len "$a0")); (λ: <>, do:  ("limit" <-[#intT] ((![#intT] "limit") + #(W64 1)))) := λ: <>,
      do:  ("size" <-[#intT] ((![#intT] "size") + ((method_call #(ptrTⁱᵈ raftpb.Entryⁱᵈ) #"Size"%go (slice.elem_ref #raftpb.Entry (![#sliceT] "ents") (![#intT] "limit"))) #())));;;
...
Definition entryPayloadSizeⁱᵈ : go_string := "go.etcd.io/raft/v3.entryPayloadSize"%go.
...
Definition assertConfStatesEquivalentⁱᵐᵖˡ : val :=
  λ: "l" "cs1" "cs2",
    ...
    (method_call #raftpb.ConfStateⁱᵈ #"Equivalent"%go (![#raftpb.ConfState] "cs1")) "$a0") in
    do:  ("err" <-[#error] "$r0");;;
    (if: interface.eq (![#error] "err") #interface.nil
    then return: (#())
    else do:  #());;;
...
Definition msets' : list (go_string * (list (go_string * val))) := [(raftLogⁱᵈ, []); (ptrTⁱᵈ raftLogⁱᵈ, [("String"%go, raftLog__Stringⁱᵐᵖˡ); ("acceptApplying"%go, raftLog__acceptApplyingⁱᵐᵖˡ); ("acceptUnstable"%go, raftLog__acceptUnstableⁱᵐᵖˡ); ("allEntries"%go, raftLog__allEntriesⁱᵐᵖˡ); ("append"%go, raftLog__appendⁱᵐᵖˡ); ("appliedTo"%go, raftLog__appliedToⁱᵐᵖˡ); ("commitTo"%go, raftLog__commitToⁱᵐᵖˡ); ("entries"%go, raftLog__entriesⁱᵐᵖˡ); ("findConflict"%go, raftLog__findConflictⁱᵐᵖˡ); ("findConflictByTerm"%go, raftLog__findConflictByTermⁱᵐᵖˡ); ("firstIndex"%go, raftLog__firstIndexⁱᵐᵖˡ); ("hasNextCommittedEnts"%go, raftLog__hasNextCommittedEntsⁱᵐᵖˡ); ("hasNextOrInProgressSnapshot"%go, raftLog__hasNextOrInProgressSnapshotⁱᵐᵖˡ); ("hasNextOrInProgressUnstableEnts"%go, raftLog__hasNextOrInProgressUnstableEntsⁱᵐᵖˡ); ("hasNextUnstableEnts"%go, raftLog__hasNextUnstableEntsⁱᵐᵖˡ); ("hasNextUnstableSnapshot"%go, raftLog__hasNextUnstableSnapshotⁱᵐᵖˡ); ("isUpToDate"%go, raftLog__isUpToDateⁱᵐᵖˡ); ("lastEntryID"%go, raftLog__lastEntryIDⁱᵐᵖˡ); ("lastIndex"%go, raftLog__lastIndexⁱᵐᵖˡ); ("matchTerm"%go, raftLog__matchTermⁱᵐᵖˡ); ("maxAppliableIndex"%go, raftLog__maxAppliableIndexⁱᵐᵖˡ); ("maybeAppend"%go, raftLog__maybeAppendⁱᵐᵖˡ); ("maybeCommit"%go, raftLog__maybeCommitⁱᵐᵖˡ); ("mustCheckOutOfBounds"%go, raftLog__mustCheckOutOfBoundsⁱᵐᵖˡ); ("nextCommittedEnts"%go, raftLog__nextCommittedEntsⁱᵐᵖˡ); ("nextUnstableEnts"%go, raftLog__nextUnstableEntsⁱᵐᵖˡ); ("nextUnstableSnapshot"%go, raftLog__nextUnstableSnapshotⁱᵐᵖˡ); ("restore"%go, raftLog__restoreⁱᵐᵖˡ); ("scan"%go, raftLog__scanⁱᵐᵖˡ); ("slice"%go, raftLog__sliceⁱᵐᵖˡ); ("snapshot"%go, raftLog__snapshotⁱᵐᵖˡ); ("stableSnapTo"%go, raftLog__stableSnapToⁱᵐᵖˡ); ("stableTo"%go, raftLog__stableToⁱᵐᵖˡ); ("term"%go, raftLog__termⁱᵐᵖˡ); ("zeroTermOnOutOfBounds"%go, raftLog__zeroTermOnOutOfBoundsⁱᵐᵖˡ)]); (unstableⁱᵈ, []); (ptrTⁱᵈ unstableⁱᵈ, [("acceptInProgress"%go, unstable__acceptInProgressⁱᵐᵖˡ); ("maybeFirstIndex"%go, unstable__maybeFirstIndexⁱᵐᵖˡ); ("maybeLastIndex"%go, unstable__maybeLastIndexⁱᵐᵖˡ); ("maybeTerm"%go, unstable__maybeTermⁱᵐᵖˡ); ("mustCheckOutOfBounds"%go, unstable__mustCheckOutOfBoundsⁱᵐᵖˡ); ("nextEntries"%go, unstable__nextEntriesⁱᵐᵖˡ); ("nextSnapshot"%go, unstable__nextSnapshotⁱᵐᵖˡ); ("restore"%go, unstable__restoreⁱᵐᵖˡ); ("shrinkEntriesArray"%go, unstable__shrinkEntriesArrayⁱᵐᵖˡ); ("slice"%go, unstable__sliceⁱᵐᵖˡ); ("stableSnapTo"%go, unstable__stableSnapToⁱᵐᵖˡ); ("stableTo"%go, unstable__stableToⁱᵐᵖˡ); ("truncateAndAppend"%go, unstable__truncateAndAppendⁱᵐᵖˡ)]); (DefaultLoggerⁱᵈ, [("Fatalln"%go, (λ: "$recv",
                 ...
                 method_call #log #"Logger'ptr" #"output" (struct.field_get #DefaultLogger "Logger" "$recv")
                 )%V)]); (ptrTⁱᵈ DefaultLoggerⁱᵈ, [("Debug"%go, DefaultLogger__Debugⁱᵐᵖˡ); ("Debugf"%go, DefaultLogger__Debugfⁱᵐᵖˡ); ("EnableDebug"%go, DefaultLogger__EnableDebugⁱᵐᵖˡ); ("EnableTimestamps"%go, DefaultLogger__EnableTimestampsⁱᵐᵖˡ); ("Error"%go, DefaultLogger__Errorⁱᵐᵖˡ); ("Errorf"%go, DefaultLogger__Errorfⁱᵐᵖˡ); ("Fatal"%go, DefaultLogger__Fatalⁱᵐᵖˡ); ("Fatalf"%go, DefaultLogger__Fatalfⁱᵐᵖˡ); ("Fatalln"%go, (λ: "$recvAddr",
                 ...
                 method_call #log #"Logger'ptr" #"output" (![#ptrT] (struct.field_ref #DefaultLogger #"Logger"%go "$recvAddr"))
                 )%V)]); (SnapshotStatusⁱᵈ, []); (ptrTⁱᵈ SnapshotStatusⁱᵈ, []); (SoftStateⁱᵈ, []); (ptrTⁱᵈ SoftStateⁱᵈ, [("equal"%go, SoftState__equalⁱᵐᵖˡ)]); (Readyⁱᵈ, [("equal"%go, (λ: "$recv",
                 method_call #v3.raft #"SoftState'ptr" #"equal" (struct.field_get #Ready "SoftState" "$recv")
                 )%V)]); (ptrTⁱᵈ Readyⁱᵈ, [("Descriptor"%go, (λ: "$recvAddr",
                 ...
                 )%V)]); (BasicStatusⁱᵈ, []); (ptrTⁱᵈ BasicStatusⁱᵈ, [("Descriptor"%go, (λ: "$recvAddr",
                 ...
                 )%V); ("firstIndex"%go, MemoryStorage__firstIndexⁱᵐᵖˡ); ("lastIndex"%go, MemoryStorage__lastIndexⁱᵐᵖˡ)]); (entryIDⁱᵈ, []); (ptrTⁱᵈ entryIDⁱᵈ, []); (logSliceⁱᵈ, [("lastEntryID"%go, logSlice__lastEntryIDⁱᵐᵖˡ); ("lastIndex"%go, logSlice__lastIndexⁱᵐᵖˡ); ("valid"%go, logSlice__validⁱᵐᵖˡ)]); (ptrTⁱᵈ logSliceⁱᵈ, [("lastEntryID"%go, (λ: "$recvAddr",
                 ...
                 )%V)]); (EntryFormatterⁱᵈ, []); (ptrTⁱᵈ EntryFormatterⁱᵈ, []); (entryEncodingSizeⁱᵈ, []); (ptrTⁱᵈ entryEncodingSizeⁱᵈ, []); (entryPayloadSizeⁱᵈ, []); (ptrTⁱᵈ entryPayloadSizeⁱᵈ, [])].
...
Definition initialize' : val :=
  λ: <>,
    package.init #v3.raft (λ: <>,
      ...
      let: "$r0" := (mem.alloc (let: "$Logger" := (let: "$a0" := (interface.make #(ptrTⁱᵈ os.Fileⁱᵈ) (![#ptrT] (globals.get #os.Stderr))) in
      let: "$a1" := #"raft"%go in
      ...
      let: "$r0" := (interface.make #(ptrTⁱᵈ DefaultLoggerⁱᵈ) (![#ptrT] (globals.get #defaultLogger))) in
      do:  ((globals.get #raftLogger) <-[#Logger] "$r0");;;
