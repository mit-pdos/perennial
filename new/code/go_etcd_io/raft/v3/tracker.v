...
{|
  pkg_imported_pkgs := [code.fmt.pkg_id.fmt; code.slices.pkg_id.slices; code.strings.pkg_id.strings; code.go_etcd_io.raft.v3.quorum.pkg_id.quorum; code.go_etcd_io.raft.v3.raftpb.pkg_id.raftpb]
|}.
