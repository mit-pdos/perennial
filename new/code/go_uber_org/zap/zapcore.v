...
Definition msets' : list (go_string * (list (go_string * val))) := [(BufferedWriteSyncer.id, []); (ptrT.id BufferedWriteSyncer.id, [("Stop"%go, BufferedWriteSyncer__Stopⁱᵐᵖˡ); ("Sync"%go, BufferedWriteSyncer__Syncⁱᵐᵖˡ); ("Write"%go, BufferedWriteSyncer__Writeⁱᵐᵖˡ); ("flushLoop"%go, BufferedWriteSyncer__flushLoopⁱᵐᵖˡ); ("initialize"%go, BufferedWriteSyncer__initializeⁱᵐᵖˡ)]); (systemClock.id, [("NewTicker"%go, systemClock__NewTickerⁱᵐᵖˡ); ("Now"%go, systemClock__Nowⁱᵐᵖˡ)]); (ptrT.id systemClock.id, [("NewTicker"%go, (λ: "$r",
                 ...
                 method_call #systemClock.id #"Now"%go (![#systemClock] "$r")
                 )%V)]); (consoleEncoder.id, [("AddArray"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddArray"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddBinary"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddBinary"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddBool"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddBool"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddByteString"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddByteString"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddComplex128"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddComplex128"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddComplex64"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddComplex64"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddDuration"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddDuration"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddFloat32"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddFloat32"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddFloat64"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddFloat64"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddInt"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddInt"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddInt16"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddInt16"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddInt32"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddInt32"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddInt64"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddInt64"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddInt8"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddInt8"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddObject"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddObject"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddReflected"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddReflected"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddString"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddString"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddTime"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddTime"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddUint"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddUint"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddUint16"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddUint16"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddUint32"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddUint32"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddUint64"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddUint64"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddUint8"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddUint8"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AddUintptr"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddUintptr"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendArray"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendArray"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendBool"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendBool"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendByteString"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendByteString"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendComplex128"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendComplex128"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendComplex64"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendComplex64"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendDuration"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendDuration"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendFloat32"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendFloat32"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendFloat64"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendFloat64"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendInt"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendInt"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendInt16"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendInt16"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendInt32"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendInt32"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendInt64"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendInt64"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendInt8"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendInt8"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendObject"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendObject"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendReflected"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendReflected"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendString"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendString"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendTime"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendTime"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendTimeLayout"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendTimeLayout"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendUint"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendUint"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendUint16"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendUint16"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendUint32"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendUint32"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendUint64"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendUint64"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendUint8"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendUint8"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("AppendUintptr"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendUintptr"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("Clone"%go, consoleEncoder__Cloneⁱᵐᵖˡ); ("EncodeEntry"%go, consoleEncoder__EncodeEntryⁱᵐᵖˡ); ("OpenNamespace"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"OpenNamespace"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("addElementSeparator"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"addElementSeparator"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("addKey"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"addKey"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("addSeparatorIfNecessary"%go, consoleEncoder__addSeparatorIfNecessaryⁱᵐᵖˡ); ("appendComplex"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"appendComplex"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("appendFloat"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"appendFloat"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("clone"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"clone"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("closeOpenNamespaces"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"closeOpenNamespaces"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("encodeReflected"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"encodeReflected"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("resetReflectBuf"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"resetReflectBuf"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("safeAddByteString"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"safeAddByteString"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("safeAddString"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"safeAddString"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("truncate"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"truncate"%go (struct.field_get #consoleEncoder #"jsonEncoder"%go "$r")
                 )%V); ("writeContext"%go, consoleEncoder__writeContextⁱᵐᵖˡ)]); (ptrT.id consoleEncoder.id, [("AddArray"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddArray"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddBinary"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddBinary"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddBool"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddBool"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddByteString"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddByteString"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddComplex128"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddComplex128"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddComplex64"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddComplex64"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddDuration"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddDuration"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddFloat32"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddFloat32"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddFloat64"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddFloat64"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddInt"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddInt"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddInt16"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddInt16"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddInt32"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddInt32"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddInt64"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddInt64"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddInt8"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddInt8"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddObject"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddObject"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddReflected"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddReflected"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddString"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddString"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddTime"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddTime"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddUint"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddUint"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddUint16"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddUint16"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddUint32"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddUint32"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddUint64"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddUint64"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddUint8"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddUint8"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AddUintptr"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AddUintptr"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendArray"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendArray"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendBool"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendBool"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendByteString"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendByteString"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendComplex128"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendComplex128"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendComplex64"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendComplex64"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendDuration"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendDuration"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendFloat32"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendFloat32"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendFloat64"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendFloat64"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendInt"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendInt"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendInt16"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendInt16"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendInt32"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendInt32"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendInt64"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendInt64"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendInt8"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendInt8"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendObject"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendObject"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendReflected"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendReflected"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendString"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendString"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendTime"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendTime"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendTimeLayout"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendTimeLayout"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendUint"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendUint"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendUint16"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendUint16"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendUint32"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendUint32"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendUint64"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendUint64"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendUint8"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendUint8"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("AppendUintptr"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"AppendUintptr"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("Clone"%go, (λ: "$r",
                 method_call #consoleEncoder.id #"Clone"%go (![#consoleEncoder] "$r")
                 )%V); ("EncodeEntry"%go, (λ: "$r",
                 method_call #consoleEncoder.id #"EncodeEntry"%go (![#consoleEncoder] "$r")
                 )%V); ("OpenNamespace"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"OpenNamespace"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("addElementSeparator"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"addElementSeparator"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("addKey"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"addKey"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("addSeparatorIfNecessary"%go, (λ: "$r",
                 method_call #consoleEncoder.id #"addSeparatorIfNecessary"%go (![#consoleEncoder] "$r")
                 )%V); ("appendComplex"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"appendComplex"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("appendFloat"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"appendFloat"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("clone"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"clone"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("closeOpenNamespaces"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"closeOpenNamespaces"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("encodeReflected"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"encodeReflected"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("resetReflectBuf"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"resetReflectBuf"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("safeAddByteString"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"safeAddByteString"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("safeAddString"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"safeAddString"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("truncate"%go, (λ: "$r",
                 method_call #(ptrT.id jsonEncoder.id) #"truncate"%go (![#ptrT] (struct.field_ref #consoleEncoder #"jsonEncoder"%go "$r"))
                 )%V); ("writeContext"%go, (λ: "$r",
                 method_call #consoleEncoder.id #"writeContext"%go (![#consoleEncoder] "$r")
                 )%V)]); (nopCore.id, [("Check"%go, nopCore__Checkⁱᵐᵖˡ); ("Enabled"%go, nopCore__Enabledⁱᵐᵖˡ); ("Sync"%go, nopCore__Syncⁱᵐᵖˡ); ("With"%go, nopCore__Withⁱᵐᵖˡ); ("Write"%go, nopCore__Writeⁱᵐᵖˡ)]); (ptrT.id nopCore.id, [("Check"%go, (λ: "$r",
                 method_call #nopCore.id #"Check"%go (![#nopCore] "$r")
                 )%V); ("Enabled"%go, (λ: "$r",
                 method_call #nopCore.id #"Enabled"%go (![#nopCore] "$r")
                 )%V); ("Sync"%go, (λ: "$r",
                 method_call #nopCore.id #"Sync"%go (![#nopCore] "$r")
                 )%V); ("With"%go, (λ: "$r",
                 method_call #nopCore.id #"With"%go (![#nopCore] "$r")
                 )%V); ("Write"%go, (λ: "$r",
                 method_call #nopCore.id #"Write"%go (![#nopCore] "$r")
                 )%V)]); (ioCore.id, [("Enabled"%go, (λ: "$r",
                 method_call #LevelEnabler.id #"Enabled"%go (struct.field_get #ioCore #"LevelEnabler"%go "$r")
                 )%V)]); (ptrT.id ioCore.id, [("Check"%go, ioCore__Checkⁱᵐᵖˡ); ("Enabled"%go, (λ: "$r",
                 method_call #(ptrT.id LevelEnabler.id) #"Enabled"%go (struct.field_ref #ioCore #"LevelEnabler"%go "$r")
                 )%V); ("Level"%go, ioCore__Levelⁱᵐᵖˡ); ("Sync"%go, ioCore__Syncⁱᵐᵖˡ); ("With"%go, ioCore__Withⁱᵐᵖˡ); ("Write"%go, ioCore__Writeⁱᵐᵖˡ); ("clone"%go, ioCore__cloneⁱᵐᵖˡ)]); (LevelEncoder.id, []); (ptrT.id LevelEncoder.id, [("UnmarshalText"%go, LevelEncoder__UnmarshalTextⁱᵐᵖˡ)]); (TimeEncoder.id, []); (ptrT.id TimeEncoder.id, [("UnmarshalJSON"%go, TimeEncoder__UnmarshalJSONⁱᵐᵖˡ); ("UnmarshalText"%go, TimeEncoder__UnmarshalTextⁱᵐᵖˡ); ("UnmarshalYAML"%go, TimeEncoder__UnmarshalYAMLⁱᵐᵖˡ)]); (DurationEncoder.id, []); (ptrT.id DurationEncoder.id, [("UnmarshalText"%go, DurationEncoder__UnmarshalTextⁱᵐᵖˡ)]); (CallerEncoder.id, []); (ptrT.id CallerEncoder.id, [("UnmarshalText"%go, CallerEncoder__UnmarshalTextⁱᵐᵖˡ)]); (NameEncoder.id, []); (ptrT.id NameEncoder.id, [("UnmarshalText"%go, NameEncoder__UnmarshalTextⁱᵐᵖˡ)]); (EncoderConfig.id, []); (ptrT.id EncoderConfig.id, []); (EntryCaller.id, [("FullPath"%go, EntryCaller__FullPathⁱᵐᵖˡ); ("String"%go, EntryCaller__Stringⁱᵐᵖˡ); ("TrimmedPath"%go, EntryCaller__TrimmedPathⁱᵐᵖˡ)]); (ptrT.id EntryCaller.id, [("FullPath"%go, (λ: "$r",
                 method_call #EntryCaller.id #"FullPath"%go (![#EntryCaller] "$r")
                 )%V); ("String"%go, (λ: "$r",
                 method_call #EntryCaller.id #"String"%go (![#EntryCaller] "$r")
                 )%V); ("TrimmedPath"%go, (λ: "$r",
                 method_call #EntryCaller.id #"TrimmedPath"%go (![#EntryCaller] "$r")
                 )%V)]); (Entry.id, []); (ptrT.id Entry.id, []); (CheckWriteAction.id, [("OnWrite"%go, CheckWriteAction__OnWriteⁱᵐᵖˡ)]); (ptrT.id CheckWriteAction.id, [("OnWrite"%go, (λ: "$r",
                 method_call #CheckWriteAction.id #"OnWrite"%go (![#CheckWriteAction] "$r")
                 )%V)]); (CheckedEntry.id, []); (ptrT.id CheckedEntry.id, [("AddCore"%go, CheckedEntry__AddCoreⁱᵐᵖˡ); ("After"%go, CheckedEntry__Afterⁱᵐᵖˡ); ("Should"%go, CheckedEntry__Shouldⁱᵐᵖˡ); ("Write"%go, CheckedEntry__Writeⁱᵐᵖˡ); ("reset"%go, CheckedEntry__resetⁱᵐᵖˡ)]); (errArray.id, [("MarshalLogArray"%go, errArray__MarshalLogArrayⁱᵐᵖˡ)]); (ptrT.id errArray.id, [("MarshalLogArray"%go, (λ: "$r",
                 method_call #errArray.id #"MarshalLogArray"%go (![#errArray] "$r")
                 )%V)]); (errArrayElem.id, []); (ptrT.id errArrayElem.id, [("Free"%go, errArrayElem__Freeⁱᵐᵖˡ); ("MarshalLogArray"%go, errArrayElem__MarshalLogArrayⁱᵐᵖˡ); ("MarshalLogObject"%go, errArrayElem__MarshalLogObjectⁱᵐᵖˡ)]); (FieldType.id, []); (ptrT.id FieldType.id, []); (Field.id, [("AddTo"%go, Field__AddToⁱᵐᵖˡ); ("Equals"%go, Field__Equalsⁱᵐᵖˡ)]); (ptrT.id Field.id, [("AddTo"%go, (λ: "$r",
                 method_call #Field.id #"AddTo"%go (![#Field] "$r")
                 )%V); ("Equals"%go, (λ: "$r",
                 method_call #Field.id #"Equals"%go (![#Field] "$r")
                 )%V)]); (hooked.id, [("Enabled"%go, (λ: "$r",
                 method_call #Core.id #"Enabled"%go (struct.field_get #hooked #"Core"%go "$r")
                 )%V); ("Sync"%go, (λ: "$r",
                 method_call #Core.id #"Sync"%go (struct.field_get #hooked #"Core"%go "$r")
                 )%V)]); (ptrT.id hooked.id, [("Check"%go, hooked__Checkⁱᵐᵖˡ); ("Enabled"%go, (λ: "$r",
                 method_call #(ptrT.id Core.id) #"Enabled"%go (struct.field_ref #hooked #"Core"%go "$r")
                 )%V); ("Level"%go, hooked__Levelⁱᵐᵖˡ); ("Sync"%go, (λ: "$r",
                 method_call #(ptrT.id Core.id) #"Sync"%go (struct.field_ref #hooked #"Core"%go "$r")
                 )%V); ("With"%go, hooked__Withⁱᵐᵖˡ); ("Write"%go, hooked__Writeⁱᵐᵖˡ)]); (levelFilterCore.id, []); (ptrT.id levelFilterCore.id, [("Check"%go, levelFilterCore__Checkⁱᵐᵖˡ); ("Enabled"%go, levelFilterCore__Enabledⁱᵐᵖˡ); ("Level"%go, levelFilterCore__Levelⁱᵐᵖˡ); ("Sync"%go, levelFilterCore__Syncⁱᵐᵖˡ); ("With"%go, levelFilterCore__Withⁱᵐᵖˡ); ("Write"%go, levelFilterCore__Writeⁱᵐᵖˡ)]); (jsonEncoder.id, []); (ptrT.id jsonEncoder.id, [("AddArray"%go, jsonEncoder__AddArrayⁱᵐᵖˡ); ("AddBinary"%go, jsonEncoder__AddBinaryⁱᵐᵖˡ); ("AddBool"%go, jsonEncoder__AddBoolⁱᵐᵖˡ); ("AddByteString"%go, jsonEncoder__AddByteStringⁱᵐᵖˡ); ("AddComplex128"%go, jsonEncoder__AddComplex128ⁱᵐᵖˡ); ("AddComplex64"%go, jsonEncoder__AddComplex64ⁱᵐᵖˡ); ("AddDuration"%go, jsonEncoder__AddDurationⁱᵐᵖˡ); ("AddFloat32"%go, jsonEncoder__AddFloat32ⁱᵐᵖˡ); ("AddFloat64"%go, jsonEncoder__AddFloat64ⁱᵐᵖˡ); ("AddInt"%go, jsonEncoder__AddIntⁱᵐᵖˡ); ("AddInt16"%go, jsonEncoder__AddInt16ⁱᵐᵖˡ); ("AddInt32"%go, jsonEncoder__AddInt32ⁱᵐᵖˡ); ("AddInt64"%go, jsonEncoder__AddInt64ⁱᵐᵖˡ); ("AddInt8"%go, jsonEncoder__AddInt8ⁱᵐᵖˡ); ("AddObject"%go, jsonEncoder__AddObjectⁱᵐᵖˡ); ("AddReflected"%go, jsonEncoder__AddReflectedⁱᵐᵖˡ); ("AddString"%go, jsonEncoder__AddStringⁱᵐᵖˡ); ("AddTime"%go, jsonEncoder__AddTimeⁱᵐᵖˡ); ("AddUint"%go, jsonEncoder__AddUintⁱᵐᵖˡ); ("AddUint16"%go, jsonEncoder__AddUint16ⁱᵐᵖˡ); ("AddUint32"%go, jsonEncoder__AddUint32ⁱᵐᵖˡ); ("AddUint64"%go, jsonEncoder__AddUint64ⁱᵐᵖˡ); ("AddUint8"%go, jsonEncoder__AddUint8ⁱᵐᵖˡ); ("AddUintptr"%go, jsonEncoder__AddUintptrⁱᵐᵖˡ); ("AppendArray"%go, jsonEncoder__AppendArrayⁱᵐᵖˡ); ("AppendBool"%go, jsonEncoder__AppendBoolⁱᵐᵖˡ); ("AppendByteString"%go, jsonEncoder__AppendByteStringⁱᵐᵖˡ); ("AppendComplex128"%go, jsonEncoder__AppendComplex128ⁱᵐᵖˡ); ("AppendComplex64"%go, jsonEncoder__AppendComplex64ⁱᵐᵖˡ); ("AppendDuration"%go, jsonEncoder__AppendDurationⁱᵐᵖˡ); ("AppendFloat32"%go, jsonEncoder__AppendFloat32ⁱᵐᵖˡ); ("AppendFloat64"%go, jsonEncoder__AppendFloat64ⁱᵐᵖˡ); ("AppendInt"%go, jsonEncoder__AppendIntⁱᵐᵖˡ); ("AppendInt16"%go, jsonEncoder__AppendInt16ⁱᵐᵖˡ); ("AppendInt32"%go, jsonEncoder__AppendInt32ⁱᵐᵖˡ); ("AppendInt64"%go, jsonEncoder__AppendInt64ⁱᵐᵖˡ); ("AppendInt8"%go, jsonEncoder__AppendInt8ⁱᵐᵖˡ); ("AppendObject"%go, jsonEncoder__AppendObjectⁱᵐᵖˡ); ("AppendReflected"%go, jsonEncoder__AppendReflectedⁱᵐᵖˡ); ("AppendString"%go, jsonEncoder__AppendStringⁱᵐᵖˡ); ("AppendTime"%go, jsonEncoder__AppendTimeⁱᵐᵖˡ); ("AppendTimeLayout"%go, jsonEncoder__AppendTimeLayoutⁱᵐᵖˡ); ("AppendUint"%go, jsonEncoder__AppendUintⁱᵐᵖˡ); ("AppendUint16"%go, jsonEncoder__AppendUint16ⁱᵐᵖˡ); ("AppendUint32"%go, jsonEncoder__AppendUint32ⁱᵐᵖˡ); ("AppendUint64"%go, jsonEncoder__AppendUint64ⁱᵐᵖˡ); ("AppendUint8"%go, jsonEncoder__AppendUint8ⁱᵐᵖˡ); ("AppendUintptr"%go, jsonEncoder__AppendUintptrⁱᵐᵖˡ); ("Clone"%go, jsonEncoder__Cloneⁱᵐᵖˡ); ("EncodeEntry"%go, jsonEncoder__EncodeEntryⁱᵐᵖˡ); ("OpenNamespace"%go, jsonEncoder__OpenNamespaceⁱᵐᵖˡ); ("addElementSeparator"%go, jsonEncoder__addElementSeparatorⁱᵐᵖˡ); ("addKey"%go, jsonEncoder__addKeyⁱᵐᵖˡ); ("appendComplex"%go, jsonEncoder__appendComplexⁱᵐᵖˡ); ("appendFloat"%go, jsonEncoder__appendFloatⁱᵐᵖˡ); ("clone"%go, jsonEncoder__cloneⁱᵐᵖˡ); ("closeOpenNamespaces"%go, jsonEncoder__closeOpenNamespacesⁱᵐᵖˡ); ("encodeReflected"%go, jsonEncoder__encodeReflectedⁱᵐᵖˡ); ("resetReflectBuf"%go, jsonEncoder__resetReflectBufⁱᵐᵖˡ); ("safeAddByteString"%go, jsonEncoder__safeAddByteStringⁱᵐᵖˡ); ("safeAddString"%go, jsonEncoder__safeAddStringⁱᵐᵖˡ); ("truncate"%go, jsonEncoder__truncateⁱᵐᵖˡ)]); (lazyWithCore.id, [("Enabled"%go, (λ: "$r",
                 method_call #Core.id #"Enabled"%go (struct.field_get #lazyWithCore #"Core"%go "$r")
                 )%V); ("Sync"%go, (λ: "$r",
                 method_call #Core.id #"Sync"%go (struct.field_get #lazyWithCore #"Core"%go "$r")
                 )%V); ("Write"%go, (λ: "$r",
                 method_call #Core.id #"Write"%go (struct.field_get #lazyWithCore #"Core"%go "$r")
                 )%V)]); (ptrT.id lazyWithCore.id, [("Check"%go, lazyWithCore__Checkⁱᵐᵖˡ); ("Do"%go, (λ: "$r",
                 method_call #(ptrT.id sync.Once.id) #"Do"%go (struct.field_ref #lazyWithCore #"Once"%go "$r")
                 )%V); ("Enabled"%go, (λ: "$r",
                 method_call #(ptrT.id Core.id) #"Enabled"%go (struct.field_ref #lazyWithCore #"Core"%go "$r")
                 )%V); ("Sync"%go, (λ: "$r",
                 method_call #(ptrT.id Core.id) #"Sync"%go (struct.field_ref #lazyWithCore #"Core"%go "$r")
                 )%V); ("With"%go, lazyWithCore__Withⁱᵐᵖˡ); ("Write"%go, (λ: "$r",
                 method_call #(ptrT.id Core.id) #"Write"%go (struct.field_ref #lazyWithCore #"Core"%go "$r")
                 )%V); ("initOnce"%go, lazyWithCore__initOnceⁱᵐᵖˡ); ("doSlow"%go, (λ: "$r",
                 method_call #(ptrT.id sync.Once.id) #"doSlow"%go (struct.field_ref #lazyWithCore #"Once"%go "$r")
                 )%V)]); (Level.id, [("CapitalString"%go, Level__CapitalStringⁱᵐᵖˡ); ("Enabled"%go, Level__Enabledⁱᵐᵖˡ); ("MarshalText"%go, Level__MarshalTextⁱᵐᵖˡ); ("String"%go, Level__Stringⁱᵐᵖˡ)]); (ptrT.id Level.id, [("CapitalString"%go, (λ: "$r",
                 method_call #Level.id #"CapitalString"%go (![#Level] "$r")
                 )%V); ("Enabled"%go, (λ: "$r",
                 method_call #Level.id #"Enabled"%go (![#Level] "$r")
                 )%V); ("Get"%go, Level__Getⁱᵐᵖˡ); ("MarshalText"%go, (λ: "$r",
                 method_call #Level.id #"MarshalText"%go (![#Level] "$r")
                 )%V); ("Set"%go, Level__Setⁱᵐᵖˡ); ("String"%go, (λ: "$r",
                 method_call #Level.id #"String"%go (![#Level] "$r")
                 )%V); ("UnmarshalText"%go, Level__UnmarshalTextⁱᵐᵖˡ); ("unmarshalText"%go, Level__unmarshalTextⁱᵐᵖˡ)]); (ObjectMarshalerFunc.id, [("MarshalLogObject"%go, ObjectMarshalerFunc__MarshalLogObjectⁱᵐᵖˡ)]); (ptrT.id ObjectMarshalerFunc.id, [("MarshalLogObject"%go, (λ: "$r",
                 method_call #ObjectMarshalerFunc.id #"MarshalLogObject"%go (![#ObjectMarshalerFunc] "$r")
                 )%V)]); (ArrayMarshalerFunc.id, [("MarshalLogArray"%go, ArrayMarshalerFunc__MarshalLogArrayⁱᵐᵖˡ)]); (ptrT.id ArrayMarshalerFunc.id, [("MarshalLogArray"%go, (λ: "$r",
                 method_call #ArrayMarshalerFunc.id #"MarshalLogArray"%go (![#ArrayMarshalerFunc] "$r")
                 )%V)]); (MapObjectEncoder.id, [("AddDuration"%go, MapObjectEncoder__AddDurationⁱᵐᵖˡ); ("AddTime"%go, MapObjectEncoder__AddTimeⁱᵐᵖˡ)]); (ptrT.id MapObjectEncoder.id, [("AddArray"%go, MapObjectEncoder__AddArrayⁱᵐᵖˡ); ("AddBinary"%go, MapObjectEncoder__AddBinaryⁱᵐᵖˡ); ("AddBool"%go, MapObjectEncoder__AddBoolⁱᵐᵖˡ); ("AddByteString"%go, MapObjectEncoder__AddByteStringⁱᵐᵖˡ); ("AddComplex128"%go, MapObjectEncoder__AddComplex128ⁱᵐᵖˡ); ("AddComplex64"%go, MapObjectEncoder__AddComplex64ⁱᵐᵖˡ); ("AddDuration"%go, (λ: "$r",
                 method_call #MapObjectEncoder.id #"AddDuration"%go (![#MapObjectEncoder] "$r")
                 )%V); ("AddFloat32"%go, MapObjectEncoder__AddFloat32ⁱᵐᵖˡ); ("AddFloat64"%go, MapObjectEncoder__AddFloat64ⁱᵐᵖˡ); ("AddInt"%go, MapObjectEncoder__AddIntⁱᵐᵖˡ); ("AddInt16"%go, MapObjectEncoder__AddInt16ⁱᵐᵖˡ); ("AddInt32"%go, MapObjectEncoder__AddInt32ⁱᵐᵖˡ); ("AddInt64"%go, MapObjectEncoder__AddInt64ⁱᵐᵖˡ); ("AddInt8"%go, MapObjectEncoder__AddInt8ⁱᵐᵖˡ); ("AddObject"%go, MapObjectEncoder__AddObjectⁱᵐᵖˡ); ("AddReflected"%go, MapObjectEncoder__AddReflectedⁱᵐᵖˡ); ("AddString"%go, MapObjectEncoder__AddStringⁱᵐᵖˡ); ("AddTime"%go, (λ: "$r",
                 method_call #MapObjectEncoder.id #"AddTime"%go (![#MapObjectEncoder] "$r")
                 )%V); ("AddUint"%go, MapObjectEncoder__AddUintⁱᵐᵖˡ); ("AddUint16"%go, MapObjectEncoder__AddUint16ⁱᵐᵖˡ); ("AddUint32"%go, MapObjectEncoder__AddUint32ⁱᵐᵖˡ); ("AddUint64"%go, MapObjectEncoder__AddUint64ⁱᵐᵖˡ); ("AddUint8"%go, MapObjectEncoder__AddUint8ⁱᵐᵖˡ); ("AddUintptr"%go, MapObjectEncoder__AddUintptrⁱᵐᵖˡ); ("OpenNamespace"%go, MapObjectEncoder__OpenNamespaceⁱᵐᵖˡ)]); (sliceArrayEncoder.id, []); (ptrT.id sliceArrayEncoder.id, [("AppendArray"%go, sliceArrayEncoder__AppendArrayⁱᵐᵖˡ); ("AppendBool"%go, sliceArrayEncoder__AppendBoolⁱᵐᵖˡ); ("AppendByteString"%go, sliceArrayEncoder__AppendByteStringⁱᵐᵖˡ); ("AppendComplex128"%go, sliceArrayEncoder__AppendComplex128ⁱᵐᵖˡ); ("AppendComplex64"%go, sliceArrayEncoder__AppendComplex64ⁱᵐᵖˡ); ("AppendDuration"%go, sliceArrayEncoder__AppendDurationⁱᵐᵖˡ); ("AppendFloat32"%go, sliceArrayEncoder__AppendFloat32ⁱᵐᵖˡ); ("AppendFloat64"%go, sliceArrayEncoder__AppendFloat64ⁱᵐᵖˡ); ("AppendInt"%go, sliceArrayEncoder__AppendIntⁱᵐᵖˡ); ("AppendInt16"%go, sliceArrayEncoder__AppendInt16ⁱᵐᵖˡ); ("AppendInt32"%go, sliceArrayEncoder__AppendInt32ⁱᵐᵖˡ); ("AppendInt64"%go, sliceArrayEncoder__AppendInt64ⁱᵐᵖˡ); ("AppendInt8"%go, sliceArrayEncoder__AppendInt8ⁱᵐᵖˡ); ("AppendObject"%go, sliceArrayEncoder__AppendObjectⁱᵐᵖˡ); ("AppendReflected"%go, sliceArrayEncoder__AppendReflectedⁱᵐᵖˡ); ("AppendString"%go, sliceArrayEncoder__AppendStringⁱᵐᵖˡ); ("AppendTime"%go, sliceArrayEncoder__AppendTimeⁱᵐᵖˡ); ("AppendUint"%go, sliceArrayEncoder__AppendUintⁱᵐᵖˡ); ("AppendUint16"%go, sliceArrayEncoder__AppendUint16ⁱᵐᵖˡ); ("AppendUint32"%go, sliceArrayEncoder__AppendUint32ⁱᵐᵖˡ); ("AppendUint64"%go, sliceArrayEncoder__AppendUint64ⁱᵐᵖˡ); ("AppendUint8"%go, sliceArrayEncoder__AppendUint8ⁱᵐᵖˡ); ("AppendUintptr"%go, sliceArrayEncoder__AppendUintptrⁱᵐᵖˡ)]); (counter.id, []); (ptrT.id counter.id, [("IncCheckReset"%go, counter__IncCheckResetⁱᵐᵖˡ)]); (counters.id, []); (ptrT.id counters.id, [("get"%go, counters__getⁱᵐᵖˡ)]); (SamplingDecision.id, []); (ptrT.id SamplingDecision.id, []); (optionFunc.id, [("apply"%go, optionFunc__applyⁱᵐᵖˡ)]); (ptrT.id optionFunc.id, [("apply"%go, (λ: "$r",
                 method_call #optionFunc.id #"apply"%go (![#optionFunc] "$r")
                 )%V)]); (sampler.id, [("Enabled"%go, (λ: "$r",
                 method_call #Core.id #"Enabled"%go (struct.field_get #sampler #"Core"%go "$r")
                 )%V); ("Sync"%go, (λ: "$r",
                 method_call #Core.id #"Sync"%go (struct.field_get #sampler #"Core"%go "$r")
                 )%V); ("Write"%go, (λ: "$r",
                 method_call #Core.id #"Write"%go (struct.field_get #sampler #"Core"%go "$r")
                 )%V)]); (ptrT.id sampler.id, [("Check"%go, sampler__Checkⁱᵐᵖˡ); ("Enabled"%go, (λ: "$r",
                 method_call #(ptrT.id Core.id) #"Enabled"%go (struct.field_ref #sampler #"Core"%go "$r")
                 )%V); ("Level"%go, sampler__Levelⁱᵐᵖˡ); ("Sync"%go, (λ: "$r",
                 method_call #(ptrT.id Core.id) #"Sync"%go (struct.field_ref #sampler #"Core"%go "$r")
                 )%V); ("With"%go, sampler__Withⁱᵐᵖˡ); ("Write"%go, (λ: "$r",
                 method_call #(ptrT.id Core.id) #"Write"%go (struct.field_ref #sampler #"Core"%go "$r")
                 )%V)]); (multiCore.id, [("Check"%go, multiCore__Checkⁱᵐᵖˡ); ("Enabled"%go, multiCore__Enabledⁱᵐᵖˡ); ("Level"%go, multiCore__Levelⁱᵐᵖˡ); ("Sync"%go, multiCore__Syncⁱᵐᵖˡ); ("With"%go, multiCore__Withⁱᵐᵖˡ); ("Write"%go, multiCore__Writeⁱᵐᵖˡ)]); (ptrT.id multiCore.id, [("Check"%go, (λ: "$r",
                 method_call #multiCore.id #"Check"%go (![#multiCore] "$r")
                 )%V); ("Enabled"%go, (λ: "$r",
                 method_call #multiCore.id #"Enabled"%go (![#multiCore] "$r")
                 )%V); ("Level"%go, (λ: "$r",
                 method_call #multiCore.id #"Level"%go (![#multiCore] "$r")
                 )%V); ("Sync"%go, (λ: "$r",
                 method_call #multiCore.id #"Sync"%go (![#multiCore] "$r")
                 )%V); ("With"%go, (λ: "$r",
                 method_call #multiCore.id #"With"%go (![#multiCore] "$r")
                 )%V); ("Write"%go, (λ: "$r",
                 method_call #multiCore.id #"Write"%go (![#multiCore] "$r")
                 )%V)]); (lockedWriteSyncer.id, []); (ptrT.id lockedWriteSyncer.id, [("Lock"%go, (λ: "$r",
                 method_call #(ptrT.id sync.Mutex.id) #"Lock"%go (struct.field_ref #lockedWriteSyncer #"Mutex"%go "$r")
                 )%V); ("Sync"%go, lockedWriteSyncer__Syncⁱᵐᵖˡ); ("TryLock"%go, (λ: "$r",
                 method_call #(ptrT.id sync.Mutex.id) #"TryLock"%go (struct.field_ref #lockedWriteSyncer #"Mutex"%go "$r")
                 )%V); ("Unlock"%go, (λ: "$r",
                 method_call #(ptrT.id sync.Mutex.id) #"Unlock"%go (struct.field_ref #lockedWriteSyncer #"Mutex"%go "$r")
                 )%V); ("Write"%go, lockedWriteSyncer__Writeⁱᵐᵖˡ)]); (writerWrapper.id, [("Sync"%go, writerWrapper__Syncⁱᵐᵖˡ); ("Write"%go, (λ: "$r",
                 method_call #io.Writer.id #"Write"%go (struct.field_get #writerWrapper #"Writer"%go "$r")
                 )%V)]); (ptrT.id writerWrapper.id, [("Sync"%go, (λ: "$r",
                 method_call #writerWrapper.id #"Sync"%go (![#writerWrapper] "$r")
                 )%V); ("Write"%go, (λ: "$r",
                 method_call #(ptrT.id io.Writer.id) #"Write"%go (struct.field_ref #writerWrapper #"Writer"%go "$r")
                 )%V)]); (multiWriteSyncer.id, [("Sync"%go, multiWriteSyncer__Syncⁱᵐᵖˡ); ("Write"%go, multiWriteSyncer__Writeⁱᵐᵖˡ)]); (ptrT.id multiWriteSyncer.id, [("Sync"%go, (λ: "$r",
                 method_call #multiWriteSyncer.id #"Sync"%go (![#multiWriteSyncer] "$r")
                 )%V); ("Write"%go, (λ: "$r",
                 method_call #multiWriteSyncer.id #"Write"%go (![#multiWriteSyncer] "$r")
                 )%V)])].
