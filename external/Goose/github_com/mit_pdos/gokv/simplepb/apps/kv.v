...
Definition Clerk__Put: val :=
  rec: "Clerk__Put" "ck" "key" "val" :=
    ...
    esm.Clerk__ApplyExactlyOnce (struct.loadF Clerk "cl" "ck") (encodePutArgs "args");;
    #().
...
Definition Clerk__CondPut: val :=
  rec: "Clerk__CondPut" "ck" "key" "expect" "val" :=
    ...
    StringFromBytes (esm.Clerk__ApplyExactlyOnce (struct.loadF Clerk "cl" "ck") (encodeCondPutArgs "args")).
